...
![](/Mechaniky/CLI/books/players-handbook-2014/img/planes-1.webp#center)
...
A number of spells allow direct or indirect access to other planes of existence. [Plane shift](/Mechaniky/CLI/spells/plane-shift.md) and [gate](/Mechaniky/CLI/spells/gate.md) can transport adventurers directly to any other plane of existence, with different degrees of precision. Etherealness allows adventurers to enter the Ethereal Plane and travel from there to any of the planes it touches—the Shadowfell, the Feywild, or the Elemental Planes. And the [astral projection](/Mechaniky/CLI/spells/astral-projection.md) spell lets adventurers project themselves into the Astral Plane and travel to the Outer Planes.
...
![Outer Planes](/Mechaniky/CLI/tables/outer-planes-phb.md)
...
![](/Mechaniky/CLI/books/players-handbook-2014/img/planes-2.webp#center)