...
![Individual Treasure: Challenge 0—4](/Mechaniky/CLI/tables/individual-treasure-challenge-04.md)

![Individual Treasure: Challenge 5—10](/Mechaniky/CLI/tables/individual-treasure-challenge-510.md)

![Individual Treasure: Challenge 11—16](/Mechaniky/CLI/tables/individual-treasure-challenge-1116.md)

![Individual Treasure: Challenge 17+](/Mechaniky/CLI/tables/individual-treasure-challenge-17.md)
...
![Treasure Hoard: Challenge 0—4](/Mechaniky/CLI/tables/treasure-hoard-challenge-04.md)

![Treasure Hoard: Challenge 5—10](/Mechaniky/CLI/tables/treasure-hoard-challenge-510.md)

![Treasure Hoard: Challenge 11—16](/Mechaniky/CLI/tables/treasure-hoard-challenge-1116.md)

![Treasure Hoard: Challenge 17+](/Mechaniky/CLI/tables/treasure-hoard-challenge-17.md)
...
![10 gp Gemstones](/Mechaniky/CLI/tables/10-gp-gemstones.md)

![50 gp Gemstones](/Mechaniky/CLI/tables/50-gp-gemstones.md)

![100 gp Gemstones](/Mechaniky/CLI/tables/100-gp-gemstones.md)

![500 gp Gemstones](/Mechaniky/CLI/tables/500-gp-gemstones.md)

![1,000 gp Gemstones](/Mechaniky/CLI/tables/1000-gp-gemstones.md)

![5,000 gp Gemstones](/Mechaniky/CLI/tables/5000-gp-gemstones.md)
...
![25 gp Art Objects](/Mechaniky/CLI/tables/25-gp-art-objects.md)

![250 gp Art Objects](/Mechaniky/CLI/tables/250-gp-art-objects.md)

![750 gp Art Objects](/Mechaniky/CLI/tables/750-gp-art-objects.md)

![2,500 gp Art Objects](/Mechaniky/CLI/tables/2500-gp-art-objects.md)

![7,500 gp Art Objects](/Mechaniky/CLI/tables/7500-gp-art-objects.md)
...
![Magic Item Rarity](/Mechaniky/CLI/tables/magic-item-rarity.md)
...
The [identify](/Mechaniky/CLI/spells/identify.md) spell is the fastest way to reveal an item's properties. Alternatively, a character can focus on one magic item during a short rest, while being in physical contact with the item. At the end of the rest, the character learns the item's properties, as well as how to use them. Potions are an exception; a little taste is enough to tell the taster what the potion does.

Sometimes a magic item carries a clue to its properties. The command word to activate a ring might be etched in tiny letters inside it, or a feathered design might suggest that it's a [ring of feather falling](/Mechaniky/CLI/items/ring-of-feather-falling.md).

Wearing or experimenting with an item can also offer hints about its properties. For example, if a character puts on a [ring of jumping](/Mechaniky/CLI/items/ring-of-jumping.md), you could say, "Your steps feel strangely springy." Perhaps the character then jumps up and down to see what happens. You then say the character jumps unexpectedly high.
...
Attunement to a cursed item can't be ended voluntarily unless the curse is broken first, such as with the [remove curse](/Mechaniky/CLI/spells/remove-curse.md) spell.
...
> 
> ![Variant: Mixing Potions; Potion Miscibility](/Mechaniky/CLI/tables/variant-mixing-potions-potion-miscibility.md)
...
A wizard spell on a spell scroll can be copied just as spells in spellbooks can be copied. When a spell is copied from a spell scroll, the copier must succeed on an Intelligence ([Arcana](/Mechaniky/CLI/Rules/skills.md#Arcana)) check with a DC equal to 10 + the spell's level. If the check succeeds, the spell is successfully copied. Whether the check succeeds or fails, the spell scroll is destroyed.

![Spell Scrolls; Spell Scroll](/Mechaniky/CLI/tables/spell-scrolls-spell-scroll.md)
...
> 
> ![Variant: Scroll Mishaps; Scroll Mishap](/Mechaniky/CLI/tables/variant-scroll-mishaps-scroll-mishap.md)
...
If an item requires an action to activate, that action isn't a function of the [Use an Object](/Mechaniky/CLI/Rules/actions.md#Use%20an%20Object) action, so a feature such as the rogue's Fast Hands can't be used to activate the item.
...
The tables that follow can help you come up with answers. Roll on as many of these tables as you like. Some of the table entries make more sense for certain items than for others. Some magic items are made only by certain kinds of creatures, for instance; a [cloak of elvenkind](/Mechaniky/CLI/items/cloak-of-elvenkind.md) is made by elves, rather than dwarves. If you roll something that doesn't make sense, roll again, choose a more appropriate entry, or use the rolled detail as inspiration to make up your own.

![Special Features; Who Created It or Was Intended to Use It?](/Mechaniky/CLI/tables/special-features-who-created-it-or-was-intended-to-use-it.md)

![Special Features; What Is a Detail from Its History?](/Mechaniky/CLI/tables/special-features-what-is-a-detail-from-its-history.md)

![Special Features; What Minor Property Does It Have](/Mechaniky/CLI/tables/special-features-what-minor-property-does-it-have.md)

![Special Features; What Quirk Does It Have](/Mechaniky/CLI/tables/special-features-what-quirk-does-it-have.md)
...
![Magic Item Table A](/Mechaniky/CLI/tables/magic-item-table-a.md)

![Magic Item Table B](/Mechaniky/CLI/tables/magic-item-table-b.md)

![Magic Item Table C](/Mechaniky/CLI/tables/magic-item-table-c.md)

![Magic Item Table D](/Mechaniky/CLI/tables/magic-item-table-d.md)

![Magic Item Table E](/Mechaniky/CLI/tables/magic-item-table-e.md)

![Magic Item Table F](/Mechaniky/CLI/tables/magic-item-table-f.md)

![Magic Item Table G](/Mechaniky/CLI/tables/magic-item-table-g.md)

![Magic Item Table H](/Mechaniky/CLI/tables/magic-item-table-h.md)

![Magic Item Table I](/Mechaniky/CLI/tables/magic-item-table-i.md)
...
![Sentient Magic Item Communication](/Mechaniky/CLI/tables/sentient-magic-item-communication.md)

#### Senses

With sentience comes awareness. A sentient item can perceive its surroundings out to a limited range. You can choose its senses or roll on the following table.

![Sentient Magic Item Senses](/Mechaniky/CLI/tables/sentient-magic-item-senses.md)

#### Alignment

A sentient magic item has an alignment. Its creator or nature might suggest an alignment. If not, you can pick an alignment or roll on the following table.

![Sentient Magic Item Alignment](/Mechaniky/CLI/tables/sentient-magic-item-alignment.md)
...
![Sentient Special Purpose](/Mechaniky/CLI/tables/sentient-special-purpose.md)
...
- [Blackrazor](/Mechaniky/CLI/items/blackrazor.md)  
- [Moonblade](/Mechaniky/CLI/items/moonblade.md)  
- [Wave](/Mechaniky/CLI/items/wave.md)  
- [Whelm](/Mechaniky/CLI/items/whelm.md)  
...
![Artifact Properties; Minor Beneficial Properties](/Mechaniky/CLI/tables/artifact-properties-minor-beneficial-properties.md)

![Artifact Properties; Major Beneficial Properties](/Mechaniky/CLI/tables/artifact-properties-major-beneficial-properties.md)

![Artifact Properties; Minor Detrimental Properties](/Mechaniky/CLI/tables/artifact-properties-minor-detrimental-properties.md)

![Artifact Properties; Major Detrimental Properties](/Mechaniky/CLI/tables/artifact-properties-major-detrimental-properties.md)
...
- [Axe of the Dwarvish Lords](/Mechaniky/CLI/items/axe-of-the-dwarvish-lords.md)  
- [Book of Exalted Deeds](/Mechaniky/CLI/items/book-of-exalted-deeds.md)  
- [Book of Vile Darkness](/Mechaniky/CLI/items/book-of-vile-darkness.md)  
- [Eye of Vecna](/Mechaniky/CLI/items/eye-of-vecna.md)  
- [Hand of Vecna](/Mechaniky/CLI/items/hand-of-vecna.md)  
- [Orb of Dragonkind](/Mechaniky/CLI/items/orb-of-dragonkind.md)  
- [Sword of Kas](/Mechaniky/CLI/items/sword-of-kas.md)  
- [Wand of Orcus](/Mechaniky/CLI/items/wand-of-orcus.md)  
...
- [Blessing of Health](/Mechaniky/CLI/rewards/blessing-of-health.md)  
- [Blessing of Protection](/Mechaniky/CLI/rewards/blessing-of-protection.md)  
- [Blessing of Magic Resistance](/Mechaniky/CLI/rewards/blessing-of-magic-resistance.md)  
- [Blessing of Understanding](/Mechaniky/CLI/rewards/blessing-of-understanding.md)  
- [Blessing of Valhalla](/Mechaniky/CLI/rewards/blessing-of-valhalla.md)  
- [Blessing of Weapon Enhancement](/Mechaniky/CLI/rewards/blessing-of-weapon-enhancement.md)  
- [Blessing of Wound Closure](/Mechaniky/CLI/rewards/blessing-of-wound-closure.md)  
...
- [Charm of Animal Conjuring](/Mechaniky/CLI/rewards/charm-of-animal-conjuring.md)  
- [Charm of Darkvision](/Mechaniky/CLI/rewards/charm-of-darkvision.md)  
- [Charm of Feather Falling](/Mechaniky/CLI/rewards/charm-of-feather-falling.md)  
- [Charm of Heroism](/Mechaniky/CLI/rewards/charm-of-heroism.md)  
- [Charm of Restoration](/Mechaniky/CLI/rewards/charm-of-restoration.md)  
- [Charm of the Slayer](/Mechaniky/CLI/rewards/charm-of-the-slayer.md)  
- [Charm of Vitality](/Mechaniky/CLI/rewards/charm-of-vitality.md)  
