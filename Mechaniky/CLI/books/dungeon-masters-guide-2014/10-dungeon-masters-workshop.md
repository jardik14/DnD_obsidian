...
![Proficiency Dice](/Mechaniky/CLI/tables/proficiency-dice.md)
...
![Ability Check Proficiency by Class](/Mechaniky/CLI/tables/ability-check-proficiency-by-class.md)
...
Consider using the [Sanity score](/Mechaniky/CLI/Rules/variant-rules/new-ability-scores-honor-and-sanity.md) if your campaign revolves around entities of an utterly alien and unspeakable nature, such as Great Cthulhu, whose powers and minions can shatter a character's mind.
...
When adventurers confront threats they have no hope of overcoming, you can call for them to make a Wisdom saving throw. Set the DC according to the circumstances. A character who fails the save becomes [frightened](/Mechaniky/CLI/Rules/conditions.md#Frightened) for 1 minute. The character can repeat the saving throw at the end of each of his or her turns, ending the effect on the character on a successful save.
...
![Explosives](/Mechaniky/CLI/tables/explosives.md)
...
![Figuring Out Alien Technology](/Mechaniky/CLI/tables/figuring-out-alien-technology.md)
...
![Speed Factor Initiative Modifiers](/Mechaniky/CLI/tables/speed-factor-initiative-modifiers.md)
...
- [Climb onto a Bigger Creature](/Mechaniky/CLI/Rules/actions.md#Climb%20onto%20a%20Bigger%20Creature)  
- [Disarm](/Mechaniky/CLI/Rules/actions.md#Disarm)  
- [Mark](/Mechaniky/CLI/Rules/actions.md#Mark)  
- [Overrun](/Mechaniky/CLI/Rules/actions.md#Overrun)  
- [Shove Aside](/Mechaniky/CLI/Rules/actions.md#Shove%20Aside)  
- [Tumble](/Mechaniky/CLI/Rules/actions.md#Tumble)  
...
![Lingering Injuries](/Mechaniky/CLI/tables/lingering-injuries.md)
...
![Massive Damage; System Shock](/Mechaniky/CLI/tables/massive-damage-system-shock.md)
...
- The creature is [surprised](/Mechaniky/CLI/Rules/conditions.md#Surprised).  
...
- All the creatures in the group are [surprised](/Mechaniky/CLI/Rules/conditions.md#Surprised).  
- The group's leader is reduced to 0 hit points, [incapacitated](/Mechaniky/CLI/Rules/conditions.md#Incapacitated), taken prisoner, or removed from battle.  
...
![Creating Quick Monster Stats; Monster Statistics by Challenge Rating](/Mechaniky/CLI/tables/creating-quick-monster-stats-monster-statistics-by-challenge-rating.md)
...
![Final Challenge Rating; Experience Points by Challenge Rating](/Mechaniky/CLI/tables/final-challenge-rating-experience-points-by-challenge-rating.md)
...
![Assign Hit Dice; Hit Dice by Size](/Mechaniky/CLI/tables/assign-hit-dice-hit-dice-by-size.md)
...
![Damage Vulnerabilities, Resistances, and Immunities; Effective Hit Points Based on Resistances and Immunities](/Mechaniky/CLI/tables/damage-vulnerabilities-resistances-and-immunities-effective-hit-points-based-on-resistances-and-immunities.md)
...
If you want a monster to be proficient in a skill, you can give it a bonus equal to its proficiency bonus on ability checks related to that skill. For example, a monster with sharp senses might have a bonus on Wisdom ([Perception](/Mechaniky/CLI/Rules/skills.md#Perception)) checks, while a duplicitous monster might have a bonus on Charisma ([Deception](/Mechaniky/CLI/Rules/skills.md#Deception)) checks.

You can double the proficiency bonus to account for heightened mastery. For example, a doppelganger is so good at deceiving others that its bonus on Charisma ([Deception](/Mechaniky/CLI/Rules/skills.md#Deception)) checks is equal to double its proficiency bonus + its Charisma modifier.
...
All monsters have a passive Wisdom ([Perception](/Mechaniky/CLI/Rules/skills.md#Perception)) score, which is most often used to determine whether a monster detects approaching or hidden enemies. A monster's passive Wisdom ([Perception](/Mechaniky/CLI/Rules/skills.md#Perception)) score is 10 + its Wisdom modifier. If the monster has proficiency in the Perception skill, its score is 10 + its Wisdom ([Perception](/Mechaniky/CLI/Rules/skills.md#Perception)) bonus.
...
![Creating a Monster Stat Block; Monster Features](/Mechaniky/CLI/tables/creating-a-monster-stat-block-monster-features.md)
...
![Creating NPCs from Scratch; NPC Features](/Mechaniky/CLI/tables/creating-npcs-from-scratch-npc-features.md)
...
![Spell Damage](/Mechaniky/CLI/tables/spell-damage.md)
...
![Power Level; Magic Item Power by Rarity](/Mechaniky/CLI/tables/power-level-magic-item-power-by-rarity.md)
...
Filling in the remaining details, we end up with the following [racial traits for the aasimar](/Mechaniky/CLI/races/aasimar-dmg.md).
...
The Spell Points by Level table applies to [bards](/Mechaniky/CLI/classes/bard.md), [clerics](/Mechaniky/CLI/classes/cleric.md), [druids](/Mechaniky/CLI/classes/druid.md), [sorcerers](/Mechaniky/CLI/classes/sorcerer.md), and [wizards](/Mechaniky/CLI/classes/wizard.md). For a [paladin](/Mechaniky/CLI/classes/paladin.md) or [ranger](/Mechaniky/CLI/classes/ranger.md), halve the character's level in that class and then consult the table. For a [fighter (Eldritch Knight)](/Mechaniky/CLI/classes/fighter.md) or [rogue (Arcane Trickster)](/Mechaniky/CLI/classes/rogue.md), divide the character's level in that class by three.
...
![Variant: Spell Points; Spell Point Cost](/Mechaniky/CLI/tables/variant-spell-points-spell-point-cost.md)

![Variant: Spell Points; Spell Points by Level](/Mechaniky/CLI/tables/variant-spell-points-spell-points-by-level.md)
