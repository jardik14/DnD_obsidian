...
![Identify the Party's Goals; Dungeon Goals](/Mechaniky/CLI/tables/identify-the-partys-goals-dungeon-goals.md)

![Identify the Party's Goals; Wilderness Goals](/Mechaniky/CLI/tables/identify-the-partys-goals-wilderness-goals.md)

![Identify the Party's Goals; Other Goals](/Mechaniky/CLI/tables/identify-the-partys-goals-other-goals.md)
...
![Identify Important NPCs; Adventure Villains](/Mechaniky/CLI/tables/identify-important-npcs-adventure-villains.md)

![Identify Important NPCs; Adventure Allies](/Mechaniky/CLI/tables/identify-important-npcs-adventure-allies.md)

![Identify Important NPCs; Adventure Patrons](/Mechaniky/CLI/tables/identify-important-npcs-adventure-patrons.md)
...
![Find the Ideal Introduction; Adventure Introduction](/Mechaniky/CLI/tables/find-the-ideal-introduction-adventure-introduction.md)
...
![Consider the Ideal Climax; Adventure Climax](/Mechaniky/CLI/tables/consider-the-ideal-climax-adventure-climax.md)
...
![Determine the Villain's Actions; Event-Based Villain Actions](/Mechaniky/CLI/tables/determine-the-villains-actions-event-based-villain-actions.md)
...
![Determine the Party's Goals; Event-Based Goals](/Mechaniky/CLI/tables/determine-the-partys-goals-event-based-goals.md)
...
![Framing Events](/Mechaniky/CLI/tables/framing-events.md)
...
![Moral Quandaries](/Mechaniky/CLI/tables/moral-quandaries.md)
...
![Twists](/Mechaniky/CLI/tables/twists.md)
...
![Side Quests](/Mechaniky/CLI/tables/side-quests.md)
...
![Combat Encounter Difficulty; XP Thresholds by Character Level](/Mechaniky/CLI/tables/combat-encounter-difficulty-xp-thresholds-by-character-level.md)
...
![Modify Total XP for Multiple Monsters; Encounter Multipliers](/Mechaniky/CLI/tables/modify-total-xp-for-multiple-monsters-encounter-multipliers.md)
...
![The Adventuring Day; Adventuring Day XP](/Mechaniky/CLI/tables/the-adventuring-day-adventuring-day-xp.md)
...
- The whole party is [surprised](/Mechaniky/CLI/Rules/conditions.md#Surprised), and the enemy isn't.  
...
![Sylvan Forest Encounters](/Mechaniky/CLI/tables/sylvan-forest-encounters.md)
