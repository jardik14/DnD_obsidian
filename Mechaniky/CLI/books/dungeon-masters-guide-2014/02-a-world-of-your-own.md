...
![A Sample Pantheon; Dawn War Deities](/Mechaniky/CLI/tables/a-sample-pantheon-dawn-war-deities.md)
...
![Forms of Government](/Mechaniky/CLI/tables/forms-of-government.md)
...
![Government; Sample Hierarchy of Noble Titles](/Mechaniky/CLI/tables/government-sample-hierarchy-of-noble-titles.md)
...
![Examples of Faction Ranks](/Mechaniky/CLI/tables/examples-of-faction-ranks.md)
...
![World-Shaking Events](/Mechaniky/CLI/tables/world-shaking-events.md)
...
![Rise or Fall of a Leader or an Era; Leader Types](/Mechaniky/CLI/tables/rise-or-fall-of-a-leader-or-an-era-leader-types.md)
...
![Cataclysmic Disasters](/Mechaniky/CLI/tables/cataclysmic-disasters.md)
...
![Assault or Invasion; Invading Forces](/Mechaniky/CLI/tables/assault-or-invasion-invading-forces.md)
...
![Extinction or Depletion](/Mechaniky/CLI/tables/extinction-or-depletion.md)
...
![New Organizations](/Mechaniky/CLI/tables/new-organizations.md)
...
![Discovery, Expansion, Invention; Discoveries](/Mechaniky/CLI/tables/discovery-expansion-invention-discoveries.md)
...
> 
> ![The Calendar of Harptos](/Mechaniky/CLI/tables/the-calendar-of-harptos.md)
...
Dedicated spellcasters learn 3rd-level spells at the start of this tier. Suddenly characters can fly, damage large numbers of foes with [fireball](/Mechaniky/CLI/spells/fireball.md) and [lightning bolt](/Mechaniky/CLI/spells/lightning-bolt.md) spells, and even breathe underwater. They master 5th-level spells by the end of the tier, and spells such as [teleportation circle](/Mechaniky/CLI/spells/teleportation-circle.md), [scrying](/Mechaniky/CLI/spells/scrying.md), [flame strike](/Mechaniky/CLI/spells/flame-strike.md), [legend lore](/Mechaniky/CLI/spells/legend-lore.md), and [raise dead](/Mechaniky/CLI/spells/raise-dead.md) can have a significant impact on their adventures. They start acquiring more permanent magic items (uncommon and rare ones) as well, which will serve them for the rest of their careers.
...
Dedicated spellcasters gain access to 6th-level spells at 11th level, including spells that completely change the way adventurers interact with the world. Their big, flashy spells are significant in combat-[disintegrate](/Mechaniky/CLI/spells/disintegrate.md), [blade barrier](/Mechaniky/CLI/spells/blade-barrier.md), and [heal](/Mechaniky/CLI/spells/heal.md), for example-but behind-the-scenes spells such as [word of recall](/Mechaniky/CLI/spells/word-of-recall.md), [find the path](/Mechaniky/CLI/spells/find-the-path.md), [contingency](/Mechaniky/CLI/spells/contingency.md), [teleport](/Mechaniky/CLI/spells/teleport.md), and [true seeing](/Mechaniky/CLI/spells/true-seeing.md) alter the way players approach their adventures. Each spell level after that point introduces new effects with an equally large impact. The adventurers find rare magic items (and very rare ones) that bestow similarly powerful abilities.
...
Dedicated spellcasters at this tier wield earthshaking 9th-level spells such as [wish](/Mechaniky/CLI/spells/wish.md), [gate](/Mechaniky/CLI/spells/gate.md), [storm of vengeance](/Mechaniky/CLI/spells/storm-of-vengeance.md), and [astral projection](/Mechaniky/CLI/spells/astral-projection.md). Characters have several rare and very rare magic items at their disposal, and begin discovering legendary items such as a [vorpal sword](/Mechaniky/CLI/items/vorpal-sword.md) or a [staff of the magi](/Mechaniky/CLI/items/staff-of-the-magi.md).
...
![Starting at Higher Level; Starting Equipment](/Mechaniky/CLI/tables/starting-at-higher-level-starting-equipment.md)
...
![Wuxia Weapon Names](/Mechaniky/CLI/tables/wuxia-weapon-names.md)
