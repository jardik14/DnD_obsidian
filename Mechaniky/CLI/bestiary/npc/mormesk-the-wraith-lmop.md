...
- "Mormesk the Wraith"
---
# [Mormesk the Wraith](Mechaniky\CLI\bestiary\npc/mormesk-the-wraith-lmop.md)
...
"condition_immunities": "[charmed](/Mechaniky/CLI/Rules/conditions.md#Charmed), [grappled](/Mechaniky/CLI/Rules/conditions.md#Grappled),\
...
"traits":
  ...
  - "desc": "While in sunlight, the wraith has disadvantage on attack rolls and on\
      \ Wisdom ([Perception](/Mechaniky/CLI/Rules/skills.md#Perception)) checks that\
      \ rely on sight."
...
"source":
  - "LMoP"
"image": "/Mechaniky/CLI/bestiary/npc/token/mormesk-the-wraith-lmop.webp"
```
^statblock