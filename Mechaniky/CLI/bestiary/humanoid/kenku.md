...
- "Kenku"
---
# [Kenku](Mechaniky\CLI\bestiary\humanoid/kenku.md)
...
"traits":
  - "desc": "In the first round of a combat, the kenku has advantage on attack rolls\
      \ against any creature it [surprised](/Mechaniky/CLI/Rules/conditions.md#Surprised)."
    "name": "Ambusher"
  - "desc": "The kenku can mimic any sounds it has heard, including voices. A creature\
      ...
      \ Wisdom ([Insight](/Mechaniky/CLI/Rules/skills.md#Insight)) check."
    "name": "Mimicry"
"actions":
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/humanoid/token/kenku.webp"
```
^statblock
