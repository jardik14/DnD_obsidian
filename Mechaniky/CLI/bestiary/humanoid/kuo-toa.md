...
- "Kuo-toa"
---
# [Kuo-toa](Mechaniky\CLI\bestiary\humanoid/kuo-toa.md)
...
"ac": !!int "13"
"ac_class": "natural armor, [shield](/Mechaniky/CLI/items/shield.md)"
"hp": !!int "18"
"hit_dice": "4d8"
"modifier": !!int "0"
"stats":
...
"skillsaves":
  - "name": "[Perception](/Mechaniky/CLI/Rules/skills.md#Perception)"
    "desc": "+4"
"gear":
  - "[net](/Mechaniky/CLI/items/net.md)"
...
"actions":
  ...
  - "desc": "*Ranged Weapon Attack:* +3 to hit, range 5/15 ft., one Large or smaller\
      \ creature. *Hit:* The target is [restrained](/Mechaniky/CLI/Rules/conditions.md#Restrained).\
...
"reactions":
  - "desc": "When a creature misses the kuo-toa with a melee weapon attack, the kuo-toa\
      ...
      \ is [grappled](/Mechaniky/CLI/Rules/conditions.md#Grappled) while the weapon\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/humanoid/token/kuo-toa.webp"
```
^statblock
