...
- "Grimlock"
---
# [Grimlock](Mechaniky\CLI\bestiary\humanoid/grimlock.md)
...
"senses": "[blindsight](/Mechaniky/CLI/Rules/senses.md#Blindsight) 30 ft. or 10 ft.\
  \ while deafened (blind beyond this radius), passive Perception 13"
"languages": "Undercommon"
"cr": "1/4"
"traits":
  - "desc": "The grimlock can't use its blindsight while [deafened](/Mechaniky/CLI/Rules/conditions.md#Deafened)\
      \ and unable to smell."
    "name": "Blind Senses"
  - "desc": "The grimlock has advantage on Wisdom ([Perception](/Mechaniky/CLI/Rules/skills.md#Perception))\
      \ checks that rely on hearing or smell."
    "name": "Keen Hearing and Smell"
  - "desc": "The grimlock has advantage on Dexterity ([Stealth](/Mechaniky/CLI/Rules/skills.md#Stealth))\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/humanoid/token/grimlock.webp"
```
^statblock
