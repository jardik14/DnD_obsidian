...
- "Troglodyte"
---
# [Troglodyte](Mechaniky\CLI\bestiary\humanoid/troglodyte.md)
...
"cr": "1/4"
"traits":
  - "desc": "The troglodyte has advantage on Dexterity ([Stealth](/Mechaniky/CLI/Rules/skills.md#Stealth))\
      \ checks made to hide."
    "name": "Chameleon Skin"
  - "desc": "Any creature other than a troglodyte that starts its turn within 5 feet\
      ...
      \ [poisoned](/Mechaniky/CLI/Rules/conditions.md#Poisoned) until the start of\
  ...
  - "desc": "While in sunlight, the troglodyte has disadvantage on attack rolls, as\
      \ well as on Wisdom ([Perception](/Mechaniky/CLI/Rules/skills.md#Perception))\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/humanoid/token/troglodyte.webp"
```
^statblock
