...
- "Werewolf"
---
# [Werewolf](Mechaniky\CLI\bestiary\humanoid/werewolf.md)
...
"traits":
  - "desc": "The werewolf can use its action to polymorph into a wolf-humanoid hybrid\
    ...
    "name": "Shapechanger"
  - "desc": "The werewolf has advantage on Wisdom ([Perception](/Mechaniky/CLI/Rules/skills.md#Perception))\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/humanoid/token/werewolf.webp"
```
^statblock
