...
- "Aarakocra"
---
# [Aarakocra](Mechaniky\CLI\bestiary\humanoid/aarakocra.md)
...
"actions":
  ...
  - "desc": "Five aarakocra within 30 feet of each other can magically summon an [air\
      \ elemental](/Mechaniky/CLI/bestiary/elemental/air-elemental.md). Each of the\
      \ five must use its action and movement on three consecutive turns to perform\
      \ an aerial dance and must maintain [concentration](/Mechaniky/CLI/Rules/conditions.md#Concentration)\
      \ while doing so (as if [concentrating](/Mechaniky/CLI/Rules/conditions.md#Concentration)\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/humanoid/token/aarakocra.webp"
```
^statblock
