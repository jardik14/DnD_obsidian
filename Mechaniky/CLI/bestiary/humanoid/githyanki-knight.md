...
- "Githyanki Knight"
---
# [Githyanki Knight](Mechaniky\CLI\bestiary\humanoid/githyanki-knight.md)
...
These silver swords channel the force of the wielder's will, dealing psychic as well as physical damage. A githyanki can't become a knight until it masters the singular discipline needed to will such a blade into existence. A silver sword is equivalent to a [greatsword](/Mechaniky/CLI/items/greatsword.md), and takes on the properties of a [+3 greatsword](/Mechaniky/CLI/items/3-weapon.md) in the hands of its creator.
...
The warlike githyanki and the contemplative githzerai are a sundered people-two cultures that utterly despise one another. Before there were githyanki or githzerai, these creatures were a single race enslaved by the [mind flayers](/Mechaniky/CLI/bestiary/aberration/mind-flayer.md). Although they attempted to overthrow their masters many times, their rebellions were repeatedly crushed until a great leader named Gith arose.
...
Whether these tall, gaunt creatures were peaceful or savage, cultured or primitive before the [mind flayers](/Mechaniky/CLI/bestiary/aberration/mind-flayer.md) enslaved and changed them, none can say. Not even the original name of their race remains from that distant time.
...
"traits":
  - "desc": "The githyanki's innate spellcasting ability is Intelligence (spell save\
      ...
      \ requiring no components:\n\n**At will:** [mage hand](/Mechaniky/CLI/spells/mage-hand.md)\
      \ (the hand is invisible)\n\n**3/day each:** [jump](/Mechaniky/CLI/spells/jump.md),\
      \ [misty step](/Mechaniky/CLI/spells/misty-step.md), [nondetection](/Mechaniky/CLI/spells/nondetection.md)\
      \ (self only), [tongues](/Mechaniky/CLI/spells/tongues.md)\n\n**1/day each:**\
      \ [plane shift](/Mechaniky/CLI/spells/plane-shift.md), [telekinesis](/Mechaniky/CLI/spells/telekinesis.md)"
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +9 to hit, reach 5 ft., one target. *Hit:* 13\
      ...
      \ [astral projection](/Mechaniky/CLI/spells/astral-projection.md) spell), the\
      \ githyanki can cut the silvery cord that tethers the target to its material\
      \ body, instead of dealing damage."
    "name": "Silver Greatsword"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/humanoid/token/githyanki-knight.webp"
```
^statblock