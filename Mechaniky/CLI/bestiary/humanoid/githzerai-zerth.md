...
- "Githzerai Zerth"
---
# [Githzerai Zerth](Mechaniky\CLI\bestiary\humanoid/githzerai-zerth.md)
...
Githzerai revere Zerthimon, the founder of their race. Although Gith won their people's freedom, Zerthimon saw her as unfit to lead. He believed that her warmongering would soon make her a tyrant no better than the [mind flayers](/Mechaniky/CLI/bestiary/aberration/mind-flayer.md).
...
"traits":
  - "desc": "The githzerai's innate spellcasting ability is Wisdom. It can innately\
      ...
      \ each:** [feather fall](/Mechaniky/CLI/spells/feather-fall.md), [jump](/Mechaniky/CLI/spells/jump.md),\
      \ [see invisibility](/Mechaniky/CLI/spells/see-invisibility.md), [shield](/Mechaniky/CLI/spells/shield.md)\n\
      \n**1/day each:** [phantasmal killer](/Mechaniky/CLI/spells/phantasmal-killer.md),\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/humanoid/token/githzerai-zerth.webp"
```
^statblock