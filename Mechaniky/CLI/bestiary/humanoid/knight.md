...
"cr": "3"
"traits":
  - "desc": "The knight has advantage on saving throws against being [frightened](/Mechaniky/CLI/Rules/conditions.md#Frightened)."
    "name": "Brave"
"actions":
  ...
  - "desc": "For 1 minute, the knight can utter a special command or warning whenever\
      ...
      \ die at a time. This effect ends if the knight is [incapacitated](/Mechaniky/CLI/Rules/conditions.md#Incapacitated)."
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/humanoid/token/knight.webp"
```
^statblock
