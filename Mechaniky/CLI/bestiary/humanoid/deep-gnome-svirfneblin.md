...
---
# [Deep Gnome (Svirfneblin)](Mechaniky\CLI\bestiary\humanoid/deep-gnome-svirfneblin.md)
...
"traits":
  - "desc": "The gnome's innate spellcasting ability is Intelligence (spell save DC\
      ...
      \n**At will:** [nondetection](/Mechaniky/CLI/spells/nondetection.md) (self only)\n\
      \n**1/day each:** [blindness/deafness](/Mechaniky/CLI/spells/blindness-deafness.md),\
      \ [blur](/Mechaniky/CLI/spells/blur.md), [disguise self](/Mechaniky/CLI/spells/disguise-self.md)"
    "name": "Innate Spellcasting"
  - "desc": "The gnome has advantage on Dexterity ([Stealth](/Mechaniky/CLI/Rules/skills.md#Stealth))\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/humanoid/token/deep-gnome-svirfneblin.webp"
```
^statblock
