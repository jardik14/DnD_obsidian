...
- "Jackalwere"
---
# [Jackalwere](Mechaniky\CLI\bestiary\humanoid/jackalwere.md)
...
Jackalweres kidnap humanoids for their lamia masters, condemning victims to a lifetime of slavery or an agonizing death. A jackalwere's magical gaze renders a foe [unconscious](/Mechaniky/CLI/Rules/conditions.md#Unconscious), allowing the monster to bind a creature or drag it away.
...
"traits":
  - "desc": "The jackalwere can use its action to polymorph into a specific Medium\
      ...
      \ form if it dies."
    "name": "Shapechanger"
  - "desc": "The jackalwere has advantage on Wisdom ([Perception](/Mechaniky/CLI/Rules/skills.md#Perception))\
  ...
  - "desc": "The jackalwere has advantage on an attack roll against a creature if\
      ...
      \ the ally isn't [incapacitated](/Mechaniky/CLI/Rules/conditions.md#Incapacitated)."
    "name": "Pack Tactics"
"actions":
  ...
  - "desc": "The jackalwere gazes at one creature it can see within 30 feet of it.\
      ...
      \ succumbs to a magical slumber, falling [unconscious](/Mechaniky/CLI/Rules/conditions.md#Unconscious)\
      ...
      \ gaze for the next 24 hours. Undead and creatures immune to being [charmed](/Mechaniky/CLI/Rules/conditions.md#Charmed)\
      \ aren't affected by it."
    "name": "Sleep Gaze"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/humanoid/token/jackalwere.webp"
```
^statblock
