...
- "Yuan-ti Pureblood"
---
# [Yuan-ti Pureblood](Mechaniky\CLI\bestiary\humanoid/yuan-ti-pureblood.md)
...
"traits":
  - "desc": "The yuan-ti's spellcasting ability is Charisma (spell save DC 12). The\
      ...
      \ (snakes only)\n\n**3/day each:** [poison spray](/Mechaniky/CLI/spells/poison-spray.md),\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/humanoid/token/yuan-ti-pureblood.webp"
```
^statblock
