...
---
# [Drow Priestess of Lolth](Mechaniky\CLI\bestiary\humanoid/drow-priestess-of-lolth.md)
...
Distilled from spider venom and the flora of the Underdark, poison can be found in abundance among the drow, and it plays an important part in their culture and politics. Drow mages concoct a viscid toxin that leaves enemies [unconscious](/Mechaniky/CLI/Rules/conditions.md#Unconscious). Drow warriors coat their blades and crossbow bolts with this venom, looking forward to the interrogation and torture that follows combat.
...
"traits":
  - "desc": "The drow is a 10th-level spellcaster. Her spellcasting ability is Wisdom\
      ...
      \ spells prepared:\n\n**Cantrips (at will):** [guidance](/Mechaniky/CLI/spells/guidance.md),\
      \ [poison spray](/Mechaniky/CLI/spells/poison-spray.md), [resistance](/Mechaniky/CLI/spells/resistance.md),\
      \ [spare the dying](/Mechaniky/CLI/spells/spare-the-dying.md), [thaumaturgy](/Mechaniky/CLI/spells/thaumaturgy.md)\n\
      \n**1st level (4 slots):** [animal friendship](/Mechaniky/CLI/spells/animal-friendship.md),\
      \ [cure wounds](/Mechaniky/CLI/spells/cure-wounds.md), [detect poison and disease](/Mechaniky/CLI/spells/detect-poison-and-disease.md),\
      \ [ray of sickness](/Mechaniky/CLI/spells/ray-of-sickness.md)\n\n**2nd level\
      \ (3 slots):** [lesser restoration](/Mechaniky/CLI/spells/lesser-restoration.md),\
      \ [protection from poison](/Mechaniky/CLI/spells/protection-from-poison.md),\
      \ [web](/Mechaniky/CLI/spells/web.md)\n\n**3rd level (3 slots):** [conjure animals](/Mechaniky/CLI/spells/conjure-animals.md)\
      \ (2 [giant spiders](/Mechaniky/CLI/bestiary/beast/giant-spider.md)), [dispel\
      \ magic](/Mechaniky/CLI/spells/dispel-magic.md)\n\n**4th level (3 slots):**\
      \ [divination](/Mechaniky/CLI/spells/divination.md), [freedom of movement](/Mechaniky/CLI/spells/freedom-of-movement.md)\n\
      \n**5th level (2 slots):** [insect plague](/Mechaniky/CLI/spells/insect-plague.md),\
  ...
  - "desc": "The drow's spellcasting ability is Charisma (spell save DC 15). She can\
      ...
      **At will:** [dancing lights](/Mechaniky/CLI/spells/dancing-lights.md)\n\n**1/day\
      ...
      \ [levitate](/Mechaniky/CLI/spells/levitate.md) (self only)"
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 5 ft., one target. *Hit:* 5 (1d6\
    ...
    "name": "Scourge"
  - "desc": "The drow attempts to magically summon a [yochlol](/Mechaniky/CLI/bestiary/fiend/yochlol.md)\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/humanoid/token/drow-priestess-of-lolth.webp"
```
^statblock
