...
- "Werebear"
---
# [Werebear](Mechaniky\CLI\bestiary\humanoid/werebear.md)
...
"damage_immunities": "bludgeoning, piercing, slashing from nonmagical attacks that\
  \ aren't silvered"
"gear":
  - "[greataxe](/Mechaniky/CLI/items/greataxe.md)"
...
"traits":
  - "desc": "The werebear can use its action to polymorph into a Large bear-humanoid\
      ...
      \ form if it dies."
    "name": "Shapechanger"
  - "desc": "The werebear has advantage on Wisdom ([Perception](/Mechaniky/CLI/Rules/skills.md#Perception))\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/humanoid/token/werebear.webp"
```
^statblock
