...
- "Hobgoblin Captain"
---
# [Hobgoblin Captain](Mechaniky\CLI\bestiary\humanoid/hobgoblin-captain.md)
...
"traits":
  - "desc": "Once per turn, the hobgoblin can deal an extra 10 (3d6) damage to a creature\
      ...
      \ of the hobgoblin that isn't [incapacitated](/Mechaniky/CLI/Rules/conditions.md#Incapacitated)."
...
"actions":
  ...
  - "desc": "For 1 minute, the hobgoblin can utter a special command or warning whenever\
      ...
      \ Leadership die at a time. This effect ends if the hobgoblin is [incapacitated](/Mechaniky/CLI/Rules/conditions.md#Incapacitated)."
    "name": "Leadership (Recharges after a Short or Long Rest)"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/humanoid/token/hobgoblin-captain.webp"
```
^statblock
