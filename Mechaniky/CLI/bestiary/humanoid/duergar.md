...
- "Duergar"
---
# [Duergar](Mechaniky\CLI\bestiary\humanoid/duergar.md)
...
The Underdark is saturated with strange magical power, which the duergar absorbed over generations of imprisonment. A duergar can increase its size and strength for a short time, becoming a powerful ogre-sized warrior. If it faces a foe it can't fight, or when spying on creatures approaching its territory, it can just as easily become [invisible](/Mechaniky/CLI/Rules/conditions.md#Invisible) to slip away into the darkness. Eons spent in the Underdark also sharpened their [darkvision](/Mechaniky/CLI/Rules/senses.md#Darkvision), allowing them to see twice as far as other dwarves. This keen eyesight comes at a cost, however, as a duergar's vision is compromised by sunlight.
...
"ac": !!int "16"
"ac_class": "[scale mail](/Mechaniky/CLI/items/scale-mail.md), [shield](/Mechaniky/CLI/items/shield.md)"
"hp": !!int "26"
"hit_dice": "4d8 + 4"
"modifier": !!int "0"
"stats":
...
"gear":
  - "[javelin](/Mechaniky/CLI/items/javelin.md)"
  - "[war pick](/Mechaniky/CLI/items/war-pick.md)"
...
"traits":
  - "desc": "The duergar has advantage on saving throws against poison, spells, and\
      \ illusions, as well as to resist being [charmed](/Mechaniky/CLI/Rules/conditions.md#Charmed)\
      \ or [paralyzed](/Mechaniky/CLI/Rules/conditions.md#Paralyzed)."
...
"actions":
  ...
  - "desc": "*Melee  or Ranged Weapon Attack:* +4 to hit, reach 5 ft. or range 30/120\
    ...
    "name": "Javelin"
  - "desc": "The duergar magically turns [invisible](/Mechaniky/CLI/Rules/conditions.md#Invisible)\
      \ until it attacks, casts a spell, or uses its Enlarge, or until its [concentration](/Mechaniky/CLI/Rules/conditions.md#Concentration)\
      \ is broken, up to 1 hour (as if [concentrating](/Mechaniky/CLI/Rules/conditions.md#Concentration)\
      \ on a spell). Any equipment the duergar wears or carries is [invisible](/Mechaniky/CLI/Rules/conditions.md#Invisible)\
      \ with it."
    "name": "Invisibility (Recharges after a Short or Long Rest)"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/humanoid/token/duergar.webp"
```
^statblock
