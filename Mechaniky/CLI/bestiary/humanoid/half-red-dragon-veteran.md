...
---
# [Half-Red Dragon Veteran](Mechaniky\CLI\bestiary\humanoid/half-red-dragon-veteran.md)
...
The half-dragon gains [blindsight](/Mechaniky/CLI/Rules/senses.md#Blindsight) with a radius of 10 feet and [darkvision](/Mechaniky/CLI/Rules/senses.md#Darkvision) with a radius of 60 feet.

### Resistances

The half-dragon gains resistance to a type of damage based on its color.

![Resistances](/Mechaniky/CLI/tables/resistances-mm.md)
...
![New Action: Breath Weapon](/Mechaniky/CLI/tables/new-action-breath-weapon-mm.md)

### Sample Half-Dragon

Here the half-dragon template has been applied to a human [veteran](/Mechaniky/CLI/bestiary/humanoid/veteran.md) to create a half-red dragon veteran. [Splint armor](/Mechaniky/CLI/items/splint-armor.md) has been replaced with [plate](/Mechaniky/CLI/items/plate-armor.md).
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/humanoid/token/half-red-dragon-veteran.webp"
```
^statblock