...
- "Archmage (Familiar)"
---
# [Archmage (Familiar)](Mechaniky\CLI\bestiary\humanoid/archmage-familiar.md)
...
"traits":
  - "desc": "The archmage is an 18th-level spellcaster. Its spellcasting ability is\
      ...
      \ slots):** [detect magic](/Mechaniky/CLI/spells/detect-magic.md), [find familiar](/Mechaniky/CLI/spells/find-familiar.md)\
      \ (one of the creatures described in the spell or some other Tiny monster, such\
      \ as a [crawling claw](/Mechaniky/CLI/bestiary/undead/crawling-claw.md), [imp](/Mechaniky/CLI/bestiary/fiend/imp.md),\
      \ [pseudodragon](/Mechaniky/CLI/bestiary/dragon/pseudodragon.md), or [quasit](/Mechaniky/CLI/bestiary/fiend/quasit.md)),\
      \ [identify](/Mechaniky/CLI/spells/identify.md), [mage armor](/Mechaniky/CLI/spells/mage-armor.md)*,\
      \ [magic missile](/Mechaniky/CLI/spells/magic-missile.md)\n\n**2nd level (3\
      \ slots):** [detect thoughts](/Mechaniky/CLI/spells/detect-thoughts.md), [mirror\
      \ image](/Mechaniky/CLI/spells/mirror-image.md), [misty step](/Mechaniky/CLI/spells/misty-step.md)\n\
