...
- "Ghost"
---
# [Ghost](Mechaniky\CLI\bestiary\undead/ghost.md)
...
"actions":
  ...
  - "desc": "Each non-undead creature within 60 feet of the ghost that can see it\
      \ must succeed on a DC 13 Wisdom saving throw or be [frightened](/Mechaniky/CLI/Rules/conditions.md#Frightened)\
      \ for 1 minute. If the save fails by 5 or more, the target also ages 1d4 × 10\
      \ years. A [frightened](/Mechaniky/CLI/Rules/conditions.md#Frightened) target\
      \ can repeat the saving throw at the end of each of its turns, ending the [frightened](/Mechaniky/CLI/Rules/conditions.md#Frightened)\
      ...
      \ restoration](/Mechaniky/CLI/spells/greater-restoration.md) spell, but only\
  ...
  - "desc": "One humanoid that the ghost can see within 5 feet of it must succeed\
      ...
      \ disappears, and the target is [incapacitated](/Mechaniky/CLI/Rules/conditions.md#Incapacitated)\
      ...
      \ Intelligence, Wisdom, Charisma, and immunity to being [charmed](/Mechaniky/CLI/Rules/conditions.md#Charmed)\
      \ and [frightened](/Mechaniky/CLI/Rules/conditions.md#Frightened). It otherwise\
      ...
      \ ghost is turned or forced out by an effect like the [dispel evil and good](/Mechaniky/CLI/spells/dispel-evil-and-good.md)\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/undead/token/ghost.webp"
```
^statblock
