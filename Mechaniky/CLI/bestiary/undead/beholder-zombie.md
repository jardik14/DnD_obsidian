...
- "Beholder Zombie"
---
# [Beholder Zombie](Mechaniky\CLI\bestiary\undead/beholder-zombie.md)
...
Most zombies are made from humanoid remains, though the flesh and bones of any formerly living creature can be imbued with a semblance of life. Necromantic magic, usually from spells, animates a zombie. Some zombies rise spontaneously when dark magic saturates an area. Once turned into a zombie, a creature can't be restored to life except by powerful magic, such as a [resurrection](/Mechaniky/CLI/spells/resurrection.md) spell.
...
> 
> After Beek died, we cast an [animate dead](/Mechaniky/CLI/spells/animate-dead.md) spell on his corpse. It was fun for a while, but the zombie started to smell real bad, so we doused it in oil and set it on fire. Beek would've found that hilarious.
...
"actions":
  ...
  - "desc": "The zombie uses a random magical eye ray, choosing a target that it can\
      ...
      \ must succeed on a DC 14 Constitution saving throw or be [paralyzed](/Mechaniky/CLI/Rules/conditions.md#Paralyzed)\
      \ for 1 minute. The target can repeat the saving throw at the end of each of\
      \ its turns, ending the effect on itself on a success.  \n- **2. Fear Ray.**\
      \ The targeted creature must succeed on a DC 14 Wisdom saving throw or be [frightened](/Mechaniky/CLI/Rules/conditions.md#Frightened)\
      \ for 1 minute. The target can repeat the saving throw at the end of each of\
      \ its turns, ending the effect on itself on a success.  \n- **3. Enervation\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/undead/token/beholder-zombie.webp"
```
^statblock
