...
- "Ghoul"
---
# [Ghoul](Mechaniky\CLI\bestiary\undead/ghoul.md)
*Source: Monster Manual p. 148, Lost Mine of Phandelver. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)*  
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +4 to hit, reach 5 ft., one target. *Hit:* 7 (2d4\
      ...
      \ it must succeed on a DC 10 Constitution saving throw or be [paralyzed](/Mechaniky/CLI/Rules/conditions.md#Paralyzed)\
...
"source":
  - "MM"
  - "LMoP"
"image": "/Mechaniky/CLI/bestiary/undead/token/ghoul.webp"
```
^statblock
