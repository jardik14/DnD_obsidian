...
- "Vampire Spellcaster"
---
# [Vampire Spellcaster](Mechaniky\CLI\bestiary\undead/vampire-spellcaster.md)
...
> 
> The game statistics of a player character transformed into a vampire spawn and then a vampire don't change, except that the character's Strength, Dexterity, and Constitution scores become 18 if they aren't higher. In addition, the character gains the vampire's damage resistances, [darkvision](/Mechaniky/CLI/Rules/senses.md#Darkvision), traits, and actions. Attack and damage rolls for the vampire's attacks are based on Strength.
> 
> The save DC for Charm is 8 + the vampire's proficiency bonus + the vampire's Charisma modifier. The character's alignment becomes lawful evil, and the DM might take control of the character until the vampirism is reversed with a [wish](/Mechaniky/CLI/spells/wish.md) spell or the character is killed and brought back to life.
...
"traits":
  - "desc": "The vampire is a 9th-level spellcaster. Its spellcasting ability is Intelligence\
      ...
      \n**1st level (4 slots):** [comprehend languages](/Mechaniky/CLI/spells/comprehend-languages.md),\
      \ [fog cloud](/Mechaniky/CLI/spells/fog-cloud.md), [sleep](/Mechaniky/CLI/spells/sleep.md)\n\
      \n**2nd level (3 slots):** [detect thoughts](/Mechaniky/CLI/spells/detect-thoughts.md),\
      \ [gust of wind](/Mechaniky/CLI/spells/gust-of-wind.md), [mirror image](/Mechaniky/CLI/spells/mirror-image.md)\n\
      \n**3rd level (3 slots):** [animate dead](/Mechaniky/CLI/spells/animate-dead.md),\
      \ [bestow curse](/Mechaniky/CLI/spells/bestow-curse.md), [nondetection](/Mechaniky/CLI/spells/nondetection.md)\n\
      \n**4th level (3 slots):** [blight](/Mechaniky/CLI/spells/blight.md), [greater\
      \ invisibility](/Mechaniky/CLI/spells/greater-invisibility.md)\n\n**5th level\
      \ (1 slots):** [dominate person](/Mechaniky/CLI/spells/dominate-person.md)"
    "name": "Spellcasting"
  ...
  - "desc": "When it drops to 0 hit points outside its resting place, the vampire\
      ...
      \ falling [unconscious](/Mechaniky/CLI/Rules/conditions.md#Unconscious), provided\
      ...
      \ its resting place, it reverts to its vampire form. It is then [paralyzed](/Mechaniky/CLI/Rules/conditions.md#Paralyzed)\
  ...
  - "desc": "The vampire has the following flaws:\n\n- **Forbiddance.** The vampire\
      ...
      \ made of wood is driven into the vampire's heart while the vampire is [incapacitated](/Mechaniky/CLI/Rules/conditions.md#Incapacitated)\
      \ in its resting place, the vampire is [paralyzed](/Mechaniky/CLI/Rules/conditions.md#Paralyzed)\
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +9 to hit, reach 5 ft., one willing creature,\
      \ or a creature that is [grappled](/Mechaniky/CLI/Rules/conditions.md#Grappled)\
      \ by the vampire, [incapacitated](/Mechaniky/CLI/Rules/conditions.md#Incapacitated),\
      \ or [restrained](/Mechaniky/CLI/Rules/conditions.md#Restrained). *Hit:* 7 (1d6\
      ...
      \ ground rises the following night as a [vampire spawn](/Mechaniky/CLI/bestiary/undead/vampire-spawn.md)\
  ...
  - "desc": "The vampire targets one humanoid it can see within 30 feet of it. If\
      ...
      \ saving throw against this magic or be [charmed](/Mechaniky/CLI/Rules/conditions.md#Charmed)\
      \ by the vampire. The [charmed](/Mechaniky/CLI/Rules/conditions.md#Charmed)\
    ...
    "name": "Charm"
  - "desc": "The vampire magically calls 2d4 swarms of [bats](/Mechaniky/CLI/bestiary/beast/swarm-of-bats.md)\
      \ or [rats](/Mechaniky/CLI/bestiary/beast/swarm-of-rats.md), provided that the\
      \ sun isn't up. While outdoors, the vampire can call 3d6 [wolves](/Mechaniky/CLI/bestiary/beast/wolf.md)\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/undead/token/vampire-spellcaster.webp"
```
^statblock
