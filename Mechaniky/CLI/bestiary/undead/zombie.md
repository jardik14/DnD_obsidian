...
- "Zombie"
---
# [Zombie](Mechaniky\CLI\bestiary\undead/zombie.md)
*Source: Monster Manual p. 316, Lost Mine of Phandelver. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)*  
...
"source":
  - "MM"
  - "LMoP"
"image": "/Mechaniky/CLI/bestiary/undead/token/zombie.webp"
```
^statblock
