...
- "Will-o'-Wisp"
---
# [Will-o'-Wisp](Mechaniky\CLI\bestiary\undead/will-o-wisp.md)
...
"condition_immunities": "[exhaustion](/Mechaniky/CLI/Rules/conditions.md#Exhaustion),\
  ...
  \ [restrained](/Mechaniky/CLI/Rules/conditions.md#Restrained), [unconscious](/Mechaniky/CLI/Rules/conditions.md#Unconscious)"
...
"actions":
  - "desc": "*Melee Spell Attack:* +4 to hit, reach 5 ft., one creature. *Hit:* 9\
    ...
    "name": "Shock"
  - "desc": "The will-o'-wisp and its light magically become [invisible](/Mechaniky/CLI/Rules/conditions.md#Invisible)\
      \ until it attacks or uses its Consume Life, or until its [concentration](/Mechaniky/CLI/Rules/conditions.md#Concentration)\
      \ ends (as if [concentrating](/Mechaniky/CLI/Rules/conditions.md#Concentration)\
      \ on a spell)."
    "name": "Invisibility"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/undead/token/will-o-wisp.webp"
```
^statblock
