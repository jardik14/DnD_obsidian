...
- "Flameskull"
---
# [Flameskull](Mechaniky\CLI\bestiary\undead/flameskull.md)
...
A flameskull's shattered fragments reform unless they are splashed with holy water or subjected to a [dispel magic](/Mechaniky/CLI/spells/dispel-magic.md) or [remove curse](/Mechaniky/CLI/spells/remove-curse.md) spell. If it can no longer fulfill its intended purpose, the re-formed flameskull is beholden to no one and becomes autonomous.
...
"traits":
  - "desc": "The flameskull is a 5th-level spellcaster. Its spellcasting ability is\
      ...
      \n**1st level (3 slots):** [magic missile](/Mechaniky/CLI/spells/magic-missile.md),\
      \ [shield](/Mechaniky/CLI/spells/shield.md)\n\n**2nd level (2 slots):** [blur](/Mechaniky/CLI/spells/blur.md),\
      \ [flaming sphere](/Mechaniky/CLI/spells/flaming-sphere.md)\n\n**3rd level (1\
      \ slots):** [fireball](/Mechaniky/CLI/spells/fireball.md)"
    "name": "Spellcasting"
  ...
  - "desc": "If the flameskull is destroyed, it regains all its hit points in 1 hour\
      \ unless holy water is sprinkled on its remains or a [dispel magic](/Mechaniky/CLI/spells/dispel-magic.md)\
      \ or [remove curse](/Mechaniky/CLI/spells/remove-curse.md) spell is cast on\
      \ them."
    "name": "Rejuvenation"
"actions":
...
"source":
  - "MM"
  - "LMoP"
"image": "/Mechaniky/CLI/bestiary/undead/token/flameskull.webp"
```
^statblock
