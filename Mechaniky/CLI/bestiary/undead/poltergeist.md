...
- "Poltergeist"
---
# [Poltergeist](Mechaniky\CLI\bestiary\undead/poltergeist.md)
...
"traits":
  ...
  - "desc": "While in sunlight, the poltergeist has disadvantage on attack rolls,\
      \ as well as on Wisdom ([Perception](/Mechaniky/CLI/Rules/skills.md#Perception))\
      \ checks that rely on sight."
    "name": "Sunlight Sensitivity"
  - "desc": "The poltergeist is [invisible](/Mechaniky/CLI/Rules/conditions.md#Invisible)."
    "name": "Invisibility"
"actions":
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/undead/token/poltergeist.webp"
```
^statblock
