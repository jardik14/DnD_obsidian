...
- "Bone Naga (Spirit)"
---
# [Bone Naga (Spirit)](Mechaniky\CLI\bestiary\undead/bone-naga-spirit.md)
...
"traits":
  - "desc": "The naga is a 5th-level spellcaster (spell save DC 12, +4 to hit with\
      ...
      \ thoughts](/Mechaniky/CLI/spells/detect-thoughts.md), [hold person](/Mechaniky/CLI/spells/hold-person.md)\n\
      \n**3rd level (2 slots):** [lightning bolt](/Mechaniky/CLI/spells/lightning-bolt.md)"
    "name": "Spellcasting"
"actions":
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/undead/token/bone-naga-spirit.webp"
```
^statblock
