...
"traits":
  - "desc": "The mummy lord is a 10th-level spellcaster. Its spellcasting ability\
      ...
      \ flame](/Mechaniky/CLI/spells/sacred-flame.md), [thaumaturgy](/Mechaniky/CLI/spells/thaumaturgy.md)\n\
      \n**1st level (4 slots):** [command](/Mechaniky/CLI/spells/command.md), [guiding\
      \ bolt](/Mechaniky/CLI/spells/guiding-bolt.md), [shield of faith](/Mechaniky/CLI/spells/shield-of-faith.md)\n\
      \n**2nd level (3 slots):** [hold person](/Mechaniky/CLI/spells/hold-person.md),\
      \ [silence](/Mechaniky/CLI/spells/silence.md), [spiritual weapon](/Mechaniky/CLI/spells/spiritual-weapon.md)\n\
      \n**3rd level (3 slots):** [animate dead](/Mechaniky/CLI/spells/animate-dead.md),\
      \ [dispel magic](/Mechaniky/CLI/spells/dispel-magic.md)\n\n**4th level (3 slots):**\
      \ [divination](/Mechaniky/CLI/spells/divination.md), [guardian of faith](/Mechaniky/CLI/spells/guardian-of-faith.md)\n\
      \n**5th level (2 slots):** [contagion](/Mechaniky/CLI/spells/contagion.md),\
      \ [insect plague](/Mechaniky/CLI/spells/insect-plague.md)\n\n**6th level (1\
      \ slots):** [harm](/Mechaniky/CLI/spells/harm.md)"
    "name": "Spellcasting"
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +9 to hit, reach 5 ft., one target. *Hit:* 14\
      ...
      \ its body turns to dust. The curse lasts until removed by the [remove curse](/Mechaniky/CLI/spells/remove-curse.md)\
  ...
  - "desc": "The mummy lord targets one creature it can see within 60 feet of it.\
      ...
      \ throw against this magic or become [frightened](/Mechaniky/CLI/Rules/conditions.md#Frightened)\
      \ until the end of the mummy's next turn. If the target fails the saving throw\
      \ by 5 or more, it is also [paralyzed](/Mechaniky/CLI/Rules/conditions.md#Paralyzed)\
...
"regional_effects":
  - "desc": "A mummy lord's temple or tomb is warped in any of the following ways\
      ...
      \ If a [divination](/Mechaniky/CLI/spells/divination.md) spell already has a\
      \ chance to fail or become unreliable when cast multiple times, that chance\
      ...
      \ on all saving throws. The curse lasts until removed by a [remove curse](/Mechaniky/CLI/spells/remove-curse.md)\
...
"legendary_actions":
  ...
  - "desc": "Blinding dust and sand swirls magically around the mummy lord. Each creature\
      ...
      \ throw or be [blinded](/Mechaniky/CLI/Rules/conditions.md#Blinded) until the\
  ...
  - "desc": "The mummy lord utters a blasphemous word. Each non-undead creature within\
      ...
      \ on a DC 16 Constitution saving throw or be [stunned](/Mechaniky/CLI/Rules/conditions.md#Stunned)\
  ...
  - "desc": "The mummy lord magically transforms into a whirlwind of sand, moves up\
      ...
      \ lord is immune to all damage, and it can't be [grappled](/Mechaniky/CLI/Rules/conditions.md#Grappled),\
      \ [petrified](/Mechaniky/CLI/Rules/conditions.md#Petrified), knocked [prone](/Mechaniky/CLI/Rules/conditions.md#Prone),\
      \ [restrained](/Mechaniky/CLI/Rules/conditions.md#Restrained), or [stunned](/Mechaniky/CLI/Rules/conditions.md#Stunned).\
      \ Equipment worn or carried by the mummy lord remain in its possession."
    "name": "Whirlwind of Sand (Costs 2 Actions)"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/undead/token/mummy-lord.webp"
```
^statblock
