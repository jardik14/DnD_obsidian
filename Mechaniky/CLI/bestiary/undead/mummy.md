...
- "Mummy"
---
# [Mummy](Mechaniky\CLI\bestiary\undead/mummy.md)
...
"actions":
  ...
  - "desc": "The mummy targets one creature it can see within 60 feet of it. If the\
      ...
      \ this magic or become [frightened](/Mechaniky/CLI/Rules/conditions.md#Frightened)\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/undead/token/mummy.webp"
```
^statblock
