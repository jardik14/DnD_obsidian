...
---
# [Adult Blue Dracolich](Mechaniky\CLI\bestiary\undead/adult-blue-dracolich.md)
...
The dracolich can't be [charmed](/Mechaniky/CLI/Rules/conditions.md#Charmed), [frightened](/Mechaniky/CLI/Rules/conditions.md#Frightened), [paralyzed](/Mechaniky/CLI/Rules/conditions.md#Paralyzed), or [poisoned](/Mechaniky/CLI/Rules/conditions.md#Poisoned). It also doesn't suffer from [exhaustion](/Mechaniky/CLI/Rules/conditions.md#Exhaustion).
...
"actions":
  ...
  - "desc": "Each creature of the dracolich's choice that is within 120 feet of the\
      ...
      \ [frightened](/Mechaniky/CLI/Rules/conditions.md#Frightened) for 1 minute.\
...
"lair_actions":
  - "desc": "On initiative count 20 (losing initiative ties), the dragon takes a lair\
      ...
      \ knocked [prone](/Mechaniky/CLI/Rules/conditions.md#Prone) and buried. The\
      \ buried target is [restrained](/Mechaniky/CLI/Rules/conditions.md#Restrained)\
      ...
      \ in the cloud must succeed on a DC 15 Constitution saving throw or be [blinded](/Mechaniky/CLI/Rules/conditions.md#Blinded)\
      ...
      \ At your discretion, a legendary ([adult](/Mechaniky/CLI/bestiary/dragon/adult-blue-dragon.md)\
      \ or [ancient](/Mechaniky/CLI/bestiary/dragon/ancient-blue-dragon.md)) blue\
      ...
      \ damage and landing [prone](/Mechaniky/CLI/Rules/conditions.md#Prone). On a\
      \ successful save, a creature moves to the nearest unoccupied space instead\
...
"regional_effects":
  - "desc": "The region containing a legendary blue dragon's lair is warped by the\
      ...
      \ can be spotted from a safe distance with a successful DC 20 Wisdom ([Perception](/Mechaniky/CLI/Rules/skills.md#Perception))\
      ...
      \ carefully examining the illusion can attempt a DC 15 Intelligence ([Investigation](/Mechaniky/CLI/Rules/skills.md#Investigation))\
...
"legendary_actions":
  - "desc": "The dracolich makes a Wisdom ([Perception](/Mechaniky/CLI/Rules/skills.md#Perception))\
      \ check."
    "name": "Detect"
  ...
  - "desc": "The dracolich beats its tattered wings. Each creature within 10 feet\
      ...
      \ (2d6 + 7) bludgeoning damage and be knocked [prone](/Mechaniky/CLI/Rules/conditions.md#Prone).\
      \ After beating its wings this way, the dracolich can fly up to half its flying\
      \ speed."
    "name": "Wing Attack (Costs 2 Actions)"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/undead/token/adult-blue-dracolich.webp"
```
^statblock
