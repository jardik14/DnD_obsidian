...
- "Ghast"
---
# [Ghast](Mechaniky\CLI\bestiary\undead/ghast.md)
...
"traits":
  - "desc": "Any creature that starts its turn within 5 feet of the ghast must succeed\
      \ on a DC 10 Constitution saving throw or be [poisoned](/Mechaniky/CLI/Rules/conditions.md#Poisoned)\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/undead/token/ghast.webp"
```
^statblock
