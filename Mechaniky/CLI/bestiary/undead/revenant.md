...
- "Revenant"
---
# [Revenant](Mechaniky\CLI\bestiary\undead/revenant.md)
...
"traits":
  ...
  - "desc": "When the revenant's body is destroyed, its soul lingers. After 24 hours,\
      ...
      \ existence and regains all its hit points. While the soul is bodiless, a [wish](/Mechaniky/CLI/spells/wish.md)\
...
"actions":
  ...
  - "desc": "The revenant targets one creature it can see within 30 feet of it and\
      ...
      \ saving throw. On a failure, the target is [paralyzed](/Mechaniky/CLI/Rules/conditions.md#Paralyzed)\
      \ until the revenant deals damage to it, or until the end of the revenant's\
      \ next turn. When the paralysis ends, the target is [frightened](/Mechaniky/CLI/Rules/conditions.md#Frightened)\
      \ of the revenant for 1 minute. The [frightened](/Mechaniky/CLI/Rules/conditions.md#Frightened)\
      \ target can repeat the saving throw at the end of each of its turns, with disadvantage\
      \ if it can see the revenant, ending the [frightened](/Mechaniky/CLI/Rules/conditions.md#Frightened)\
      \ condition on itself on a success."
    "name": "Vengeful Glare"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/undead/token/revenant.webp"
```
^statblock
