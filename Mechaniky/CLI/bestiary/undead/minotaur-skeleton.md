...
- "Minotaur Skeleton"
---
# [Minotaur Skeleton](Mechaniky\CLI\bestiary\undead/minotaur-skeleton.md)
...
"traits":
  - "desc": "If the skeleton moves at least 10 feet straight toward a target and then\
      ...
      \ saving throw or be pushed up to 10 feet away and knocked [prone](/Mechaniky/CLI/Rules/conditions.md#Prone)."
    "name": "Charge"
"actions":
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/undead/token/minotaur-skeleton.webp"
```
^statblock
