...
"cr": "14"
"traits":
  - "desc": "The death tyrant's central eye emits an [invisible](/Mechaniky/CLI/Rules/conditions.md#Invisible),\
      ...
      \ there becomes a [zombie](/Mechaniky/CLI/bestiary/undead/zombie.md) under the\
...
"actions":
  ...
  - "desc": "The death tyrant shoots three of the following magical eye rays at random\
      ...
      \ Constitution saving throw or be [paralyzed](/Mechaniky/CLI/Rules/conditions.md#Paralyzed)\
      \ for 1 minute. The target can repeat the saving throw at the end of each of\
      \ its turns, ending the effect on itself on a success.  \n- **3. Fear Ray.**\
      \ The targeted creature must succeed on a DC 17 Wisdom saving throw or be [frightened](/Mechaniky/CLI/Rules/conditions.md#Frightened)\
      \ for 1 minute. The target can repeat the saving throw at the end of each of\
      \ its turns, ending the effect on itself on a success.  \n- **4. Slowing Ray.**\
      ...
      \ it up to 30 feet in any direction. It is [restrained](/Mechaniky/CLI/Rules/conditions.md#Restrained)\
      \ by the ray's telekinetic grip until the start of the death tyrant's next turn\
      \ or until the death tyrant is [incapacitated](/Mechaniky/CLI/Rules/conditions.md#Incapacitated).\
...
"lair_actions":
  - "desc": "When fighting inside its lair, a death tyrant can invoke the ambient\
      ...
      \ must succeed on a DC 17 Dexterity saving throw or be [grappled](/Mechaniky/CLI/Rules/conditions.md#Grappled).\
      \ Escaping requires a successful DC 17 Strength ([Athletics](/Mechaniky/CLI/Rules/skills.md#Athletics))\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/undead/token/death-tyrant.webp"
```
^statblock
