...
- "Wraith"
---
# [Wraith](Mechaniky\CLI\bestiary\undead/wraith.md)
...
"actions":
  ...
  - "desc": "The wraith targets a humanoid within 10 feet of it that has been dead\
      ...
      \ as a [specter](/Mechaniky/CLI/bestiary/undead/specter.md) in the space of\
      \ its corpse or in the nearest unoccupied space. The [specter](/Mechaniky/CLI/bestiary/undead/specter.md)\
      \ is under the wraith's control. The wraith can have no more than seven specters\
      \ under its control at one time."
    "name": "Create Specter"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/undead/token/wraith.webp"
```
^statblock
