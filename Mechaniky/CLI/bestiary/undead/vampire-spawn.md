...
- "Vampire Spawn"
---
# [Vampire Spawn](Mechaniky\CLI\bestiary\undead/vampire-spawn.md)
...
"traits":
  ...
  - "desc": "The vampire has the following flaws:\n\n- **Forbiddance.** The vampire\
      ...
      \ it is [incapacitated](/Mechaniky/CLI/Rules/conditions.md#Incapacitated) in\
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +6 to hit, reach 5 ft., one willing creature,\
      ...
      \ or [restrained](/Mechaniky/CLI/Rules/conditions.md#Restrained). *Hit:* 6 (1d6\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/undead/token/vampire-spawn.webp"
```
^statblock
