...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +4 to hit, reach 5 ft., one target. *Hit:* 6 (1d8\
      \ + 2) bludgeoning damage, and the target is [grappled](/Mechaniky/CLI/Rules/conditions.md#Grappled)\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/beast/token/giant-scorpion.webp"
```
^statblock
