...
"cr": "1/4"
"traits":
  - "desc": "The panther has advantage on Wisdom ([Perception](/Mechaniky/CLI/Rules/skills.md#Perception))\
  ...
  - "desc": "If the panther moves at least 20 feet straight toward a creature and\
      ...
      \ If the target is [prone](/Mechaniky/CLI/Rules/conditions.md#Prone), the panther\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/beast/token/panther.webp"
```
^statblock
