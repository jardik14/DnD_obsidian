...
"actions":
  - "desc": "*Melee Weapon Attack:* +4 to hit, reach 5 ft., one creature. *Hit:* 4\
      ...
      \ the target to 0 hit points, the target is stable but [poisoned](/Mechaniky/CLI/Rules/conditions.md#Poisoned)\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/beast/token/giant-centipede.webp"
```
^statblock
