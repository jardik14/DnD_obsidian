...
"traits":
  - "desc": "If the elk moves at least 20 feet straight toward a target and then hits\
      ...
      \ or be knocked [prone](/Mechaniky/CLI/Rules/conditions.md#Prone)."
    "name": "Charge"
"actions":
  - "desc": "*Melee Weapon Attack:* +6 to hit, reach 10 ft., one target. *Hit:* 11\
      \ (2d6 + 4) bludgeoning damage."
    "name": "Ram"
  - "desc": "*Melee Weapon Attack:* +6 to hit, reach 5 ft., one [prone](/Mechaniky/CLI/Rules/conditions.md#Prone)\
      \ creature. *Hit:* 22 (4d8 + 4) bludgeoning damage."
    "name": "Hooves"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/beast/token/giant-elk.webp"
```
^statblock
