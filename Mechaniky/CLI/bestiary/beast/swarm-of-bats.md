...
"cr": "1/4"
"traits":
  - "desc": "The swarm can't use its blindsight while [deafened](/Mechaniky/CLI/Rules/conditions.md#Deafened)."
    "name": "Echolocation"
  - "desc": "The swarm has advantage on Wisdom ([Perception](/Mechaniky/CLI/Rules/skills.md#Perception))\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/beast/token/swarm-of-bats.webp"
```
^statblock
