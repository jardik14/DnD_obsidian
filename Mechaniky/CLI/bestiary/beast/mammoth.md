...
"traits":
  - "desc": "If the mammoth moves at least 20 feet straight toward a creature and\
      ...
      \ on a DC 18 Strength saving throw or be knocked [prone](/Mechaniky/CLI/Rules/conditions.md#Prone).\
      \ If the target is [prone](/Mechaniky/CLI/Rules/conditions.md#Prone), the mammoth\
...
"actions":
  - "desc": "*Melee Weapon Attack:* +10 to hit, reach 10 ft., one target. *Hit:* 25\
    ...
    "name": "Gore"
  - "desc": "*Melee Weapon Attack:* +10 to hit, reach 5 ft., one [prone](/Mechaniky/CLI/Rules/conditions.md#Prone)\
      \ creature. *Hit:* 29 (4d10 + 7) bludgeoning damage."
    "name": "Stomp"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/beast/token/mammoth.webp"
```
^statblock
