...
- "Allosaurus"
---
# [Allosaurus](Mechaniky\CLI\bestiary\beast/allosaurus.md)
...
"traits":
  - "desc": "If the allosaurus moves at least 30 feet straight toward a creature and\
      ...
      \ If the target is [prone](/Mechaniky/CLI/Rules/conditions.md#Prone), the allosaurus\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/beast/token/allosaurus.webp"
```
^statblock
