...
- "Triceratops"
---
# [Triceratops](Mechaniky\CLI\bestiary\beast/triceratops.md)
...
"traits":
  - "desc": "If the triceratops moves at least 20 feet straight toward a creature\
      ...
      \ on a DC 13 Strength saving throw or be knocked [prone](/Mechaniky/CLI/Rules/conditions.md#Prone).\
      \ If the target is [prone](/Mechaniky/CLI/Rules/conditions.md#Prone), the triceratops\
...
"actions":
  - "desc": "*Melee Weapon Attack:* +9 to hit, reach 5 ft., one target. *Hit:* 24\
    ...
    "name": "Gore"
  - "desc": "*Melee Weapon Attack:* +9 to hit, reach 5 ft., one [prone](/Mechaniky/CLI/Rules/conditions.md#Prone)\
      \ creature. *Hit:* 22 (3d10 + 6) bludgeoning damage"
    "name": "Stomp"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/beast/token/triceratops.webp"
```
^statblock
