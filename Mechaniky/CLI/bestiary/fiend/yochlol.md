...
- "Yochlol"
---
# [Yochlol](Mechaniky\CLI\bestiary\fiend/yochlol.md)
...
"traits":
  - "desc": "The yochlol's spellcasting ability is Charisma (spell save DC 14). The\
      ...
      \ [web](/Mechaniky/CLI/spells/web.md)\n\n**1/day:** [dominate person](/Mechaniky/CLI/spells/dominate-person.md)"
...
"actions":
  ...
  - "desc": "The yochlol transforms into toxic mist or reverts to its true form. Any\
      ...
      \ true form if it dies.\n\nWhile in mist form, the yochlol is [incapacitated](/Mechaniky/CLI/Rules/conditions.md#Incapacitated)\
      ...
      \ creature must succeed on a DC 14 Constitution saving throw or be [poisoned](/Mechaniky/CLI/Rules/conditions.md#Poisoned)\
      \ until the start of its next turn. While [poisoned](/Mechaniky/CLI/Rules/conditions.md#Poisoned)\
      \ in this way, the target is [incapacitated](/Mechaniky/CLI/Rules/conditions.md#Incapacitated)."
    "name": "Mist Form"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/fiend/token/yochlol.webp"
```
^statblock