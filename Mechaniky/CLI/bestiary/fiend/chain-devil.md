...
- "Chain Devil"
---
# [Chain Devil](Mechaniky\CLI\bestiary\fiend/chain-devil.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +8 to hit, reach 10 ft., one target. *Hit:* 11\
      \ (2d6 + 4) slashing damage. The target is [grappled](/Mechaniky/CLI/Rules/conditions.md#Grappled)\
      \ (escape DC 14) if the devil isn't already grappling a creature. Until this\
      \ grapple ends, the target is [restrained](/Mechaniky/CLI/Rules/conditions.md#Restrained)\
  ...
  - "desc": "Up to four chains the devil can see within 60 feet of it magically sprout\
      ...
      \ or if the devil is [incapacitated](/Mechaniky/CLI/Rules/conditions.md#Incapacitated)\
      \ or dies."
...
"reactions":
  - "desc": "When a creature the devil can see starts its turn within 30 feet of the\
      ...
      \ it must succeed on a DC 14 Wisdom saving throw or be [frightened](/Mechaniky/CLI/Rules/conditions.md#Frightened)\
      \ until the end of its turn."
    "name": "Unnerving Mask"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/fiend/token/chain-devil.webp"
```
^statblock