...
- "Bearded Devil"
---
# [Bearded Devil](Mechaniky\CLI\bestiary\fiend/bearded-devil.md)
...
"gear":
  - "[glaive](/Mechaniky/CLI/items/glaive.md)"
...
"traits":
  ...
  - "desc": "The devil can't be [frightened](/Mechaniky/CLI/Rules/conditions.md#Frightened)\
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 5 ft., one creature. *Hit:* 6\
      ...
      \ for 1 minute. While [poisoned](/Mechaniky/CLI/Rules/conditions.md#Poisoned)\
  ...
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 10 ft., one target. *Hit:* 8\
      ...
      \ the wound with a successful DC 12 Wisdom ([Medicine](/Mechaniky/CLI/Rules/skills.md#Medicine))\
      \ check. The wound also closes if the target receives magical healing."
    "name": "Glaive"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/fiend/token/bearded-devil.webp"
```
^statblock