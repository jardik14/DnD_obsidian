...
- "Mezzoloth"
---
# [Mezzoloth](Mechaniky\CLI\bestiary\fiend/mezzoloth.md)
...
"traits":
  - "desc": "The mezzoloth's innate spellcasting ability is Charisma (spell save DC\
      ...
      \ components:\n\n**2/day each:** [darkness](/Mechaniky/CLI/spells/darkness.md),\
      \ [dispel magic](/Mechaniky/CLI/spells/dispel-magic.md)\n\n**1/day:** [cloudkill](/Mechaniky/CLI/spells/cloudkill.md)"
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/fiend/token/mezzoloth.webp"
```
^statblock