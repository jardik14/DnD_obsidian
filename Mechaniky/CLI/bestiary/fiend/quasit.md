...
- "Quasit"
---
# [Quasit](Mechaniky\CLI\bestiary\fiend/quasit.md)
...
> 
> Though demons all have common names, every demon lord and every demon of type 1 through 6 has a true name that it keeps secret. A demon can be forced to disclose its true name if [charmed](/Mechaniky/CLI/Rules/conditions.md#Charmed), and ancient scrolls and tomes are said to exist that list the true names of the most powerful demons.
> 
...
"actions":
  - "desc": "*Melee Weapon Attack:* +4 to hit, reach 5 ft., one target. *Hit:* 5 (1d4\
      ...
      \ saving throw or take 5 (2d4) poison damage and become [poisoned](/Mechaniky/CLI/Rules/conditions.md#Poisoned)\
      \ for 1 minute. The target can repeat the saving throw at the end of each of\
      \ its turns, ending the effect on itself on a success."
    "name": "Claw (Bite in Beast Form)"
  - "desc": "One creature of the quasit's choice within 20 feet of it must succeed\
      \ on a DC 10 Wisdom saving throw or be [frightened](/Mechaniky/CLI/Rules/conditions.md#Frightened)\
      \ for 1 minute. The target can repeat the saving throw at the end of each of\
      \ its turns, with disadvantage if the quasit is within line of sight, ending\
      \ the effect on itself on a success."
    "name": "Scare (1/Day)"
  - "desc": "The quasit magically turns [invisible](/Mechaniky/CLI/Rules/conditions.md#Invisible)\
      \ until it attacks or uses Scare, or until its [concentration](/Mechaniky/CLI/Rules/conditions.md#Concentration)\
      \ ends (as if [concentrating](/Mechaniky/CLI/Rules/conditions.md#Concentration)\
      \ on a spell). Any equipment the quasit wears or carries is [invisible](/Mechaniky/CLI/Rules/conditions.md#Invisible)\
      \ with it."
    "name": "Invisibility"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/fiend/token/quasit.webp"
```
^statblock