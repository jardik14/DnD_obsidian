...
- "Succubus"
---
# [Succubus](Mechaniky\CLI\bestiary\fiend/succubus.md)
...
Succubi and incubi can reproduce with one another to spawn more of their kind. Less commonly, a succubus or incubus reproduces with a humanoid. From this unholy union, a [cambion](/Mechaniky/CLI/bestiary/fiend/cambion.md) child is conceived. Invariably, the fiendish offspring is as wicked as its fiendish parent.
...
"traits":
  - "desc": "The fiend ignores the range restriction on its telepathy when communicating\
      \ with a creature it has [charmed](/Mechaniky/CLI/Rules/conditions.md#Charmed).\
...
"actions":
  ...
  - "desc": "One humanoid the fiend can see within 30 feet of it must succeed on a\
      \ DC 15 Wisdom saving throw or be magically [charmed](/Mechaniky/CLI/Rules/conditions.md#Charmed)\
      ...
      \ the next 24 hours.\n\nThe fiend can have only one target [charmed](/Mechaniky/CLI/Rules/conditions.md#Charmed)\
      \ at a time. If it charms another, the effect on the previous target ends."
    "name": "Charm"
  - "desc": "The fiend kisses a creature [charmed](/Mechaniky/CLI/Rules/conditions.md#Charmed)\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/fiend/token/succubus.webp"
```
^statblock
