...
- "Hezrou"
---
# [Hezrou](Mechaniky\CLI\bestiary\fiend/hezrou.md)
...
"traits":
  ...
  - "desc": "Any creature that starts its turn within 10 feet of the hezrou must succeed\
      \ on a DC 14 Constitution saving throw or be [poisoned](/Mechaniky/CLI/Rules/conditions.md#Poisoned)\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/fiend/token/hezrou.webp"
```
^statblock