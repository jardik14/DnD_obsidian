...
- "Night Hag"
---
# [Night Hag](Mechaniky\CLI\bestiary\fiend/night-hag.md)
...
"condition_immunities": "[charmed](/Mechaniky/CLI/Rules/conditions.md#Charmed)"
...
"traits":
  - "desc": "The hag's innate spellcasting ability is Charisma (spell save DC 14,\
      ...
      \ requiring no material components:\n\n**At will:** [detect magic](/Mechaniky/CLI/spells/detect-magic.md),\
      \ [magic missile](/Mechaniky/CLI/spells/magic-missile.md)\n\n**2/day each:**\
      \ [plane shift](/Mechaniky/CLI/spells/plane-shift.md) (self only), [ray of enfeeblement](/Mechaniky/CLI/spells/ray-of-enfeeblement.md),\
...
"actions":
  ...
  - "desc": "While on the Ethereal Plane, the hag magically touches a sleeping humanoid\
      \ on the Material Plane. A [protection from evil and good](/Mechaniky/CLI/spells/protection-from-evil-and-good.md)\
      ...
      \ maximum lasts until removed by the  [greater restoration](/Mechaniky/CLI/spells/greater-restoration.md)\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/fiend/token/night-hag.webp"
```
^statblock