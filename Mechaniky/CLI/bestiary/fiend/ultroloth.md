...
- "Ultroloth"
---
# [Ultroloth](Mechaniky\CLI\bestiary\fiend/ultroloth.md)
...
"traits":
  - "desc": "The ultroloth's innate spellcasting ability is Charisma (spell save DC\
      ...
      \ [clairvoyance](/Mechaniky/CLI/spells/clairvoyance.md), [darkness](/Mechaniky/CLI/spells/darkness.md),\
      \ [detect magic](/Mechaniky/CLI/spells/detect-magic.md), [detect thoughts](/Mechaniky/CLI/spells/detect-thoughts.md),\
      \ [dispel magic](/Mechaniky/CLI/spells/dispel-magic.md), [invisibility](/Mechaniky/CLI/spells/invisibility.md)\
      \ (self only), [suggestion](/Mechaniky/CLI/spells/suggestion.md)\n\n**3/day\
      \ each:** [dimension door](/Mechaniky/CLI/spells/dimension-door.md), [fear](/Mechaniky/CLI/spells/fear.md),\
      \ [wall of fire](/Mechaniky/CLI/spells/wall-of-fire.md)\n\n**1/day each:** [fire\
      \ storm](/Mechaniky/CLI/spells/fire-storm.md), [mass suggestion](/Mechaniky/CLI/spells/mass-suggestion.md)"
...
"actions":
  ...
  - "desc": "The ultroloth's eyes sparkle with opalescent light as it targets one\
      ...
      \ or be [charmed](/Mechaniky/CLI/Rules/conditions.md#Charmed) until the end\
      \ of the ultroloth's next turn. The [charmed](/Mechaniky/CLI/Rules/conditions.md#Charmed)\
      \ target is [stunned](/Mechaniky/CLI/Rules/conditions.md#Stunned). If the target's\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/fiend/token/ultroloth.webp"
```
^statblock