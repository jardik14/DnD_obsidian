...
- "Nalfeshnee"
---
# [Nalfeshnee](Mechaniky\CLI\bestiary\fiend/nalfeshnee.md)
...
"actions":
  ...
  - "desc": "The nalfeshnee magically emits scintillating, multicolored light. Each\
      ...
      \ on a DC 15 Wisdom saving throw or be [frightened](/Mechaniky/CLI/Rules/conditions.md#Frightened)\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/fiend/token/nalfeshnee.webp"
```
^statblock