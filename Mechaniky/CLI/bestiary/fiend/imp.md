...
- "Imp"
---
# [Imp](Mechaniky\CLI\bestiary\fiend/imp.md)
...
An imp can assume animal form at will, but in its natural state it resembles a diminutive red-skinned humanoid with a barbed tail, small horns, and leathery wings. It strikes while [invisible](/Mechaniky/CLI/Rules/conditions.md#Invisible), attacking with its poison stinger.
...
> 
> Though devils all have common names, every devil above a lemure in station also has a true name that it keeps secret. A devil can be forced to disclose its true name if [charmed](/Mechaniky/CLI/Rules/conditions.md#Charmed), and ancient scrolls and tomes are said to exist that list the true names of certain devils.
> 
...
"actions":
  ...
  - "desc": "The imp magically turns [invisible](/Mechaniky/CLI/Rules/conditions.md#Invisible)\
      \ until it attacks, or until its [concentration](/Mechaniky/CLI/Rules/conditions.md#Concentration)\
      \ ends (as if [concentrating](/Mechaniky/CLI/Rules/conditions.md#Concentration)\
      \ on a spell). Any equipment the imp wears or carries is [invisible](/Mechaniky/CLI/Rules/conditions.md#Invisible)\
      \ with it."
    "name": "Invisibility"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/fiend/token/imp.webp"
```
^statblock