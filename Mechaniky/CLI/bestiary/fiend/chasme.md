...
- "Chasme"
---
# [Chasme](Mechaniky\CLI\bestiary\fiend/chasme.md)
...
"traits":
  - "desc": "The chasme produces a horrid droning sound to which demons are immune.\
      ...
      \ succeed on a DC 12 Constitution saving throw or fall [unconscious](/Mechaniky/CLI/Rules/conditions.md#Unconscious)\
...
"actions":
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 5 ft., one creature. *Hit:* 16\
      ...
      \ finishes a long rest or until it is affected by a spell like  [greater restoration](/Mechaniky/CLI/spells/greater-restoration.md)."
    "name": "Proboscis"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/fiend/token/chasme.webp"
```
^statblock