...
- "Pit Fiend"
---
# [Pit Fiend](Mechaniky\CLI\bestiary\fiend/pit-fiend.md)
...
"traits":
  - "desc": "The pit fiend's spellcasting ability is Charisma (spell save DC 21).\
      ...
      \ [fireball](/Mechaniky/CLI/spells/fireball.md)\n\n**3/day each:** [hold monster](/Mechaniky/CLI/spells/hold-monster.md),\
  ...
  - "desc": "Any creature hostile to the pit fiend that starts its turn within 20\
      ...
      \ fiend is [incapacitated](/Mechaniky/CLI/Rules/conditions.md#Incapacitated).\
      \ On a failed save, the creature is [frightened](/Mechaniky/CLI/Rules/conditions.md#Frightened)\
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +14 to hit, reach 5 ft., one target. *Hit:* 22\
      ...
      \ saving throw or become [poisoned](/Mechaniky/CLI/Rules/conditions.md#Poisoned).\
      ...
      \ the start of each of its turns. The [poisoned](/Mechaniky/CLI/Rules/conditions.md#Poisoned)\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/fiend/token/pit-fiend.webp"
```
^statblock