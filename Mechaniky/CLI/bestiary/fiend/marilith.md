...
- "Marilith"
---
# [Marilith](Mechaniky\CLI\bestiary\fiend/marilith.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +9 to hit, reach 10 ft., one creature. *Hit:*\
      ...
      \ [grappled](/Mechaniky/CLI/Rules/conditions.md#Grappled) (escape DC 19). Until\
      \ this grapple ends, the target is [restrained](/Mechaniky/CLI/Rules/conditions.md#Restrained),\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/fiend/token/marilith.webp"
```
^statblock