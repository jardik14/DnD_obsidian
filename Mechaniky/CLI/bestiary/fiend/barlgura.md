...
- "Barlgura"
---
# [Barlgura](Mechaniky\CLI\bestiary\fiend/barlgura.md)
...
"traits":
  - "desc": "The barlgura's spellcasting ability is Wisdom (spell save DC 13). The\
      ...
      \n**2/day each:** [disguise self](/Mechaniky/CLI/spells/disguise-self.md), [invisibility](/Mechaniky/CLI/spells/invisibility.md)\
      \ (self only)\n\n**1/day each:** [entangle](/Mechaniky/CLI/spells/entangle.md),\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/fiend/token/barlgura.webp"
```
^statblock