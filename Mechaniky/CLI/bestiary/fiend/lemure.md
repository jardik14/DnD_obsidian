...
- "Lemure"
---
# [Lemure](Mechaniky\CLI\bestiary\fiend/lemure.md)
...
"traits":
  ...
  - "desc": "A lemure that dies in the Nine Hells comes back to life with all its\
      ...
      \ a [bless](/Mechaniky/CLI/spells/bless.md) spell cast on that creature or its\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/fiend/token/lemure.webp"
```
^statblock