...
- "Erinyes"
---
# [Erinyes](Mechaniky\CLI\bestiary\fiend/erinyes.md)
...
> 
> Some erinyes carry a [rope of entanglement](/Mechaniky/CLI/items/rope-of-entanglement.md) (detailed in the Dungeon Master's Guide). When such an erinyes uses its Multiattack, the erinyes can use the rope in place of two of the attacks.
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/fiend/token/erinyes.webp"
```
^statblock