...
- "Deva"
---
# [Deva](Mechaniky\CLI\bestiary\celestial/deva.md)
...
"traits":
  - "desc": "The deva's spellcasting ability is Charisma (spell save DC 17). The deva\
      ...
      \n**1/day each:** [commune](/Mechaniky/CLI/spells/commune.md), [raise dead](/Mechaniky/CLI/spells/raise-dead.md)"
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/celestial/token/deva.webp"
```
^statblock