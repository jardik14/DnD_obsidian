...
- "Solar"
---
# [Solar](Mechaniky\CLI\bestiary\celestial/solar.md)
...
"traits":
  - "desc": "The solar's spellcasting ability is Charisma (spell save DC 25). It can\
      ...
      **At will:** [detect evil and good](/Mechaniky/CLI/spells/detect-evil-and-good.md),\
      \ [invisibility](/Mechaniky/CLI/spells/invisibility.md) (self only)\n\n**3/day\
      \ each:** [blade barrier](/Mechaniky/CLI/spells/blade-barrier.md), [dispel evil\
      \ and good](/Mechaniky/CLI/spells/dispel-evil-and-good.md), [resurrection](/Mechaniky/CLI/spells/resurrection.md)\n\
      \n**1/day each:** [commune](/Mechaniky/CLI/spells/commune.md), [control weather](/Mechaniky/CLI/spells/control-weather.md)"
...
"legendary_actions":
  ...
  - "desc": "The solar targets one creature it can see within 30 feet of it. If the\
      ...
      \ throw or be [blinded](/Mechaniky/CLI/Rules/conditions.md#Blinded) until magic\
      \ such as the [lesser restoration](/Mechaniky/CLI/spells/lesser-restoration.md)\
      \ spell removes the blindness."
    "name": "Blinding Gaze (Costs 3 Actions)"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/celestial/token/solar.webp"
```
^statblock