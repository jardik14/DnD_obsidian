...
- "Unicorn"
---
# [Unicorn](Mechaniky\CLI\bestiary\celestial/unicorn.md)
...
"condition_immunities": "[charmed](/Mechaniky/CLI/Rules/conditions.md#Charmed), [paralyzed](/Mechaniky/CLI/Rules/conditions.md#Paralyzed),\
...
"traits":
  - "desc": "The unicorn's innate spellcasting ability is Charisma (spell save DC\
      ...
      \ [druidcraft](/Mechaniky/CLI/spells/druidcraft.md), [pass without trace](/Mechaniky/CLI/spells/pass-without-trace.md)\n\
      \n**1/day each:** [calm emotions](/Mechaniky/CLI/spells/calm-emotions.md), [dispel\
      \ evil and good](/Mechaniky/CLI/spells/dispel-evil-and-good.md), [entangle](/Mechaniky/CLI/spells/entangle.md)"
...
"regional_effects":
  - "desc": "Transformed by the creature's celestial presence, the domain of a unicorn\
      ...
      \ on all Dexterity ([Stealth](/Mechaniky/CLI/Rules/skills.md#Stealth)) checks\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/celestial/token/unicorn.webp"
```
^statblock
