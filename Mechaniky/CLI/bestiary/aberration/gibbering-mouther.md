...
- "Gibbering Mouther"
---
# [Gibbering Mouther](Mechaniky\CLI\bestiary\aberration/gibbering-mouther.md)
...
When a gibbering mouther senses prey, its mouths begin to murmur and chatter, each with a different voice: deep or shrill, wailing or ululating, crying out in agony or ecstasy. This cacophonous gibbering overcomes the senses of any creature that hears it, causing most to flee in terror. Others are overcome with madness or stand [paralyzed](/Mechaniky/CLI/Rules/conditions.md#Paralyzed), fixated on the horrific creature as it oozes forward to consume them.
...
"traits":
  ...
  - "desc": "The mouther babbles incoherently while it can see any creature and isn't\
      \ [incapacitated](/Mechaniky/CLI/Rules/conditions.md#Incapacitated). Each creature\
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +2 to hit, reach 5 ft., one creature. *Hit:* 17\
      ...
      \ on a DC 10 Strength saving throw or be knocked [prone](/Mechaniky/CLI/Rules/conditions.md#Prone).\
  ...
  - "desc": "The mouther spits a chemical glob at a point it can see within 15 feet\
      ...
      \ or be [blinded](/Mechaniky/CLI/Rules/conditions.md#Blinded) until the end\
      \ of the mouther's next turn."
    "name": "Blinding Spittle (Recharge 5-6)"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/aberration/token/gibbering-mouther.webp"
```
^statblock
