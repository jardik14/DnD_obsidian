...
- "Cloaker"
---
# [Cloaker](Mechaniky\CLI\bestiary\aberration/cloaker.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +6 to hit, reach 5 ft., one creature. *Hit:* 10\
      ...
      \ attaches to the target's head, and the target is [blinded](/Mechaniky/CLI/Rules/conditions.md#Blinded)\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/aberration/token/cloaker.webp"
```
^statblock
