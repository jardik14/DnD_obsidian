...
- "Intellect Devourer"
---
# [Intellect Devourer](Mechaniky\CLI\bestiary\aberration/intellect-devourer.md)
...
"condition_immunities": "[blinded](/Mechaniky/CLI/Rules/conditions.md#Blinded)"
...
"traits":
  - "desc": "The intellect devourer can sense the presence and location of any creature\
      ...
      \ of interposing barriers, unless the creature is protected by a [mind blank](/Mechaniky/CLI/spells/mind-blank.md)\
      \ spell."
...
"actions":
  ...
  - "desc": "The intellect devourer targets one creature it can see within 10 feet\
      ...
      \ that score is reduced to 0. The target is [stunned](/Mechaniky/CLI/Rules/conditions.md#Stunned)\
      \ until it regains at least one point of Intelligence."
    "name": "Devour Intellect"
  - "desc": "The intellect devourer initiates an Intelligence contest with an [incapacitated](/Mechaniky/CLI/Rules/conditions.md#Incapacitated)\
      \ humanoid within 5 feet of it that isn't protected by [protection from evil\
      \ and good](/Mechaniky/CLI/spells/protection-from-evil-and-good.md). If it wins\
      ...
      \ from evil and good](/Mechaniky/CLI/spells/protection-from-evil-and-good.md)\
      ...
      \ [wish](/Mechaniky/CLI/spells/wish.md). By spending 5 feet of its movement,\
      \ the intellect devourer can voluntarily leave the body, teleporting to the\
      \ nearest unoccupied space within 5 feet of it. The body then dies, unless its\
      \ brain is restored within 1 round."
    "name": "Body Thief"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/aberration/token/intellect-devourer.webp"
```
^statblock
