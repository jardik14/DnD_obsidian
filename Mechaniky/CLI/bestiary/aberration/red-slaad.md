...
- "Red Slaad"
---
# [Red Slaad](Mechaniky\CLI\bestiary\aberration/red-slaad.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +6 to hit, reach 5 ft., one target. *Hit:* 7 (1d8\
      ...
      \ tadpole](/Mechaniky/CLI/bestiary/aberration/slaad-tadpole.md). In the 24-hour\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/aberration/token/red-slaad.webp"
```
^statblock