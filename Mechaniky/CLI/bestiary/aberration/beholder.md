...
- "Beholder"
---
# [Beholder](Mechaniky\CLI\bestiary\aberration/beholder.md)
...
As alien as their creator, the rooms in a beholder's lair reflect the creature's arrogance. It festoons its chambers with trophies from the battles it has won, including [petrified](/Mechaniky/CLI/Rules/conditions.md#Petrified) adventurers standing frozen in their horrified final moments, pieces of other beholders, and magic items wrested from powerful foes. A beholder judges its own worth by its acquisitions, and it never willingly parts with its treasures.
...
"skillsaves":
  - "name": "[Perception](/Mechaniky/CLI/Rules/skills.md#Perception)"
    "desc": "+12"
"condition_immunities": "[prone](/Mechaniky/CLI/Rules/conditions.md#Prone)"
...
"traits":
  - "desc": "The beholder's central eye creates an area of antimagic, as in the [antimagic\
      \ field](/Mechaniky/CLI/spells/antimagic-field.md) spell, in a 150-foot cone.\
      \ At the start of each of its turns, the beholder decides which way the cone\
      \ faces and whether the cone is active. The area works against the beholder's\
      \ own eye rays."
    "name": "Antimagic Cone"
"actions":
  ...
  - "desc": "The beholder shoots three of the following magical eye rays at random\
      ...
      \ Wisdom saving throw or be [charmed](/Mechaniky/CLI/Rules/conditions.md#Charmed)\
      ...
      \ saving throw or be [paralyzed](/Mechaniky/CLI/Rules/conditions.md#Paralyzed)\
      \ for 1 minute. The target can repeat the saving throw at the end of each of\
      \ its turns, ending the effect on itself on a success.  \n- **3. Fear Ray.**\
      \ The targeted creature must succeed on a DC 16 Wisdom saving throw or be [frightened](/Mechaniky/CLI/Rules/conditions.md#Frightened)\
      \ for 1 minute. The target can repeat the saving throw at the end of each of\
      \ its turns, ending the effect on itself on a success.  \n- **4. Slowing Ray.**\
      ...
      \ up to 30 feet in any direction. It is [restrained](/Mechaniky/CLI/Rules/conditions.md#Restrained)\
      \ by the ray's telekinetic grip until the start of the beholder's next turn\
      \ or until the beholder is [incapacitated](/Mechaniky/CLI/Rules/conditions.md#Incapacitated).\
      ...
      \ and remain [unconscious](/Mechaniky/CLI/Rules/conditions.md#Unconscious) for\
      ...
      \ [restrained](/Mechaniky/CLI/Rules/conditions.md#Restrained). It must repeat\
      \ the saving throw at the end of its next turn. On a success, the effect ends.\
      \ On a failure, the creature is [petrified](/Mechaniky/CLI/Rules/conditions.md#Petrified)\
      \ until freed by the  [greater restoration](/Mechaniky/CLI/spells/greater-restoration.md)\
...
"lair_actions":
  - "desc": "When fighting inside its lair, a beholder can invoke the ambient magic\
      ...
      \ a DC 15 Dexterity saving throw or be [grappled](/Mechaniky/CLI/Rules/conditions.md#Grappled).\
      \ Escaping requires a successful DC 15 Strength ([Athletics](/Mechaniky/CLI/Rules/skills.md#Athletics))\
      \ or Dexterity ([Acrobatics](/Mechaniky/CLI/Rules/skills.md#Acrobatics)) check.\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/aberration/token/beholder.webp"
```
^statblock
