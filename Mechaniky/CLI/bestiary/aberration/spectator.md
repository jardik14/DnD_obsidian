...
- "Spectator"
---
# [Spectator](Mechaniky\CLI\bestiary\aberration/spectator.md)
...
"actions":
  ...
  - "desc": "The spectator shoots up to two of the following magical eye rays at one\
      ...
      \ [paralyzed](/Mechaniky/CLI/Rules/conditions.md#Paralyzed) for 1 minute. The\
      \ target can repeat the saving throw at the end of each of its turns, ending\
      \ the effect on itself on a success.  \n- **3. Fear Ray.** The target must succeed\
      \ on a DC 13 Wisdom saving throw or be [frightened](/Mechaniky/CLI/Rules/conditions.md#Frightened)\
...
"source":
  - "MM"
  - "LMoP"
"image": "/Mechaniky/CLI/bestiary/aberration/token/spectator.webp"
```
^statblock
