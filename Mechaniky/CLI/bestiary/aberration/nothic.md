...
- "Nothic"
---
# [Nothic](Mechaniky\CLI\bestiary\aberration/nothic.md)
...
"cr": "2"
"traits":
  - "desc": "The nothic has advantage on Wisdom ([Perception](/Mechaniky/CLI/Rules/skills.md#Perception))\
...
"actions":
  ...
  - "desc": "The nothic targets one creature it can see within 30 feet of it. The\
    ...
    "name": "Rotting Gaze"
  - "desc": "The nothic targets one creature it can see within 30 feet of it. The\
      \ target must contest its Charisma ([Deception](/Mechaniky/CLI/Rules/skills.md#Deception))\
      \ check against the nothic's Wisdom ([Insight](/Mechaniky/CLI/Rules/skills.md#Insight))\
      \ check. If the nothic wins, it magically learns one fact or secret about the\
      \ target. The target automatically wins if it is immune to being [charmed](/Mechaniky/CLI/Rules/conditions.md#Charmed)."
    "name": "Weird Insight"
"source":
  - "MM"
  - "LMoP"
"image": "/Mechaniky/CLI/bestiary/aberration/token/nothic.webp"
```
^statblock
