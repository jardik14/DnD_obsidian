...
---
# [Mind Flayer Arcanist](Mechaniky\CLI\bestiary\aberration/mind-flayer-arcanist.md)
...
"traits":
  - "desc": "The mind flayer is a 10th-level spellcaster. Its spellcasting ability\
      ...
      \ ward](/Mechaniky/CLI/spells/blade-ward.md), [dancing lights](/Mechaniky/CLI/spells/dancing-lights.md),\
      \ [mage hand](/Mechaniky/CLI/spells/mage-hand.md), [shocking grasp](/Mechaniky/CLI/spells/shocking-grasp.md)\n\
      \n**1st level (4 slots):** [detect magic](/Mechaniky/CLI/spells/detect-magic.md),\
      \ [disguise self](/Mechaniky/CLI/spells/disguise-self.md), [shield](/Mechaniky/CLI/spells/shield.md),\
      \ [sleep](/Mechaniky/CLI/spells/sleep.md)\n\n**2nd level (3 slots):** [blur](/Mechaniky/CLI/spells/blur.md),\
      \ [invisibility](/Mechaniky/CLI/spells/invisibility.md), [ray of enfeeblement](/Mechaniky/CLI/spells/ray-of-enfeeblement.md)\n\
      \n**3rd level (3 slots):** [clairvoyance](/Mechaniky/CLI/spells/clairvoyance.md),\
      \ [lightning bolt](/Mechaniky/CLI/spells/lightning-bolt.md), [sending](/Mechaniky/CLI/spells/sending.md)\n\
      \n**4th level (3 slots):** [confusion](/Mechaniky/CLI/spells/confusion.md),\
      \ [hallucinatory terrain](/Mechaniky/CLI/spells/hallucinatory-terrain.md)\n\n\
      **5th level (2 slots):** [telekinesis](/Mechaniky/CLI/spells/telekinesis.md),\
  ...
  - "desc": "The mind flayer's innate spellcasting ability is Intelligence (spell\
      ...
      \ monster](/Mechaniky/CLI/spells/dominate-monster.md), [plane shift](/Mechaniky/CLI/spells/plane-shift.md)\
      \ (self only)"
...
"actions":
  - "desc": "*Melee Weapon Attack:* +7 to hit, reach 5 ft., one creature. *Hit:* 15\
      \ (2d10 + 4) psychic damage. If the target is Medium or smaller, it is [grappled](/Mechaniky/CLI/Rules/conditions.md#Grappled)\
      \ (escape DC 15) and must succeed on a DC 15 Intelligence saving throw or be\
      \ [stunned](/Mechaniky/CLI/Rules/conditions.md#Stunned) until this grapple ends."
    "name": "Tentacles"
  - "desc": "*Melee Weapon Attack:* +7 to hit, reach 5 ft., one [incapacitated](/Mechaniky/CLI/Rules/conditions.md#Incapacitated)\
      \ humanoid [grappled](/Mechaniky/CLI/Rules/conditions.md#Grappled) by the mind\
  ...
  - "desc": "The mind flayer magically emits psychic energy in a 60-foot cone. Each\
      ...
      \ take 22 (4d8 + 4) psychic damage and be [stunned](/Mechaniky/CLI/Rules/conditions.md#Stunned)\
      \ for 1 minute. A creature can repeat the saving throw at the end of each of\
      \ its turns, ending the effect on itself on a success."
    "name": "Mind Blast (Recharge 5-6)"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/aberration/token/mind-flayer-arcanist.webp"
```
^statblock
