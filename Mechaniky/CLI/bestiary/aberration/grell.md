...
- "Grell"
---
# [Grell](Mechaniky\CLI\bestiary\aberration/grell.md)
...
"condition_immunities": "[blinded](/Mechaniky/CLI/Rules/conditions.md#Blinded), [prone](/Mechaniky/CLI/Rules/conditions.md#Prone)"
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +4 to hit, reach 10 ft., one creature. *Hit:*\
      ...
      \ for 1 minute. The [poisoned](/Mechaniky/CLI/Rules/conditions.md#Poisoned)\
      \ target is [paralyzed](/Mechaniky/CLI/Rules/conditions.md#Paralyzed), and it\
      \ can repeat the saving throw at the end of each of its turns, ending the effect\
      \ on a success.\n\nThe target is also [grappled](/Mechaniky/CLI/Rules/conditions.md#Grappled)\
      \ (escape DC 15). If the target is Medium or smaller, it is also [restrained](/Mechaniky/CLI/Rules/conditions.md#Restrained)\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/aberration/token/grell.webp"
```
^statblock
