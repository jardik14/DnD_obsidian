...
- "Blue Slaad"
---
# [Blue Slaad](Mechaniky\CLI\bestiary\aberration/blue-slaad.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +8 to hit, reach 5 ft., one target. *Hit:* 12\
      ...
      \ slaad](/Mechaniky/CLI/bestiary/aberration/red-slaad.md) or, if it has the\
      \ ability to cast spells of 3rd level or higher, a [green slaad](/Mechaniky/CLI/bestiary/aberration/green-slaad.md).\
      \ Only a [wish](/Mechaniky/CLI/spells/wish.md) spell can reverse the transformation."
    "name": "Claw"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/aberration/token/blue-slaad.webp"
```
^statblock