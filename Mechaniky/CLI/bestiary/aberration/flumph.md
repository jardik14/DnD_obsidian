...
- "Flumph"
---
# [Flumph](Mechaniky\CLI\bestiary\aberration/flumph.md)
...
"traits":
  - "desc": "The flumph can perceive the content of any telepathic communication used\
      \ within 60 feet of it, and it can't be [surprised](/Mechaniky/CLI/Rules/conditions.md#Surprised)\
      \ by creatures with any form of telepathy."
    "name": "Advanced Telepathy"
  - "desc": "If the flumph is knocked [prone](/Mechaniky/CLI/Rules/conditions.md#Prone),\
      \ roll a die. On an odd result, the flumph lands upside-down and is [incapacitated](/Mechaniky/CLI/Rules/conditions.md#Incapacitated).\
      \ At the end of each of its turns, the flumph can make a DC 10 Dexterity saving\
      \ throw, righting itself and ending the [incapacitated](/Mechaniky/CLI/Rules/conditions.md#Incapacitated)\
...
"actions":
  - "desc": "*Melee Weapon Attack:* +4 to hit, reach 5 ft., one creature. *Hit:* 4\
      ...
      \ success. A [lesser restoration](/Mechaniky/CLI/spells/lesser-restoration.md)\
  ...
  - "desc": "Each creature in a 15-foot cone originating from the flumph must succeed\
      ...
      \ is [poisoned](/Mechaniky/CLI/Rules/conditions.md#Poisoned) as long as the\
      \ stench lasts, and other creatures are [poisoned](/Mechaniky/CLI/Rules/conditions.md#Poisoned)\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/aberration/token/flumph.webp"
```
^statblock
