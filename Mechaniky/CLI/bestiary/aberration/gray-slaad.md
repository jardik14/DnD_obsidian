...
- "Gray Slaad"
---
# [Gray Slaad](Mechaniky\CLI\bestiary\aberration/gray-slaad.md)
...
> 
> **Control Gem.** Implanted in the slaad's brain is a magic control gem. The slaad must obey whoever possesses the gem and is immune to being [charmed](/Mechaniky/CLI/Rules/conditions.md#Charmed) while so controlled.
> 
> Certain spells can be used to acquire the gem. If the slaad fails its saving throw against imprisonment, the spell can transfer the gem to the spellcaster's open hand, instead of imprisoning the slaad. A [wish](/Mechaniky/CLI/spells/wish.md) spell, if cast in the slaad's presence, can be worded to acquire the gem.
> 
> A [greater restoration](/Mechaniky/CLI/spells/greater-restoration.md) spell cast on the slaad destroys the gem without harming the slaad.
> 
> Someone who is proficient in Wisdom ([Medicine](/Mechaniky/CLI/Rules/skills.md#Medicine)) can remove the gem from an [incapacitated](/Mechaniky/CLI/Rules/conditions.md#Incapacitated) slaad. Each try requires 1 minute of uninterrupted work and a successful DC 20 Wisdom ([Medicine](/Mechaniky/CLI/Rules/skills.md#Medicine)) check. Each failed attempt deals 22 (`4d10`) psychic damage to the slaad.
...
"senses": "[blindsight](/Mechaniky/CLI/Rules/senses.md#Blindsight) 60 ft., [darkvision](/Mechaniky/CLI/Rules/senses.md#Darkvision)\
...
"traits":
  - "desc": "The slaad's innate spellcasting ability is Charisma (spell save DC 14).\
      ...
      \n**At will:** [detect magic](/Mechaniky/CLI/spells/detect-magic.md), [detect\
      \ thoughts](/Mechaniky/CLI/spells/detect-thoughts.md), [invisibility](/Mechaniky/CLI/spells/invisibility.md)\
      \ (self only), [mage hand](/Mechaniky/CLI/spells/mage-hand.md), [major image](/Mechaniky/CLI/spells/major-image.md)\n\
      \n**2/day each:** [fear](/Mechaniky/CLI/spells/fear.md), [fly](/Mechaniky/CLI/spells/fly.md),\
      \ [fireball](/Mechaniky/CLI/spells/fireball.md), [tongues](/Mechaniky/CLI/spells/tongues.md)\n\
      \n**1/day:** [plane shift](/Mechaniky/CLI/spells/plane-shift.md) (self only)"
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/aberration/token/gray-slaad.webp"
```
^statblock
