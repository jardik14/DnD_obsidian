...
- "Otyugh"
---
# [Otyugh](Mechaniky\CLI\bestiary\aberration/otyugh.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +6 to hit, reach 5 ft., one target. *Hit:* 12\
      ...
      \ a DC 15 Constitution saving throw against disease or become [poisoned](/Mechaniky/CLI/Rules/conditions.md#Poisoned)\
  ...
  - "desc": "*Melee Weapon Attack:* +6 to hit, reach 10 ft., one target. *Hit:* 7\
      ...
      \ Medium or smaller, it is [grappled](/Mechaniky/CLI/Rules/conditions.md#Grappled)\
      \ (escape DC 13) and [restrained](/Mechaniky/CLI/Rules/conditions.md#Restrained)\
      \ until the grapple ends. The otyugh has two tentacles, each of which can grapple\
      \ one target."
    "name": "Tentacle"
  - "desc": "The otyugh slams creatures [grappled](/Mechaniky/CLI/Rules/conditions.md#Grappled)\
      ...
      \ be [stunned](/Mechaniky/CLI/Rules/conditions.md#Stunned) until the end of\
      \ the otyugh's next turn. On a successful save, the target takes half the bludgeoning\
      \ damage and isn't [stunned](/Mechaniky/CLI/Rules/conditions.md#Stunned)."
    "name": "Tentacle Slam"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/aberration/token/otyugh.webp"
```
^statblock
