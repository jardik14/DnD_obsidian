...
- "Homunculus"
---
# [Homunculus](Mechaniky\CLI\bestiary\construct/homunculus.md)
...
"actions":
  - "desc": "*Melee Weapon Attack:* +4 to hit, reach 5 ft., one creature. *Hit:* 1\
      ...
      \ throw or be [poisoned](/Mechaniky/CLI/Rules/conditions.md#Poisoned) for 1\
      \ minute. If the saving throw fails by 5 or more, the target is instead [poisoned](/Mechaniky/CLI/Rules/conditions.md#Poisoned)\
      \ for 5 (1d10) minutes and [unconscious](/Mechaniky/CLI/Rules/conditions.md#Unconscious)\
      \ while [poisoned](/Mechaniky/CLI/Rules/conditions.md#Poisoned) in this way."
    "name": "Bite"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/construct/token/homunculus.webp"
```
^statblock