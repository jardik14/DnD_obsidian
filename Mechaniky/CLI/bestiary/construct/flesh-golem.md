...
- "Flesh Golem"
---
# [Flesh Golem](Mechaniky\CLI\bestiary\construct/flesh-golem.md)
...
To create a golem, one requires a [manual of golems](/Mechaniky/CLI/items/manual-of-golems.md). The comprehensive illustrations and instructions in a manual detail the process for creating a golem of a particular type.
...
When its creator or possessor is on hand to command it, a golem performs flawlessly. If the golem is left without instructions or is [incapacitated](/Mechaniky/CLI/Rules/conditions.md#Incapacitated), it continues to follow its last orders to the best of its ability. When it can't fulfill its orders, a golem might react violently-or stand and do nothing. A golem that has been given conflicting orders sometimes alternates between them.
...
"traits":
  - "desc": "Whenever the golem starts its turn with 40 hit points or fewer, roll\
      ...
      \ take an action to make a DC 15 Charisma ([Persuasion](/Mechaniky/CLI/Rules/skills.md#Persuasion))\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/construct/token/flesh-golem.webp"
```
^statblock