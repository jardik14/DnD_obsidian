...
- "Pentadrone"
---
# [Pentadrone](Mechaniky\CLI\bestiary\construct/pentadrone.md)
...
"actions":
  ...
  - "desc": "The pentadrone exhales a 30-foot cone of gas. Each creature in that area\
      \ must succeed on a DC 11 Constitution saving throw or be [paralyzed](/Mechaniky/CLI/Rules/conditions.md#Paralyzed)\
      \ for 1 minute. A creature can repeat the saving throw at the end of each of\
      \ its turns, ending the effect on itself on a success."
    "name": "Paralysis Gas (Recharge 5-6)"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/construct/token/pentadrone.webp"
```
^statblock