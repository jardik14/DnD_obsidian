...
- "Shield Guardian"
---
# [Shield Guardian](Mechaniky\CLI\bestiary\construct/shield-guardian.md)
...
Every shield guardian has an amulet magically linked to it. A shield guardian can have only one corresponding amulet, and if that amulet is destroyed, the shield guardian is [incapacitated](/Mechaniky/CLI/Rules/conditions.md#Incapacitated) until a replacement amulet is created. A shield guardian's amulet is subject to direct attack if it isn't being worn or carried. It has AC 10, 10 hit points, and immunity to poison and psychic damage. Crafting an amulet requires 1 week and costs 1,000 gp in components.
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/construct/token/shield-guardian.webp"
```
^statblock
