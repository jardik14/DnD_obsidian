...
---
# [Ancient Copper Dragon](Mechaniky\CLI\bestiary\dragon/ancient-copper-dragon.md)
...
"lair_actions":
  - "desc": "On initiative count 20 (losing initiative ties), the dragon takes a lair\
      ...
      \ identical to the [spike growth](/Mechaniky/CLI/spells/spike-growth.md) spell\
      ...
      \ on a DC 15 Dexterity saving throw or sink into the mud and become [restrained](/Mechaniky/CLI/Rules/conditions.md#Restrained).\
      \ A creature can take an action to attempt a DC 15 Strength check, freeing itself\
      \ or another creature within its reach and ending the [restrained](/Mechaniky/CLI/Rules/conditions.md#Restrained)\
      ...
      \ discretion, a legendary ([adult](/Mechaniky/CLI/bestiary/dragon/adult-copper-dragon.md)\
      \ or [ancient](/Mechaniky/CLI/bestiary/dragon/ancient-copper-dragon.md)) copper\
      ...
      \ 15 Wisdom saving throw is [incapacitated](/Mechaniky/CLI/Rules/conditions.md#Incapacitated)\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/dragon/token/ancient-copper-dragon.webp"
```
^statblock
