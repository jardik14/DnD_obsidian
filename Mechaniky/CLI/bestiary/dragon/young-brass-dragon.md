...
- "Young Brass Dragon"
---
# [Young Brass Dragon](Mechaniky\CLI\bestiary\dragon/young-brass-dragon.md)
...
"actions":
  ...
  - "desc": "The dragon uses one of the following breath weapons.\n\n- **Fire Breath.**\
      ...
      \ in that area must succeed on a DC 14 Constitution saving throw or fall [unconscious](/Mechaniky/CLI/Rules/conditions.md#Unconscious)\
      \ for 5 minutes. This effect ends for a creature if the creature takes damage\
      \ or someone uses an action to wake it.  "
    "name": "Breath Weapons (Recharge 5-6)"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/dragon/token/young-brass-dragon.webp"
```
^statblock
