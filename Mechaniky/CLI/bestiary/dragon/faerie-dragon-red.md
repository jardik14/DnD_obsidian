...
- "Faerie Dragon (Red)"
---
# [Faerie Dragon (Red)](Mechaniky\CLI\bestiary\dragon/faerie-dragon-red.md)
...
"traits":
  - "desc": "The dragon's innate spellcasting ability is Charisma (spell save DC 13).\
      ...
      \n**1/day each:** [dancing lights](/Mechaniky/CLI/spells/dancing-lights.md),\
      \ [mage hand](/Mechaniky/CLI/spells/mage-hand.md), [minor illusion](/Mechaniky/CLI/spells/minor-illusion.md)"
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/dragon/token/faerie-dragon-red.webp"
```
^statblock
