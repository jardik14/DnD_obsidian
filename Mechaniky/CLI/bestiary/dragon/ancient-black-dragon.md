...
---
# [Ancient Black Dragon](Mechaniky\CLI\bestiary\dragon/ancient-black-dragon.md)
...
"lair_actions":
  - "desc": "On initiative count 20 (losing initiative ties), the dragon takes a lair\
      ...
      \ or be pulled up to 20 feet into the water and knocked [prone](/Mechaniky/CLI/Rules/conditions.md#Prone).\
      ...
      \ around corners. A creature with [darkvision](/Mechaniky/CLI/Rules/senses.md#Darkvision)\
      ...
      **Additional Lair Actions.** At your discretion, a legendary ([adult](/Mechaniky/CLI/bestiary/dragon/adult-black-dragon.md)\
      \ or [ancient](/Mechaniky/CLI/bestiary/dragon/ancient-black-dragon.md)) black\
      ...
      \ must succeed on a DC 15 Strength saving throw or be [restrained](/Mechaniky/CLI/Rules/conditions.md#Restrained)\
      ...
      \ Constitution saving throw or be [poisoned](/Mechaniky/CLI/Rules/conditions.md#Poisoned)\
...
"regional_effects":
  - "desc": "The region containing a legendary black dragon's lair is warped by the\
      ...
      \ lair, imposing disadvantage on Dexterity ([Stealth](/Mechaniky/CLI/Rules/skills.md#Stealth))\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/dragon/token/ancient-black-dragon.webp"
```
^statblock
