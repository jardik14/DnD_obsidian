...
- "Adult Silver Dragon"
---
# [Adult Silver Dragon](Mechaniky\CLI\bestiary\dragon/adult-silver-dragon.md)
...
"actions":
  ...
  - "desc": "The dragon uses one of the following breath weapons.\n\n- **Cold Breath.**\
      ...
      \ in that area must succeed on a DC 20 Constitution saving throw or be [paralyzed](/Mechaniky/CLI/Rules/conditions.md#Paralyzed)\
      \ for 1 minute. A creature can repeat the saving throw at the end of each of\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/dragon/token/adult-silver-dragon.webp"
```
^statblock
