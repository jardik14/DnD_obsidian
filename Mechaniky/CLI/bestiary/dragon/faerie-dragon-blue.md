...
- "Faerie Dragon (Blue)"
---
# [Faerie Dragon (Blue)](Mechaniky\CLI\bestiary\dragon/faerie-dragon-blue.md)
...
"traits":
  - "desc": "The dragon's innate spellcasting ability is Charisma (spell save DC 13).\
      ...
      \ lights](/Mechaniky/CLI/spells/dancing-lights.md), [mage hand](/Mechaniky/CLI/spells/mage-hand.md),\
      \ [major image](/Mechaniky/CLI/spells/major-image.md), [minor illusion](/Mechaniky/CLI/spells/minor-illusion.md),\
      \ [mirror image](/Mechaniky/CLI/spells/mirror-image.md), [suggestion](/Mechaniky/CLI/spells/suggestion.md)"
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/dragon/token/faerie-dragon-blue.webp"
```
^statblock
