...
- "Pseudodragon"
---
# [Pseudodragon](Mechaniky\CLI\bestiary\dragon/pseudodragon.md)
...
"cr": "1/4"
"traits":
  - "desc": "The pseudodragon has advantage on Wisdom ([Perception](/Mechaniky/CLI/Rules/skills.md#Perception))\
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +4 to hit, reach 5 ft., one creature. *Hit:* 4\
      ...
      \ for 1 hour. If the saving throw fails by 5 or more, the target falls [unconscious](/Mechaniky/CLI/Rules/conditions.md#Unconscious)\
      \ for the same duration, or until it takes damage or another creature uses an\
      \ action to shake it awake."
    "name": "Sting"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/dragon/token/pseudodragon.webp"
```
^statblock
