...
---
# [Ancient Silver Dragon](Mechaniky\CLI\bestiary\dragon/ancient-silver-dragon.md)
...
"actions":
  ...
  - "desc": "The dragon uses one of the following breath weapons.\n\n- **Cold Breath.**\
      ...
      \ in that area must succeed on a DC 24 Constitution saving throw or be [paralyzed](/Mechaniky/CLI/Rules/conditions.md#Paralyzed)\
      \ for 1 minute. A creature can repeat the saving throw at the end of each of\
...
"lair_actions":
  - "desc": "On initiative count 20 (losing initiative ties), the dragon takes a lair\
      ...
      \ as if it had cast the [fog cloud](/Mechaniky/CLI/spells/fog-cloud.md) spell.\
      ...
      \ a legendary ([adult](/Mechaniky/CLI/bestiary/dragon/adult-silver-dragon.md)\
      \ or [ancient](/Mechaniky/CLI/bestiary/dragon/ancient-silver-dragon.md)) silver\
      ...
      \ must succeed on a DC 15 Constitution saving throw or be [restrained](/Mechaniky/CLI/Rules/conditions.md#Restrained)\
...
"regional_effects":
  - "desc": "The region containing a legendary silver dragon's lair is warped by the\
      ...
      \ to the [control weather](/Mechaniky/CLI/spells/control-weather.md) spell.\
      ...
      \ to work, the dragon can make clouds and fog within its lair as solid as stone,\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/dragon/token/ancient-silver-dragon.webp"
```
^statblock
