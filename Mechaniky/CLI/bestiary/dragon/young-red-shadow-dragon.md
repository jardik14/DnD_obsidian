...
---
# [Young Red Shadow Dragon](Mechaniky\CLI\bestiary\dragon/young-red-shadow-dragon.md)
...
The dragon's proficiency bonus is doubled for its Dexterity ([Stealth](/Mechaniky/CLI/Rules/skills.md#Stealth)) checks.
...
While in dim light or darkness, the dragon can take the [Hide](/Mechaniky/CLI/Rules/actions.md#Hide) action as a bonus action.

### Sunlight Sensitivity

While in sunlight, the dragon has disadvantage on attack rolls, as well as on Wisdom ([Perception](/Mechaniky/CLI/Rules/skills.md#Perception)) checks that rely on sight.
...
"actions":
  ...
  - "desc": "The dragon exhales shadowy fire in a 30-foot cone. Each creature in that\
      ...
      \ to 0 hit points by this damage dies, and an undead [shadow](/Mechaniky/CLI/bestiary/undead/shadow.md)\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/dragon/token/young-red-shadow-dragon.webp"
```
^statblock
