...
- "Dragon Turtle"
---
# [Dragon Turtle](Mechaniky\CLI\bestiary\dragon/dragon-turtle.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +13 to hit, reach 15 ft., one target. *Hit:* 26\
      ...
      \ dragon turtle and knocked [prone](/Mechaniky/CLI/Rules/conditions.md#Prone)."
    "name": "Tail"
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/dragon/token/dragon-turtle.webp"
```
^statblock
