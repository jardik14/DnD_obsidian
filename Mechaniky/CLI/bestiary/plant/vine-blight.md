...
- "Vine Blight"
---
# [Vine Blight](Mechaniky\CLI\bestiary\plant/vine-blight.md)
...
"actions":
  - "desc": "*Melee Weapon Attack:* +4 to hit, reach 10 ft., one target. *Hit:* 9\
      \ (2d6 + 2) bludgeoning damage, and a Large or smaller target is [grappled](/Mechaniky/CLI/Rules/conditions.md#Grappled)\
  ...
  - "desc": "Grasping roots and vines sprout in a 15-foot radius centered on the blight,\
      ...
      \ throw or become [restrained](/Mechaniky/CLI/Rules/conditions.md#Restrained).\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/plant/token/vine-blight.webp"
```
^statblock
