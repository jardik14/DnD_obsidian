...
- "Myconid Adult"
---
# [Myconid Adult](Mechaniky\CLI\bestiary\plant/myconid-adult.md)
...
"actions":
  ...
  - "desc": "The myconid ejects spores at one creature it can see within 5 feet of\
      \ it. The target must succeed on a DC 11 Constitution saving throw or be [stunned](/Mechaniky/CLI/Rules/conditions.md#Stunned)\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/plant/token/myconid-adult.webp"
```
^statblock
