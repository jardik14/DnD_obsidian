...
- "Gas Spore"
---
# [Gas Spore](Mechaniky\CLI\bestiary\plant/gas-spore.md)
...
"traits":
  - "desc": "The gas spore explodes when it drops to 0 hit points. Each creature within\
      ...
      \ immune to the [poisoned](/Mechaniky/CLI/Rules/conditions.md#Poisoned) condition\
      ...
      \ [poisoned](/Mechaniky/CLI/Rules/conditions.md#Poisoned) for the rest of the\
  ...
  - "desc": "The gas spore resembles a beholder. A creature that can see the gas spore\
      \ can discern its true nature with a successful DC 15 Intelligence ([Nature](/Mechaniky/CLI/Rules/skills.md#Nature))\
      \ check."
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/plant/token/gas-spore.webp"
```
^statblock
