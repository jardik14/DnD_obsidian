...
- The tomb trembles violently for a moment. Each creature on the floor of the tomb must succeed on a DC 19 Dexterity saving throw or be knocked [prone](/Mechaniky/CLI/Rules/conditions.md#Prone).  
- The demilich targets one creature it can see within 60 feet of it. An [antimagic field](/Mechaniky/CLI/spells/antimagic-field.md) fills the space of the target, moving with it until initiative count 20 on the next round.  
...
- Monsters in the tomb have advantage on saving throws against being [charmed](/Mechaniky/CLI/Rules/conditions.md#Charmed) or [frightened](/Mechaniky/CLI/Rules/conditions.md#Frightened), and against features that turn undead.  
