...
At your discretion, a legendary ([adult](/Mechaniky/CLI/bestiary/dragon/adult-gold-dragon.md) or [ancient](/Mechaniky/CLI/bestiary/dragon/ancient-gold-dragon.md)) gold dragon can use the following additional lair action while in its lair:

- **Beguiling Glow.** Warm light fills a 30-foot-radius sphere centered on the dragon; each creature in that area must succeed on a DC 15 Wisdom saving throw or be [charmed](/Mechaniky/CLI/Rules/conditions.md#Charmed) by the dragon until initiative count 20 on the next round.  
