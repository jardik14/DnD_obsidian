...
- "Water Elemental"
---
# [Water Elemental](Mechaniky\CLI\bestiary\elemental/water-elemental.md)
...
"actions":
  ...
  - "desc": "Each creature in the elemental's space must make a DC 15 Strength saving\
      ...
      \ is Large or smaller, it is also [grappled](/Mechaniky/CLI/Rules/conditions.md#Grappled)\
      ...
      \ one time. At the start of each of the elemental's turns, each target [grappled](/Mechaniky/CLI/Rules/conditions.md#Grappled)\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/elemental/token/water-elemental.webp"
```
^statblock
