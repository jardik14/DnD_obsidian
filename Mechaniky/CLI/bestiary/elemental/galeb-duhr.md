...
- "Galeb Duhr"
---
# [Galeb Duhr](Mechaniky\CLI\bestiary\elemental/galeb-duhr.md)
...
"traits":
  ...
  - "desc": "If the galeb duhr rolls at least 20 feet straight toward a target and\
      ...
      \ a DC 16 Strength saving throw or be knocked [prone](/Mechaniky/CLI/Rules/conditions.md#Prone)."
    "name": "Rolling Charge"
"actions":
  ...
  - "desc": "The galeb duhr magically animates up to two boulders it can see within\
      ...
      \ it has Intelligence 1 and Charisma 1, it can't be [charmed](/Mechaniky/CLI/Rules/conditions.md#Charmed)\
      \ or [frightened](/Mechaniky/CLI/Rules/conditions.md#Frightened), and it lacks\
      \ this action option. A boulder remains animated as long as the galeb duhr maintains\
      \ [concentration](/Mechaniky/CLI/Rules/conditions.md#Concentration), up to 1\
      \ minute (as if [concentrating](/Mechaniky/CLI/Rules/conditions.md#Concentration)\
      \ on a spell)."
    "name": "Animate Boulders (1/Day)"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/elemental/token/galeb-duhr.webp"
```
^statblock
