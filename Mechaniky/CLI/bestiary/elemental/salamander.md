...
- "Salamander"
---
# [Salamander](Mechaniky\CLI\bestiary\elemental/salamander.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +7 to hit, reach 10 ft., one target. *Hit:* 11\
      \ (2d6 + 4) bludgeoning damage plus 7 (2d6) fire damage, and the target is [grappled](/Mechaniky/CLI/Rules/conditions.md#Grappled)\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/elemental/token/salamander.webp"
```
^statblock
