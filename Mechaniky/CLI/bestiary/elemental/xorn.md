...
- "Xorn"
---
# [Xorn](Mechaniky\CLI\bestiary\elemental/xorn.md)
...
"traits":
  - "desc": "The xorn can burrow through nonmagical, unworked earth and stone. While\
    ...
    "name": "Earth Glide"
  - "desc": "The xorn has advantage on Dexterity ([Stealth](/Mechaniky/CLI/Rules/skills.md#Stealth))\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/elemental/token/xorn.webp"
```
^statblock
