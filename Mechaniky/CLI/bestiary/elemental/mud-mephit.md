...
- "Mud Mephit"
---
# [Mud Mephit](Mechaniky\CLI\bestiary\elemental/mud-mephit.md)
...
"traits":
  - "desc": "When the mephit dies, it explodes in a burst of sticky mud. Each Medium\
      ...
      \ saving throw or be [restrained](/Mechaniky/CLI/Rules/conditions.md#Restrained)\
...
"actions":
  ...
  - "desc": "The mephit belches viscid mud onto one creature within 5 feet of it.\
      ...
      \ throw or be [restrained](/Mechaniky/CLI/Rules/conditions.md#Restrained) for\
      \ 1 minute. A creature can repeat the saving throw at the end of each of its\
      \ turns, ending the effect on itself on a success."
    "name": "Mud Breath (Recharge 6)"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/elemental/token/mud-mephit.webp"
```
^statblock
