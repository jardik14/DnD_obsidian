...
- "Air Elemental"
---
# [Air Elemental](Mechaniky\CLI\bestiary\elemental/air-elemental.md)
...
"actions":
  ...
  - "desc": "Each creature in the elemental's space must make a DC 13 Strength saving\
      ...
      \ [prone](/Mechaniky/CLI/Rules/conditions.md#Prone). If a thrown target strikes\
      ...
      \ damage and be knocked [prone](/Mechaniky/CLI/Rules/conditions.md#Prone).\n\
      \nIf the saving throw is successful, the target takes half the bludgeoning damage\
      \ and isn't flung away or knocked [prone](/Mechaniky/CLI/Rules/conditions.md#Prone)."
    "name": "Whirlwind (Recharge 4-6)"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/elemental/token/air-elemental.webp"
```
^statblock
