...
- "Ettercap"
---
# [Ettercap](Mechaniky\CLI\bestiary\monstrosity/ettercap.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +4 to hit, reach 5 ft., one creature. *Hit:* 6\
      ...
      \ on a DC 11 Constitution saving throw or be [poisoned](/Mechaniky/CLI/Rules/conditions.md#Poisoned)\
  ...
  - "desc": "*Ranged Weapon Attack:* +4 to hit, range 30/60 ft., one Large or smaller\
      \ creature. *Hit:* The creature is [restrained](/Mechaniky/CLI/Rules/conditions.md#Restrained)\
      \ by webbing. As an action, the [restrained](/Mechaniky/CLI/Rules/conditions.md#Restrained)\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/monstrosity/token/ettercap.webp"
```
^statblock
