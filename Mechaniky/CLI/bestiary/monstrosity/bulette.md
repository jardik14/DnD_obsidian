...
- "Bulette"
---
# [Bulette](Mechaniky\CLI\bestiary\monstrosity/bulette.md)
...
"actions":
  ...
  - "desc": "If the bulette jumps at least 15 feet as part of its movement, it can\
      ...
      \ or Dexterity saving throw (target's choice) or be knocked [prone](/Mechaniky/CLI/Rules/conditions.md#Prone)\
      ...
      \ [prone](/Mechaniky/CLI/Rules/conditions.md#Prone), and is pushed 5 feet out\
      \ of the bulette's space into an unoccupied space of the creature's choice.\
      \ If no unoccupied space is within range, the creature instead falls [prone](/Mechaniky/CLI/Rules/conditions.md#Prone)\
      \ in the bulette's space."
    "name": "Deadly Leap"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/monstrosity/token/bulette.webp"
```
^statblock
