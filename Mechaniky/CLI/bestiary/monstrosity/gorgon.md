...
- "Gorgon"
---
# [Gorgon](Mechaniky\CLI\bestiary\monstrosity/gorgon.md)
...
"traits":
  - "desc": "If the gorgon moves at least 20 feet straight toward a creature and then\
      ...
      \ DC 16 Strength saving throw or be knocked [prone](/Mechaniky/CLI/Rules/conditions.md#Prone).\
      \ If the target is [prone](/Mechaniky/CLI/Rules/conditions.md#Prone), the gorgon\
...
"actions":
  ...
  - "desc": "The gorgon exhales petrifying gas in a 30-foot cone. Each creature in\
      ...
      \ a target begins to turn to stone and is [restrained](/Mechaniky/CLI/Rules/conditions.md#Restrained).\
      \ The [restrained](/Mechaniky/CLI/Rules/conditions.md#Restrained) target must\
      \ repeat the saving throw at the end of its next turn. On a success, the effect\
      \ ends on the target. On a failure, the target is [petrified](/Mechaniky/CLI/Rules/conditions.md#Petrified)\
      \ until freed by the  [greater restoration](/Mechaniky/CLI/spells/greater-restoration.md)\
      \ spell or other magic."
    "name": "Petrifying Breath (Recharge 5-6)"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/monstrosity/token/gorgon.webp"
```
^statblock
