...
- "Roper"
---
# [Roper](Mechaniky\CLI\bestiary\monstrosity/roper.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +7 to hit, reach 50 ft., one creature. *Hit:*\
      \ The target is [grappled](/Mechaniky/CLI/Rules/conditions.md#Grappled) (escape\
      \ DC 15). Until the grapple ends, the target is [restrained](/Mechaniky/CLI/Rules/conditions.md#Restrained)\
    ...
    "name": "Tendril"
  - "desc": "The roper pulls each creature [grappled](/Mechaniky/CLI/Rules/conditions.md#Grappled)\
      \ by it up to 25 feet straight toward it."
    "name": "Reel"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/monstrosity/token/roper.webp"
```
^statblock
