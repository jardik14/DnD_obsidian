...
- "Peryton"
---
# [Peryton](Mechaniky\CLI\bestiary\monstrosity/peryton.md)
...
"traits":
  ...
  - "desc": "The peryton doesn't provoke an opportunity attack when it flies out of\
      \ an enemy's reach."
    "name": "Flyby"
  - "desc": "The peryton has advantage on Wisdom ([Perception](/Mechaniky/CLI/Rules/skills.md#Perception))\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/monstrosity/token/peryton.webp"
```
^statblock
