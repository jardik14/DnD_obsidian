...
- "Behir"
---
# [Behir](Mechaniky\CLI\bestiary\monstrosity/behir.md)
...
"senses": "[darkvision](/Mechaniky/CLI/Rules/senses.md#Darkvision) 90 ft., passive\
  \ Perception 16"
"languages": "Draconic"
"cr": "11"
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +10 to hit, reach 5 ft., one Large or smaller\
      ...
      \ damage. The target is [grappled](/Mechaniky/CLI/Rules/conditions.md#Grappled)\
      \ (escape DC 16) if the behir isn't already constricting a creature, and the\
      \ target is [restrained](/Mechaniky/CLI/Rules/conditions.md#Restrained) until\
      \ this grapple ends."
    "name": "Constrict"
  ...
  - "desc": "The behir makes one bite attack against a Medium or smaller target it\
      ...
      \ ends. While swallowed, the target is [blinded](/Mechaniky/CLI/Rules/conditions.md#Blinded)\
      ...
      \ the creature, which falls [prone](/Mechaniky/CLI/Rules/conditions.md#Prone)\
      ...
      \ it and can escape from the corpse by using 15 feet of movement, exiting [prone](/Mechaniky/CLI/Rules/conditions.md#Prone)."
    "name": "Swallow"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/monstrosity/token/behir.webp"
```
^statblock
