...
- "Yuan-ti Abomination"
---
# [Yuan-ti Abomination](Mechaniky\CLI\bestiary\monstrosity/yuan-ti-abomination.md)
...
"traits":
  - "desc": "The yuan-ti's innate spellcasting ability is Charisma (spell save DC\
      ...
      \ components:\n\n**At will:** [animal friendship](/Mechaniky/CLI/spells/animal-friendship.md)\
      \ (snakes only)\n\n**3/day:** [suggestion](/Mechaniky/CLI/spells/suggestion.md)\n\
      \n**1/day:** [fear](/Mechaniky/CLI/spells/fear.md)"
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +7 to hit, reach 10 ft., one target. *Hit:* 11\
      \ (2d6 + 4) bludgeoning damage, and the target is [grappled](/Mechaniky/CLI/Rules/conditions.md#Grappled)\
      \ (escape DC 14). Until this grapple ends, the target is [restrained](/Mechaniky/CLI/Rules/conditions.md#Restrained),\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/monstrosity/token/yuan-ti-abomination.webp"
```
^statblock
