...
- "Grick Alpha"
---
# [Grick Alpha](Mechaniky\CLI\bestiary\monstrosity/grick-alpha.md)
...
"cr": "7"
"traits":
  - "desc": "The grick has advantage on Dexterity ([Stealth](/Mechaniky/CLI/Rules/skills.md#Stealth))\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/monstrosity/token/grick-alpha.webp"
```
^statblock
