...
- "Hydra"
---
# [Hydra](Mechaniky\CLI\bestiary\monstrosity/hydra.md)
...
"traits":
  ...
  - "desc": "The hydra has five heads. While it has more than one head, the hydra\
      \ has advantage on saving throws against being [blinded](/Mechaniky/CLI/Rules/conditions.md#Blinded),\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/monstrosity/token/hydra.webp"
```
^statblock
