...
- "Kraken"
---
# [Kraken](Mechaniky\CLI\bestiary\monstrosity/kraken.md)
...
"condition_immunities": "[frightened](/Mechaniky/CLI/Rules/conditions.md#Frightened),\
  \ [paralyzed](/Mechaniky/CLI/Rules/conditions.md#Paralyzed)"
...
"traits":
  ...
  - "desc": "The kraken ignores difficult terrain, and magical effects can't reduce\
      \ its speed or cause it to be [restrained](/Mechaniky/CLI/Rules/conditions.md#Restrained).\
      \ It can spend 5 feet of movement to escape from nonmagical restraints or being\
      \ [grappled](/Mechaniky/CLI/Rules/conditions.md#Grappled)."
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +17 to hit, reach 5 ft., one target. *Hit:* 23\
      \ (3d8 + 10) piercing damage. If the target is a Large or smaller creature [grappled](/Mechaniky/CLI/Rules/conditions.md#Grappled)\
      \ by the kraken, that creature is swallowed, and the grapple ends. While swallowed,\
      \ the creature is [blinded](/Mechaniky/CLI/Rules/conditions.md#Blinded) and\
      \ [restrained](/Mechaniky/CLI/Rules/conditions.md#Restrained), it has total\
      ...
      \ or regurgitate all swallowed creatures, which fall [prone](/Mechaniky/CLI/Rules/conditions.md#Prone)\
      ...
      \ it and can escape from the corpse using 15 feet of movement, exiting [prone](/Mechaniky/CLI/Rules/conditions.md#Prone)."
    "name": "Bite"
  - "desc": "*Melee Weapon Attack:* +17 to hit, reach 30 ft., one target. *Hit:* 20\
      \ (3d6 + 10) bludgeoning damage, and the target is [grappled](/Mechaniky/CLI/Rules/conditions.md#Grappled)\
      \ (escape DC 18). Until this grapple ends, the target is [restrained](/Mechaniky/CLI/Rules/conditions.md#Restrained).\
      \ The kraken has ten tentacles, each of which can grapple one target."
    "name": "Tentacle"
  - "desc": "One Large or smaller object held or creature [grappled](/Mechaniky/CLI/Rules/conditions.md#Grappled)\
      \ by the kraken is thrown up to 60 feet in a random direction and knocked [prone](/Mechaniky/CLI/Rules/conditions.md#Prone).\
      ...
      \ take the same damage and be knocked [prone](/Mechaniky/CLI/Rules/conditions.md#Prone)."
    "name": "Fling"
...
"regional_effects":
  - "desc": "The region containing a kraken's lair is warped by the creature's blasphemous\
      ...
      \ identical to the [control weather](/Mechaniky/CLI/spells/control-weather.md)\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/monstrosity/token/kraken.webp"
```
^statblock
