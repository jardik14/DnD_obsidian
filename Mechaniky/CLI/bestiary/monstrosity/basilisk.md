...
- "Basilisk"
---
# [Basilisk](Mechaniky\CLI\bestiary\monstrosity/basilisk.md)
...
Some alchemists are said to know how to process the basilisk's gullet and the fluids contained within. Properly handled, the gullet produces an oil that can return [petrified](/Mechaniky/CLI/Rules/conditions.md#Petrified) creatures to flesh and life. Unfortunately for such a victim, any parts lost in stone form remain absent if the creature revives. Revivification using the oil is impossible if a vital part of the [petrified](/Mechaniky/CLI/Rules/conditions.md#Petrified) creature, such as its head, is detached.
...
"traits":
  - "desc": "If a creature starts its turn within 30 feet of the basilisk and the\
      ...
      \ a DC 12 Constitution saving throw if the basilisk isn't [incapacitated](/Mechaniky/CLI/Rules/conditions.md#Incapacitated).\
      \ On a failed save, the creature magically begins to turn to stone and is [restrained](/Mechaniky/CLI/Rules/conditions.md#Restrained).\
      \ It must repeat the saving throw at the end of its next turn. On a success,\
      \ the effect ends. On a failure, the creature is [petrified](/Mechaniky/CLI/Rules/conditions.md#Petrified)\
      \ until freed by the  [greater restoration](/Mechaniky/CLI/spells/greater-restoration.md)\
      \ spell or other magic.\n\nA creature that isn't [surprised](/Mechaniky/CLI/Rules/conditions.md#Surprised)\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/monstrosity/token/basilisk.webp"
```
^statblock
