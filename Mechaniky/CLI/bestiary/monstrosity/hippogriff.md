...
- "Hippogriff"
---
# [Hippogriff](Mechaniky\CLI\bestiary\monstrosity/hippogriff.md)
...
"cr": "1"
"traits":
  - "desc": "The hippogriff has advantage on Wisdom ([Perception](/Mechaniky/CLI/Rules/skills.md#Perception))\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/monstrosity/token/hippogriff.webp"
```
^statblock
