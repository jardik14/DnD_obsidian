...
- "Carrion Crawler"
---
# [Carrion Crawler](Mechaniky\CLI\bestiary\monstrosity/carrion-crawler.md)
...
"cr": "2"
"traits":
  - "desc": "The carrion crawler has advantage on Wisdom ([Perception](/Mechaniky/CLI/Rules/skills.md#Perception))\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/monstrosity/token/carrion-crawler.webp"
```
^statblock
