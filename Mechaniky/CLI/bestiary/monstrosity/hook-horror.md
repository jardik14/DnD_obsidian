...
- "Hook Horror"
---
# [Hook Horror](Mechaniky\CLI\bestiary\monstrosity/hook-horror.md)
...
"cr": "3"
"traits":
  - "desc": "The hook horror can't use its blindsight while [deafened](/Mechaniky/CLI/Rules/conditions.md#Deafened)."
    "name": "Echolocation"
  - "desc": "The hook horror has advantage on Wisdom ([Perception](/Mechaniky/CLI/Rules/skills.md#Perception))\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/monstrosity/token/hook-horror.webp"
```
^statblock
