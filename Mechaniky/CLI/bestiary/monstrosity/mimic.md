...
- "Mimic"
---
# [Mimic](Mechaniky\CLI\bestiary\monstrosity/mimic.md)
...
"traits":
  ...
  - "desc": "The mimic adheres to anything that touches it. A Huge or smaller creature\
      \ adhered to the mimic is also [grappled](/Mechaniky/CLI/Rules/conditions.md#Grappled)\
  ...
  - "desc": "The mimic has advantage on attack rolls against any creature [grappled](/Mechaniky/CLI/Rules/conditions.md#Grappled)\
      \ by it."
    "name": "Grappler"
"actions":
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/monstrosity/token/mimic.webp"
```
^statblock
