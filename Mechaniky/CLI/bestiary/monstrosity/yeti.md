...
- "Yeti"
---
# [Yeti](Mechaniky\CLI\bestiary\monstrosity/yeti.md)
...
"actions":
  ...
  - "desc": "The yeti targets one creature it can see within 30 feet of it. If the\
      ...
      \ throw against this magic or take 10 (3d6) cold damage and then be [paralyzed](/Mechaniky/CLI/Rules/conditions.md#Paralyzed)\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/monstrosity/token/yeti.webp"
```
^statblock
