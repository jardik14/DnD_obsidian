...
- "Roc"
---
# [Roc](Mechaniky\CLI\bestiary\monstrosity/roc.md)
...
"cr": "11"
"traits":
  - "desc": "The roc has advantage on Wisdom ([Perception](/Mechaniky/CLI/Rules/skills.md#Perception))\
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +13 to hit, reach 5 ft., one target. *Hit:* 23\
      \ (4d6 + 9) slashing damage, and the target is [grappled](/Mechaniky/CLI/Rules/conditions.md#Grappled)\
      \ (escape DC 19). Until this grapple ends, the target is [restrained](/Mechaniky/CLI/Rules/conditions.md#Restrained),\
      \ and the roc can't use its talons on another target."
    "name": "Talons"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/monstrosity/token/roc.webp"
```
^statblock
