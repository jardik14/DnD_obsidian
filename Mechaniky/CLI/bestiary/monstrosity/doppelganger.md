...
- "Doppelganger"
---
# [Doppelganger](Mechaniky\CLI\bestiary\monstrosity/doppelganger.md)
...
"traits":
  ...
  - "desc": "In the first round of a combat, the doppelganger has advantage on attack\
      \ rolls against any creature it [surprised](/Mechaniky/CLI/Rules/conditions.md#Surprised)."
    "name": "Ambusher"
...
"actions":
  ...
  - "desc": "The doppelganger magically reads the surface thoughts of one creature\
      ...
      \ thoughts, as long as the doppelganger's [concentration](/Mechaniky/CLI/Rules/conditions.md#Concentration)\
      \ isn't broken (as if [concentrating](/Mechaniky/CLI/Rules/conditions.md#Concentration)\
      \ on a spell). While reading the target's mind, the doppelganger has advantage\
      \ on Wisdom ([Insight](/Mechaniky/CLI/Rules/skills.md#Insight)) and Charisma\
      \ ([Deception](/Mechaniky/CLI/Rules/skills.md#Deception), [Intimidation](/Mechaniky/CLI/Rules/skills.md#Intimidation),\
      \ and [Persuasion](/Mechaniky/CLI/Rules/skills.md#Persuasion)) checks against\
      \ the target."
    "name": "Read Thoughts"
"source":
  - "MM"
  - "LMoP"
"image": "/Mechaniky/CLI/bestiary/monstrosity/token/doppelganger.webp"
```
^statblock
