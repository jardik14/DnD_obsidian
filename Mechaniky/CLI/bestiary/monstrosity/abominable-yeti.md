...
- "Abominable Yeti"
---
# [Abominable Yeti](Mechaniky\CLI\bestiary\monstrosity/abominable-yeti.md)
...
"traits":
  - "desc": "If the yeti takes fire damage, it has disadvantage on attack rolls and\
    ...
    "name": "Fear of Fire"
  - "desc": "The yeti has advantage on Wisdom ([Perception](/Mechaniky/CLI/Rules/skills.md#Perception))\
      \ checks that rely on smell."
    "name": "Keen Smell"
  - "desc": "The yeti has advantage on Dexterity ([Stealth](/Mechaniky/CLI/Rules/skills.md#Stealth))\
...
"actions":
  ...
  - "desc": "The yeti targets one creature it can see within 30 feet of it. If the\
      ...
      \ throw against this magic or take 21 (6d6) cold damage and then be [paralyzed](/Mechaniky/CLI/Rules/conditions.md#Paralyzed)\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/monstrosity/token/abominable-yeti.webp"
```
^statblock
