...
- "Cockatrice"
---
# [Cockatrice](Mechaniky\CLI\bestiary\monstrosity/cockatrice.md)
...
"actions":
  - "desc": "*Melee Weapon Attack:* +3 to hit, reach 5 ft., one creature. *Hit:* 3\
      ...
      \ saving throw against being magically [petrified](/Mechaniky/CLI/Rules/conditions.md#Petrified).\
      \ On a failed save, the creature begins to turn to stone and is [restrained](/Mechaniky/CLI/Rules/conditions.md#Restrained).\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/monstrosity/token/cockatrice.webp"
```
^statblock
