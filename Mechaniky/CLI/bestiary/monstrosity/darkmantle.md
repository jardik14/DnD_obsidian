...
- "Darkmantle"
---
# [Darkmantle](Mechaniky\CLI\bestiary\monstrosity/darkmantle.md)
...
"cr": "1/2"
"traits":
  - "desc": "The darkmantle can't use its blindsight while [deafened](/Mechaniky/CLI/Rules/conditions.md#Deafened)."
    "name": "Echolocation"
...
"actions":
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 5 ft., one creature. *Hit:* 6\
      ...
      \ roll, it attaches by engulfing the target's head, and the target is also [blinded](/Mechaniky/CLI/Rules/conditions.md#Blinded)\
  ...
  - "desc": "A 15-foot radius of magical darkness extends out from the darkmantle,\
      ...
      \ darkmantle maintains [concentration](/Mechaniky/CLI/Rules/conditions.md#Concentration),\
      \ up to 10 minutes (as if [concentrating](/Mechaniky/CLI/Rules/conditions.md#Concentration)\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/monstrosity/token/darkmantle.webp"
```
^statblock
