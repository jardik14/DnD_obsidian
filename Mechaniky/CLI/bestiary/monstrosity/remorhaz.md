...
- "Remorhaz"
---
# [Remorhaz](Mechaniky\CLI\bestiary\monstrosity/remorhaz.md)
...
"senses": "[darkvision](/Mechaniky/CLI/Rules/senses.md#Darkvision) 60 ft., tremorsense\
...
"actions":
  - "desc": "*Melee Weapon Attack:* +11 to hit, reach 10 ft., one target. *Hit:* 40\
      ...
      \ it is [grappled](/Mechaniky/CLI/Rules/conditions.md#Grappled) (escape DC 17).\
      \ Until this grapple ends, the target is [restrained](/Mechaniky/CLI/Rules/conditions.md#Restrained),\
  ...
  - "desc": "The remorhaz makes one bite attack against a Medium or smaller creature\
      ...
      \ and is swallowed, and the grapple ends. While swallowed, the creature is [blinded](/Mechaniky/CLI/Rules/conditions.md#Blinded)\
      ...
      \ of that turn or regurgitate all swallowed creatures, which fall [prone](/Mechaniky/CLI/Rules/conditions.md#Prone)\
      \ in a space within 10 feet of the remorhaz. If the remorhaz dies, a swallowed\
      \ creature is no longer [restrained](/Mechaniky/CLI/Rules/conditions.md#Restrained)\
      \ by it and can escape from the corpse using 15 feet of movement, exiting [prone](/Mechaniky/CLI/Rules/conditions.md#Prone)."
    "name": "Swallow"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/monstrosity/token/remorhaz.webp"
```
^statblock
