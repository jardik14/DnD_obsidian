...
- "Ankheg"
---
# [Ankheg](Mechaniky\CLI\bestiary\monstrosity/ankheg.md)
...
"actions":
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 5 ft., one target. *Hit:* 10\
      ...
      \ or smaller creature, it is [grappled](/Mechaniky/CLI/Rules/conditions.md#Grappled)\
      \ (escape DC 13). Until this grapple ends, the ankheg can bite only the [grappled](/Mechaniky/CLI/Rules/conditions.md#Grappled)\
  ...
  - "desc": "The ankheg spits acid in a line that is 30 feet long and 5 feet wide,\
      \ provided that it has no creature [grappled](/Mechaniky/CLI/Rules/conditions.md#Grappled).\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/monstrosity/token/ankheg.webp"
```
^statblock
