...
- "Tarrasque"
---
# [Tarrasque](Mechaniky\CLI\bestiary\monstrosity/tarrasque.md)
...
"traits":
  ...
  - "desc": "Any time the tarrasque is targeted by a [magic missile](/Mechaniky/CLI/spells/magic-missile.md)\
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +19 to hit, reach 10 ft., one target. *Hit:* 36\
      \ (4d12 + 10) piercing damage. If the target is a creature, it is [grappled](/Mechaniky/CLI/Rules/conditions.md#Grappled)\
      \ (escape DC 20). Until this grapple ends, the target is [restrained](/Mechaniky/CLI/Rules/conditions.md#Restrained),\
  ...
  - "desc": "*Melee Weapon Attack:* +19 to hit, reach 20 ft., one target. *Hit:* 24\
      ...
      \ on a DC 20 Strength saving throw or be knocked [prone](/Mechaniky/CLI/Rules/conditions.md#Prone)."
    "name": "Tail"
  - "desc": "Each creature of the tarrasque's choice within 120 feet of it and aware\
      \ of it must succeed on a DC 17 Wisdom saving throw or become [frightened](/Mechaniky/CLI/Rules/conditions.md#Frightened)\
  ...
  - "desc": "The tarrasque makes one bite attack against a Large or smaller creature\
      ...
      \ [blinded](/Mechaniky/CLI/Rules/conditions.md#Blinded) and [restrained](/Mechaniky/CLI/Rules/conditions.md#Restrained),\
      ...
      \ fall [prone](/Mechaniky/CLI/Rules/conditions.md#Prone) in a space within 10\
      \ feet of the tarrasque. If the tarrasque dies, a swallowed creature is no longer\
      \ [restrained](/Mechaniky/CLI/Rules/conditions.md#Restrained) by it and can\
      \ escape from the corpse by using 30 feet of movement, exiting [prone](/Mechaniky/CLI/Rules/conditions.md#Prone)."
    "name": "Swallow"
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/monstrosity/token/tarrasque.webp"
```
^statblock
