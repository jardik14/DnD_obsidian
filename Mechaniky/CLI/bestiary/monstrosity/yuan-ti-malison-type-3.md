...
---
# [Yuan-ti Malison (Type 3)](Mechaniky\CLI\bestiary\monstrosity/yuan-ti-malison-type-3.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 5 ft., one target. *Hit:* 10\
      \ (2d6 + 3) bludgeoning damage, and the target is [grappled](/Mechaniky/CLI/Rules/conditions.md#Grappled)\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/monstrosity/token/yuan-ti-malison-type-3.webp"
```
^statblock
