...
- "Dryad"
---
# [Dryad](Mechaniky\CLI\bestiary\fey/dryad.md)
...
Dryads act as guardians of their woodland demesnes. Shy and reclusive, they watch interlopers from the trees. A dryad struck by the beauty of a stranger might investigate more closely, perhaps even try to lure the individual away to be [charmed](/Mechaniky/CLI/Rules/conditions.md#Charmed).
...
"traits":
  - "desc": "The dryad's innate spellcasting ability is Charisma (spell save DC 14).\
      ...
      \ each:** [entangle](/Mechaniky/CLI/spells/entangle.md), [goodberry](/Mechaniky/CLI/spells/goodberry.md)\n\
      \n**1/day each:** [barkskin](/Mechaniky/CLI/spells/barkskin.md), [pass without\
      \ trace](/Mechaniky/CLI/spells/pass-without-trace.md), [shillelagh](/Mechaniky/CLI/spells/shillelagh.md)"
...
"actions":
  ...
  - "desc": "The dryad targets one humanoid or beast that she can see within 30 feet\
      ...
      \ saving throw or be magically [charmed](/Mechaniky/CLI/Rules/conditions.md#Charmed).\
      \ The [charmed](/Mechaniky/CLI/Rules/conditions.md#Charmed) creature regards\
      ...
      \ can have no more than one humanoid and up to three beasts [charmed](/Mechaniky/CLI/Rules/conditions.md#Charmed)\
      \ at a time."
    "name": "Fey Charm"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/fey/token/dryad.webp"
```
^statblock
