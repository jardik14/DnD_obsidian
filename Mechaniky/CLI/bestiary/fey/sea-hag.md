...
- "Sea Hag"
---
# [Sea Hag](Mechaniky\CLI\bestiary\fey/sea-hag.md)
...
"traits":
  ...
  - "desc": "Any humanoid that starts its turn within 30 feet of the hag and can see\
      ...
      \ the creature is [frightened](/Mechaniky/CLI/Rules/conditions.md#Frightened)\
      ...
      \ for the next 24 hours.\n\nUnless the target is [surprised](/Mechaniky/CLI/Rules/conditions.md#Surprised)\
...
"actions":
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 5 ft., one target. *Hit:* 10\
    ...
    "name": "Claws"
  - "desc": "The hag targets one [frightened](/Mechaniky/CLI/Rules/conditions.md#Frightened)\
...
"lair_actions":
  - "desc": "The following lair actions are options for grandmothers and powerful\
      ...
      \ of that creature (as if created with the [simulacrum](/Mechaniky/CLI/spells/simulacrum.md)\
...
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/fey/token/sea-hag.webp"
```
^statblock
