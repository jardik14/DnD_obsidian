...
- "Pixie"
---
# [Pixie](Mechaniky\CLI\bestiary\fey/pixie.md)
...
"traits":
  - "desc": "The pixie's innate spellcasting ability is Charisma (spell save DC 12).\
      ...
      \ a component:\n\n**At will:** [druidcraft](/Mechaniky/CLI/spells/druidcraft.md)\n\
      \n**1/day each:** [confusion](/Mechaniky/CLI/spells/confusion.md), [dancing\
      \ lights](/Mechaniky/CLI/spells/dancing-lights.md), [detect evil and good](/Mechaniky/CLI/spells/detect-evil-and-good.md),\
      \ [detect thoughts](/Mechaniky/CLI/spells/detect-thoughts.md), [dispel magic](/Mechaniky/CLI/spells/dispel-magic.md),\
      \ [entangle](/Mechaniky/CLI/spells/entangle.md), [fly](/Mechaniky/CLI/spells/fly.md),\
      \ [phantasmal force](/Mechaniky/CLI/spells/phantasmal-force.md), [polymorph](/Mechaniky/CLI/spells/polymorph.md),\
...
"actions":
  - "desc": "The pixie magically turns [invisible](/Mechaniky/CLI/Rules/conditions.md#Invisible)\
      \ until its [concentration](/Mechaniky/CLI/Rules/conditions.md#Concentration)\
      \ ends (as if [concentrating](/Mechaniky/CLI/Rules/conditions.md#Concentration)\
      \ on a spell). Any equipment the pixie wears or carries is [invisible](/Mechaniky/CLI/Rules/conditions.md#Invisible)\
      \ with it."
    "name": "Superior Invisibility"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/fey/token/pixie.webp"
```
^statblock
