...
- "Green Hag"
---
# [Green Hag](Mechaniky\CLI\bestiary\fey/green-hag.md)
...
> 
> 1st level (4 slots): [identify](/Mechaniky/CLI/spells/identify.md), [ray of sickness](/Mechaniky/CLI/spells/ray-of-sickness.md)  
> 2nd level (3 slots): [hold person](/Mechaniky/CLI/spells/hold-person.md), [locate object](/Mechaniky/CLI/spells/locate-object.md)  
> 3rd level (3 slots): [bestow curse](/Mechaniky/CLI/spells/bestow-curse.md), [counterspell](/Mechaniky/CLI/spells/counterspell.md), [lightning bolt](/Mechaniky/CLI/spells/lightning-bolt.md)  
> 4th level (3 slots): [phantasmal killer](/Mechaniky/CLI/spells/phantasmal-killer.md), [polymorph](/Mechaniky/CLI/spells/polymorph.md)  
> 5th level (2 slots): [contact other plane](/Mechaniky/CLI/spells/contact-other-plane.md), [scrying](/Mechaniky/CLI/spells/scrying.md)  
> 6th level (1 slot): [eyebite](/Mechaniky/CLI/spells/eyebite.md)  
> 
> For casting these spells, each hag is a 12th-level spellcaster that uses Intelligence as her spellcasting ability. The spell save DC is 12 + the hag's Intelligence modifier, and the spell attack bonus is 4 + the hag's Intelligence modifier.
> 
> **Hag Eye.** A hag coven can craft a magic item called a hag eye, which is made from a real eye coated in varnish and often fitted to a pendant or other wearable item. The hag eye is usually entrusted to a minion for safekeeping and transport. A hag in the coven can take an action to see what the hag eye sees if the hag eye is on the same plane of existence. A hag eye has AC 10, 1 hit point, and [darkvision](/Mechaniky/CLI/Rules/senses.md#Darkvision) with a radius of 60 feet. If it is destroyed, each coven member takes `3d10` psychic damage and is [blinded](/Mechaniky/CLI/Rules/conditions.md#Blinded) for 24 hours.
> 
> A hag coven can have only one hag eye at a time, and creating a new one requires all three members of the coven to perform a ritual. The ritual takes 1 hour, and the hags can't perform it while [blinded](/Mechaniky/CLI/Rules/conditions.md#Blinded). During the ritual, if the hags take any action other than performing the ritual, they must start over.
^hag-covens
...
"traits":
  - "desc": "The hag's innate spellcasting ability is Charisma (spell save DC 12).\
      ...
      \n**At will:** [dancing lights](/Mechaniky/CLI/spells/dancing-lights.md), [minor\
      \ illusion](/Mechaniky/CLI/spells/minor-illusion.md), [vicious mockery](/Mechaniky/CLI/spells/vicious-mockery.md)"
  ...
  - "desc": "The hag can mimic animal sounds and humanoid voices. A creature that\
      ...
      \ ([Insight](/Mechaniky/CLI/Rules/skills.md#Insight)) check."
    "name": "Mimicry"
"actions":
  ...
  - "desc": "The hag covers herself and anything she is wearing or carrying with a\
      ...
      \ Intelligence ([Investigation](/Mechaniky/CLI/Rules/skills.md#Investigation))\
      \ check to discern that the hag is disguised."
    "name": "Illusory Appearance"
  - "desc": "The hag magically turns [invisible](/Mechaniky/CLI/Rules/conditions.md#Invisible)\
      \ until she attacks or casts a spell, or until her [concentration](/Mechaniky/CLI/Rules/conditions.md#Concentration)\
      \ ends (as if [concentrating](/Mechaniky/CLI/Rules/conditions.md#Concentration)\
      \ on a spell). While [invisible](/Mechaniky/CLI/Rules/conditions.md#Invisible),\
      \ she leaves no physical evidence of her passage, so she can be tracked only\
      \ by magic. Any equipment she wears or carries is [invisible](/Mechaniky/CLI/Rules/conditions.md#Invisible)\
      \ with her."
...
"regional_effects":
  - "desc": "Each hag's lair is the source of three to five regional effects; the\
      ...
      \ score of 2 or lower are [charmed](/Mechaniky/CLI/Rules/conditions.md#Charmed)\
      ...
      \ mud.  \n- Trees transform into [awakened trees](/Mechaniky/CLI/bestiary/plant/awakened-tree.md)\
      \ and attack when hostile intruders are near.  "
    "name": ""
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/fey/token/green-hag.webp"
```
^statblock
