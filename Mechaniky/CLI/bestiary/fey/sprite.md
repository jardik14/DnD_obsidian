...
- "Sprite"
---
# [Sprite](Mechaniky\CLI\bestiary\fey/sprite.md)
...
"gear":
  ...
  - "[shortbow](/Mechaniky/CLI/items/shortbow.md)"
...
"actions":
  ...
  - "desc": "*Ranged Weapon Attack:* +6 to hit, range 40/160 ft., one target. *Hit:*\
      ...
      \ throw or become [poisoned](/Mechaniky/CLI/Rules/conditions.md#Poisoned) for\
      \ 1 minute. If its saving throw result is 5 or lower, the [poisoned](/Mechaniky/CLI/Rules/conditions.md#Poisoned)\
      \ target falls [unconscious](/Mechaniky/CLI/Rules/conditions.md#Unconscious)\
  ...
  - "desc": "The sprite touches a creature and magically knows the creature's current\
    ...
    "name": "Heart Sight"
  - "desc": "The sprite magically turns [invisible](/Mechaniky/CLI/Rules/conditions.md#Invisible)\
      \ until it attacks or casts a spell, or until its [concentration](/Mechaniky/CLI/Rules/conditions.md#Concentration)\
      \ ends (as if [concentrating](/Mechaniky/CLI/Rules/conditions.md#Concentration)\
      \ on a spell). Any equipment the sprite wears or carries is [invisible](/Mechaniky/CLI/Rules/conditions.md#Invisible)\
      \ with it."
    "name": "Invisibility"
"source":
  - "MM"
"image": "/Mechaniky/CLI/bestiary/fey/token/sprite.webp"
```
^statblock
