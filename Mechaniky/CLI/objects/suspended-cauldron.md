...
Cauldrons can be filled with other liquids, such as acid or [green slime](/Mechaniky/CLI/traps-hazards/green-slime.md), with different effects.

```ad-statblock
title: Suspended Cauldron
![](/Mechaniky/CLI/objects/token/suspended-cauldron.webp#token)
*Large Siege weapon*
