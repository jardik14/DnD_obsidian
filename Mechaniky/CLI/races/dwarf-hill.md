...
![](/Mechaniky/CLI/races/img/dwarf.webp#right)
...
You have proficiency with the [battleaxe](/Mechaniky/CLI/items/battleaxe.md), [handaxe](/Mechaniky/CLI/items/handaxe.md), [light hammer](/Mechaniky/CLI/items/light-hammer.md), and [warhammer](/Mechaniky/CLI/items/warhammer.md).

### Tool Proficiency

You gain proficiency with the [artisan's tools](/Mechaniky/CLI/items/artisans-tools.md) of your choice: [Smith's tools](/Mechaniky/CLI/items/smiths-tools.md), [brewer's supplies](/Mechaniky/CLI/items/brewers-supplies.md), or [mason's tools](/Mechaniky/CLI/items/masons-tools.md).

### Stonecunning

Whenever you make an Intelligence ([History](/Mechaniky/CLI/Rules/skills.md#History)) check related to the origin of stonework, you are considered proficient in the [History](/Mechaniky/CLI/Rules/skills.md#History) skill and add double your proficiency bonus to the check, instead of your normal proficiency bonus.
