...
You can use your ki to duplicate the effects of certain spells. As an action, you can spend 2 ki points to cast [darkness](/Mechaniky/CLI/spells/darkness.md), [darkvision](/Mechaniky/CLI/spells/darkvision.md), [pass without trace](/Mechaniky/CLI/spells/pass-without-trace.md), or [silence](/Mechaniky/CLI/spells/silence.md), without providing material components. Additionally, you gain the [minor illusion](/Mechaniky/CLI/spells/minor-illusion.md) cantrip if you don't already know it.
...
By 11th level, you have learned to become one with the shadows. When you are in an area of dim light or darkness, you can use your action to become [invisible](/Mechaniky/CLI/Rules/conditions.md#Invisible). You remain [invisible](/Mechaniky/CLI/Rules/conditions.md#Invisible) until you make an attack, cast a spell, or are in an area of bright light.
