...
- **Tools**: none
- **Skills**: choose 2 from [Acrobatics](/Mechaniky/CLI/Rules/skills.md#Acrobatics), [Animal Handling](/Mechaniky/CLI/Rules/skills.md#Animal%20Handling), [Athletics](/Mechaniky/CLI/Rules/skills.md#Athletics), [History](/Mechaniky/CLI/Rules/skills.md#History), [Insight](/Mechaniky/CLI/Rules/skills.md#Insight), [Intimidation](/Mechaniky/CLI/Rules/skills.md#Intimidation), [Perception](/Mechaniky/CLI/Rules/skills.md#Perception), and [Survival](/Mechaniky/CLI/Rules/skills.md#Survival)

You start with the following items, plus anything provided by your background.

- (a) [chain mail](/Mechaniky/CLI/items/chain-mail.md) or (b) [leather armor](/Mechaniky/CLI/items/leather-armor.md), [longbow](/Mechaniky/CLI/items/longbow.md), and [20 arrows](/Mechaniky/CLI/items/arrows-20.md)
- (a) a martial weapon and a [shield](/Mechaniky/CLI/items/shield.md) or (b) two martial weapons
- (a) a [light crossbow](/Mechaniky/CLI/items/light-crossbow.md) and [20 bolts](/Mechaniky/CLI/items/crossbow-bolts-20.md) or (b) two [handaxes](/Mechaniky/CLI/items/handaxe.md)
...
You can make a fighter quickly by following these suggestions. First, make Strength or Dexterity your highest ability score, depending on whether you want to focus on melee weapons or on archery (or finesse weapons). Your next-highest score should be Constitution, or Intelligence if you plan to adopt the Eldritch Knight martial archetype. Second, choose the [soldier](/Mechaniky/CLI/backgrounds/soldier.md) background.
...
*4th-level fighter <span title="Tasha's Cauldron of Everything">optional feature</span>*

Whenever you reach a level in this class that grants the Ability Score Improvement feature, you can do one of the following, as you shift the focus of your martial practice:

- Replace a [fighting style](/Mechaniky/CLI/lists/list-optfeaturetype-fs-f.md) you know with another fighting style available to fighters.  
- If you know any [maneuvers](/Mechaniky/CLI/lists/list-optfeaturetype-mv-b.md) from the [Battle Master](/Mechaniky/CLI/classes/fighter-battle-master.md) archetype, you can replace one maneuver you know with a different maneuver.  
...
At 11th level, you can attack three times whenever you take the [Attack](/Mechaniky/CLI/Rules/actions.md#Attack) action on your turn.
...
At 20th level, you can attack four times whenever you take the [Attack](/Mechaniky/CLI/Rules/actions.md#Attack) action on your turn.

## Optional Features

> [!example]- Optional Features: Fighting Style, Fighter
> ![Fighting Style, Fighter](/Mechaniky/CLI/lists/list-optfeaturetype-fs-f.md#Fighting%20Style,%20Fighter)
