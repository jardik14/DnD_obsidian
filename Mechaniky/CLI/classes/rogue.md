...
- **Armor**: [light armor](/Mechaniky/CLI/Rules/item-types.md#Light%20Armor)
- **Weapons**: simple weapons, [hand crossbows](/Mechaniky/CLI/items/hand-crossbow.md), [longswords](/Mechaniky/CLI/items/longsword.md), [rapiers](/Mechaniky/CLI/items/rapier.md), [shortswords](/Mechaniky/CLI/items/shortsword.md)
- **Tools**: [thieves' tools](/Mechaniky/CLI/items/thieves-tools.md)
- **Skills**: choose 4 from [Acrobatics](/Mechaniky/CLI/Rules/skills.md#Acrobatics), [Athletics](/Mechaniky/CLI/Rules/skills.md#Athletics), [Deception](/Mechaniky/CLI/Rules/skills.md#Deception), [Insight](/Mechaniky/CLI/Rules/skills.md#Insight), [Intimidation](/Mechaniky/CLI/Rules/skills.md#Intimidation), [Investigation](/Mechaniky/CLI/Rules/skills.md#Investigation), [Perception](/Mechaniky/CLI/Rules/skills.md#Perception), [Performance](/Mechaniky/CLI/Rules/skills.md#Performance), [Persuasion](/Mechaniky/CLI/Rules/skills.md#Persuasion), [Sleight of Hand](/Mechaniky/CLI/Rules/skills.md#Sleight%20of%20Hand), and [Stealth](/Mechaniky/CLI/Rules/skills.md#Stealth)

You start with the following items, plus anything provided by your background.

- (a) a [rapier](/Mechaniky/CLI/items/rapier.md) or (b) a [shortsword](/Mechaniky/CLI/items/shortsword.md)
- (a) a [shortbow](/Mechaniky/CLI/items/shortbow.md) and [quiver](/Mechaniky/CLI/items/quiver.md) of [20 arrows](/Mechaniky/CLI/items/arrows-20.md) or (b) a [shortsword](/Mechaniky/CLI/items/shortsword.md)
- (a) a [burglar's pack](/Mechaniky/CLI/items/burglars-pack.md), (b) a [dungeoneer's pack](/Mechaniky/CLI/items/dungeoneers-pack.md), or (c) an [explorer's pack](/Mechaniky/CLI/items/explorers-pack.md)
- [Leather armor](/Mechaniky/CLI/items/leather-armor.md), two [daggers](/Mechaniky/CLI/items/dagger.md), and [thieves' tools](/Mechaniky/CLI/items/thieves-tools.md)
...
- **Armor**: [light armor](/Mechaniky/CLI/Rules/item-types.md#Light%20Armor)
- **Tools**: [thieves' tools](/Mechaniky/CLI/items/thieves-tools.md)
- **Skills**: choose 1 from [Acrobatics](/Mechaniky/CLI/Rules/skills.md#Acrobatics), [Athletics](/Mechaniky/CLI/Rules/skills.md#Athletics), [Deception](/Mechaniky/CLI/Rules/skills.md#Deception), [Insight](/Mechaniky/CLI/Rules/skills.md#Insight), [Intimidation](/Mechaniky/CLI/Rules/skills.md#Intimidation), [Investigation](/Mechaniky/CLI/Rules/skills.md#Investigation), [Perception](/Mechaniky/CLI/Rules/skills.md#Perception), [Performance](/Mechaniky/CLI/Rules/skills.md#Performance), [Persuasion](/Mechaniky/CLI/Rules/skills.md#Persuasion), [Sleight of Hand](/Mechaniky/CLI/Rules/skills.md#Sleight%20of%20Hand), and [Stealth](/Mechaniky/CLI/Rules/skills.md#Stealth)
...
You can make a rogue quickly by following these suggestions. First, Dexterity should be your highest ability score. Make Intelligence your next-highest if you want to excel at Investigation or plan to take up the Arcane Trickster archetype. Choose Charisma instead if you plan to emphasize deception and social interaction. Second, choose the [charlatan](/Mechaniky/CLI/backgrounds/charlatan.md) background.
...
At 1st level, choose two of your skill proficiencies, or one of your skill proficiencies and your proficiency with [thieves' tools](/Mechaniky/CLI/items/thieves-tools.md). Your proficiency bonus is doubled for any ability check you make that uses either of the chosen proficiencies.

At 6th level, you can choose two more of your proficiencies (in skills or with [thieves' tools](/Mechaniky/CLI/items/thieves-tools.md)) to gain this benefit.

### Sneak Attack (Level 1)

Beginning at 1st level, you know how to strike subtly and exploit a foe's distraction. Once per turn, you can deal an extra `1d6` damage to one creature you hit with an attack if you have advantage on the attack roll. The attack must use a finesse or a ranged weapon.

You don't need advantage on the attack roll if another enemy of the target is within 5 feet of it, that enemy isn't [incapacitated](/Mechaniky/CLI/Rules/conditions.md#Incapacitated), and you don't have disadvantage on the attack roll.
...
Starting at 2nd level, your quick thinking and agility allow you to move and act quickly. You can take a bonus action on each of your turns in combat. This action can be used only to take the [Dash](/Mechaniky/CLI/Rules/actions.md#Dash), [Disengage](/Mechaniky/CLI/Rules/actions.md#Disengage), or [Hide](/Mechaniky/CLI/Rules/actions.md#Hide) action.
...
At 6th level, you can choose two more of your proficiencies (in skills or with [thieves' tools](/Mechaniky/CLI/items/thieves-tools.md)) to gain the benefit of Expertise.

### Evasion (Level 7)

Beginning at 7th level, you can nimbly dodge out of the way of certain area effects, such as a red dragon's fiery breath or an [ice storm](/Mechaniky/CLI/spells/ice-storm.md) spell. When you are subjected to an effect that allows you to make a Dexterity saving throw to take only half damage, you instead take no damage if you succeed on the saving throw, and only half damage if you fail.
...
Starting at 14th level, if you are able to hear, you are aware of the location of any hidden or [invisible](/Mechaniky/CLI/Rules/conditions.md#Invisible) creature within 10 feet of you.
...
Beginning at 18th level, you are so evasive that attackers rarely gain the upper hand against you. No attack roll has advantage against you while you aren't [incapacitated](/Mechaniky/CLI/Rules/conditions.md#Incapacitated).
