...
- **Tools**: none
- **Skills**: choose 2 from [Arcana](/Mechaniky/CLI/Rules/skills.md#Arcana), [Deception](/Mechaniky/CLI/Rules/skills.md#Deception), [History](/Mechaniky/CLI/Rules/skills.md#History), [Intimidation](/Mechaniky/CLI/Rules/skills.md#Intimidation), [Investigation](/Mechaniky/CLI/Rules/skills.md#Investigation), [Nature](/Mechaniky/CLI/Rules/skills.md#Nature), and [Religion](/Mechaniky/CLI/Rules/skills.md#Religion)

You start with the following items, plus anything provided by your background.

- (a) a [light crossbow](/Mechaniky/CLI/items/light-crossbow.md) and [20 bolts](/Mechaniky/CLI/items/crossbow-bolts-20.md) or (b) any simple weapon
- (a) a [component pouch](/Mechaniky/CLI/items/component-pouch.md) or (b) an [arcane focus](/Mechaniky/CLI/items/arcane-focus.md)
- (a) a [scholar's pack](/Mechaniky/CLI/items/scholars-pack.md) or (b) a [dungeoneer's pack](/Mechaniky/CLI/items/dungeoneers-pack.md)
- [Leather armor](/Mechaniky/CLI/items/leather-armor.md), any simple weapon, and two [daggers](/Mechaniky/CLI/items/dagger.md)
...
You can make a warlock quickly by following these suggestions. First, Charisma should be your highest ability score, followed by Constitution. Second, choose the [charlatan](/Mechaniky/CLI/backgrounds/charlatan.md) background. Third, choose the [eldritch blast](/Mechaniky/CLI/spells/eldritch-blast.md) and [chill touch](/Mechaniky/CLI/spells/chill-touch.md) cantrips, along with the 1st-level spells [charm person](/Mechaniky/CLI/spells/charm-person.md) and [witch bolt](/Mechaniky/CLI/spells/witch-bolt.md).
...
For example, when you are 5th level, you have two 3rd-level spell slots. To cast the 1st-level spell [witch bolt](/Mechaniky/CLI/spells/witch-bolt.md), you must spend one of those slots, and you cast it as a 3rd-level spell.
...
You can use an [arcane focus](/Mechaniky/CLI/items/arcane-focus.md) as a spellcasting focus for your warlock spells.
...
At 2nd level, you gain two eldritch invocations of your choice. A list of the available options can be found on the [Optional Features](/Mechaniky/CLI/lists/list-optfeaturetype-ei.md) page. When you gain certain warlock levels, you gain additional invocations of your choice, as shown in the Invocations Known column of the Warlock table.
...
- [Pact of the Chain](/Mechaniky/CLI/optional-features/pact-of-the-chain.md)  
- [Pact of the Blade](/Mechaniky/CLI/optional-features/pact-of-the-blade.md)  
- [Pact of the Tome](/Mechaniky/CLI/optional-features/pact-of-the-tome.md)  
...
*4th-level warlock <span title="Tasha's Cauldron of Everything">optional feature</span>*
...
> ![Eldritch Invocation](/Mechaniky/CLI/lists/list-optfeaturetype-ei.md#Eldritch%20Invocation)
^list-optfeature-ei

> [!example]- Optional Features: Pact Boon
> ![Pact Boon](/Mechaniky/CLI/lists/list-optfeaturetype-pb.md#Pact%20Boon)
^list-optfeature-pb