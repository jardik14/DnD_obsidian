...
- **Armor**: none
- **Weapons**: [daggers](/Mechaniky/CLI/items/dagger.md), [darts](/Mechaniky/CLI/items/dart.md), [slings](/Mechaniky/CLI/items/sling.md), [quarterstaffs](/Mechaniky/CLI/items/quarterstaff.md), [light crossbows](/Mechaniky/CLI/items/light-crossbow.md)
- **Tools**: none
- **Skills**: choose 2 from [Arcana](/Mechaniky/CLI/Rules/skills.md#Arcana), [Deception](/Mechaniky/CLI/Rules/skills.md#Deception), [Insight](/Mechaniky/CLI/Rules/skills.md#Insight), [Intimidation](/Mechaniky/CLI/Rules/skills.md#Intimidation), [Persuasion](/Mechaniky/CLI/Rules/skills.md#Persuasion), and [Religion](/Mechaniky/CLI/Rules/skills.md#Religion)
...
- Two [daggers](/Mechaniky/CLI/items/dagger.md)
...
You can make a sorcerer quickly by following these suggestions. First, Charisma should be your highest ability score, followed by Constitution. Second, choose the hermit background. Third, choose the [light](/Mechaniky/CLI/spells/light.md), [prestidigitation](/Mechaniky/CLI/spells/prestidigitation.md), [ray of frost](/Mechaniky/CLI/spells/ray-of-frost.md), and [shocking grasp](/Mechaniky/CLI/spells/shocking-grasp.md) cantrips, along with the 1st-level spells [shield](/Mechaniky/CLI/spells/shield.md) and [magic missile](/Mechaniky/CLI/spells/magic-missile.md).
...
For example, if you know the 1st-level spell [burning hands](/Mechaniky/CLI/spells/burning-hands.md) and have a 1st-level and a 2nd-level spell slot available, you can cast [burning hands](/Mechaniky/CLI/spells/burning-hands.md) using either slot.
...
You can use an [arcane focus](/Mechaniky/CLI/items/arcane-focus.md) as a spellcasting focus for your sorcerer spells.
...
- [Careful Spell](/Mechaniky/CLI/optional-features/careful-spell.md)  
- [Distant Spell](/Mechaniky/CLI/optional-features/distant-spell.md)  
- [Empowered Spell](/Mechaniky/CLI/optional-features/empowered-spell.md)  
- [Extended Spell](/Mechaniky/CLI/optional-features/extended-spell.md)  
- [Heightened Spell](/Mechaniky/CLI/optional-features/heightened-spell.md)  
- [Quickened Spell](/Mechaniky/CLI/optional-features/quickened-spell.md)  
- [Subtle Spell](/Mechaniky/CLI/optional-features/subtle-spell.md)  
- [Twinned Spell](/Mechaniky/CLI/optional-features/twinned-spell.md)  

### Metamagic Options (Level 3)
_Source: Tasha's Cauldron of Everything p. 65_

*3rd-level sorcerer <span title="Tasha's Cauldron of Everything">optional feature</span>*
...
*4th-level sorcerer <span title="Tasha's Cauldron of Everything">optional feature</span>*
...
- Replace one of the options you chose for the Metamagic feature with a different [Metamagic option](/Mechaniky/CLI/lists/list-optfeaturetype-mm.md) available to you.  
...
> ![Metamagic](/Mechaniky/CLI/lists/list-optfeaturetype-mm.md#Metamagic)
^list-optfeature-mm