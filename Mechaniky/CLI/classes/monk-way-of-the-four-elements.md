...
Once you reach 5th level in this class, you can spend additional ki points to increase the level of an elemental discipline spell that you cast, provided that the spell has an enhanced effect at a higher level, as [burning hands](/Mechaniky/CLI/spells/burning-hands.md) does. The spell's level increases by 1 for each additional ki point you spend. For example, if you are a 5th-level monk and use Sweeping Cinder Strike to cast [burning hands](/Mechaniky/CLI/spells/burning-hands.md), you can spend 3 ki points to cast it as a 2nd-level spell (the discipline's base cost of 2 ki points plus 1).
...
- [Breath of Winter](/Mechaniky/CLI/optional-features/breath-of-winter.md)  
- [Clench of the North Wind](/Mechaniky/CLI/optional-features/clench-of-the-north-wind.md)  
- [Elemental Attunement](/Mechaniky/CLI/optional-features/elemental-attunement.md)  
- [Eternal Mountain Defense](/Mechaniky/CLI/optional-features/eternal-mountain-defense.md)  
- [Fangs of the Fire Snake](/Mechaniky/CLI/optional-features/fangs-of-the-fire-snake.md)  
- [Fist of Four Thunders](/Mechaniky/CLI/optional-features/fist-of-four-thunders.md)  
- [Unbroken Air](/Mechaniky/CLI/optional-features/unbroken-air.md)  
- [Flames of the Phoenix](/Mechaniky/CLI/optional-features/flames-of-the-phoenix.md)  
- [Gong of the Summit](/Mechaniky/CLI/optional-features/gong-of-the-summit.md)  
- [Mist Stance](/Mechaniky/CLI/optional-features/mist-stance.md)  
- [Ride the Wind](/Mechaniky/CLI/optional-features/ride-the-wind.md)  
- [River of Hungry Flame](/Mechaniky/CLI/optional-features/river-of-hungry-flame.md)  
- [Rush of the Gale Spirits](/Mechaniky/CLI/optional-features/rush-of-the-gale-spirits.md)  
- [Shape the Flowing River](/Mechaniky/CLI/optional-features/shape-the-flowing-river.md)  
- [Sweeping Cinder Strike](/Mechaniky/CLI/optional-features/sweeping-cinder-strike.md)  
- [Water Whip](/Mechaniky/CLI/optional-features/water-whip.md)  
- [Wave of Rolling Earth](/Mechaniky/CLI/optional-features/wave-of-rolling-earth.md)  
...
> ![Elemental Discipline](/Mechaniky/CLI/lists/list-optfeaturetype-ed.md#Elemental%20Discipline)
^list-optfeature-ed