...
- **Tools**: none
- **Skills**: choose 2 from [Arcana](/Mechaniky/CLI/Rules/skills.md#Arcana), [History](/Mechaniky/CLI/Rules/skills.md#History), [Insight](/Mechaniky/CLI/Rules/skills.md#Insight), [Investigation](/Mechaniky/CLI/Rules/skills.md#Investigation), [Medicine](/Mechaniky/CLI/Rules/skills.md#Medicine), and [Religion](/Mechaniky/CLI/Rules/skills.md#Religion)

You start with the following items, plus anything provided by your background.

- (a) a [quarterstaff](/Mechaniky/CLI/items/quarterstaff.md) or (b) a [dagger](/Mechaniky/CLI/items/dagger.md)
- (a) a [component pouch](/Mechaniky/CLI/items/component-pouch.md) or (b) an [arcane focus](/Mechaniky/CLI/items/arcane-focus.md)
- (a) a [scholar's pack](/Mechaniky/CLI/items/scholars-pack.md) or (b) an [explorer's pack](/Mechaniky/CLI/items/explorers-pack.md)
- A [spellbook](/Mechaniky/CLI/items/spellbook.md)
...
You can make a wizard quickly by following these suggestions. First, Intelligence should be your highest ability score, followed by Constitution or Dexterity. If you plan to join the School of Enchantment, make Charisma your next-best score. Second, choose the [sage](/Mechaniky/CLI/backgrounds/sage.md) background. Third, choose the [mage hand](/Mechaniky/CLI/spells/mage-hand.md), [light](/Mechaniky/CLI/spells/light.md), and [ray of frost](/Mechaniky/CLI/spells/ray-of-frost.md) cantrips, along with the following 1st-level spells for your spellbook: [burning hands](/Mechaniky/CLI/spells/burning-hands.md), [charm person](/Mechaniky/CLI/spells/charm-person.md), [feather fall](/Mechaniky/CLI/spells/feather-fall.md), [mage armor](/Mechaniky/CLI/spells/mage-armor.md), [magic missile](/Mechaniky/CLI/spells/magic-missile.md), and [sleep](/Mechaniky/CLI/spells/sleep.md).
...
For example, if you're a 3rd-level wizard, you have four 1st-level and two 2nd-level spell slots. With an Intelligence of 16, your list of prepared spells can include six spells of 1st or 2nd level, in any combination, chosen from your spellbook. If you prepare the 1st-level spell [magic missile](/Mechaniky/CLI/spells/magic-missile.md), you can cast it using a 1st-level or a 2nd-level slot. Casting the spell doesn't remove it from your list of prepared spells.
...
You can use an [arcane focus](/Mechaniky/CLI/items/arcane-focus.md) as a spellcasting focus for your wizard spells.
...
> 
> **Copying from a Spell Scroll.** A wizard spell on a spell scroll can be copied just as spells in spellbooks can be copied. When you copy a spell from a spell scroll, you must succeed on an Intelligence ([Arcana](/Mechaniky/CLI/Rules/skills.md#Arcana)) check with a DC equal to 10 + the spell's level. If the check succeeds, the spell is successfully copied. Whether the check succeeds or fails, the spell scroll is destroyed.
> 
...
*3rd-level wizard <span title="Tasha's Cauldron of Everything">optional feature</span>*
