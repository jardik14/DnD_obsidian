...
- **Armor**: [light armor](/Mechaniky/CLI/Rules/item-types.md#Light%20Armor), [medium armor](/Mechaniky/CLI/Rules/item-types.md#Medium%20Armor), [heavy armor](/Mechaniky/CLI/Rules/item-types.md#Heavy%20Armor), [shields](/Mechaniky/CLI/items/shield.md)
- **Weapons**: simple weapons, martial weapons
- **Tools**: none
- **Skills**: choose 2 from [Athletics](/Mechaniky/CLI/Rules/skills.md#Athletics), [Insight](/Mechaniky/CLI/Rules/skills.md#Insight), [Intimidation](/Mechaniky/CLI/Rules/skills.md#Intimidation), [Medicine](/Mechaniky/CLI/Rules/skills.md#Medicine), [Persuasion](/Mechaniky/CLI/Rules/skills.md#Persuasion), and [Religion](/Mechaniky/CLI/Rules/skills.md#Religion)

You start with the following items, plus anything provided by your background.

- (a) a martial weapon and a [shield](/Mechaniky/CLI/items/shield.md) or (b) two martial weapons
- (a) five [javelins](/Mechaniky/CLI/items/javelin.md) or (b) any simple melee weapon
- (a) a [priest's pack](/Mechaniky/CLI/items/priests-pack.md) or (b) an [explorer's pack](/Mechaniky/CLI/items/explorers-pack.md)
- [Chain mail](/Mechaniky/CLI/items/chain-mail.md) and a [holy symbol](/Mechaniky/CLI/items/holy-symbol.md)
...
You can make a paladin quickly by following these suggestions. First, Strength should be your highest ability score, followed by Charisma. Second, choose the [noble](/Mechaniky/CLI/backgrounds/noble.md) background.
...
The presence of strong evil registers on your senses like a noxious odor, and powerful good rings like heavenly music in your ears. As an action, you can open your awareness to detect such forces. Until the end of your next turn, you know the location of any celestial, fiend, or undead within 60 feet of you that is not behind total cover. You know the type (celestial, fiend, or undead) of any being whose presence you sense, but not its identity (the vampire Count Strahd von Zarovich, for instance). Within the same radius, you also detect the presence of any place or object that has been consecrated or desecrated, as with the [hallow](/Mechaniky/CLI/spells/hallow.md) spell.
...
- [Great Weapon Fighting](/Mechaniky/CLI/optional-features/great-weapon-fighting.md)  
- [Protection](/Mechaniky/CLI/optional-features/protection.md)  
...
You can use a [holy symbol](/Mechaniky/CLI/items/holy-symbol.md) as a spellcasting focus for your paladin spells.
...
*3rd-level paladin <span title="Tasha's Cauldron of Everything">optional feature</span>*
...
Whenever you reach a level in this class that grants the Ability Score Improvement feature, you can replace a [fighting style](/Mechaniky/CLI/lists/list-optfeaturetype-fs-p.md) you know with another fighting style available to paladins. This replacement represents a shift of focus in your martial practice.
...
Starting at 10th level, you and friendly creatures within 10 feet of you can't be [frightened](/Mechaniky/CLI/Rules/conditions.md#Frightened) while you are conscious.
...
> ![Fighting Style, Paladin](/Mechaniky/CLI/lists/list-optfeaturetype-fs-p.md#Fighting%20Style,%20Paladin)
