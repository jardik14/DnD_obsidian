...
- **Tools**: none
- **Skills**: choose 2 from [History](/Mechaniky/CLI/Rules/skills.md#History), [Insight](/Mechaniky/CLI/Rules/skills.md#Insight), [Medicine](/Mechaniky/CLI/Rules/skills.md#Medicine), [Persuasion](/Mechaniky/CLI/Rules/skills.md#Persuasion), and [Religion](/Mechaniky/CLI/Rules/skills.md#Religion)

You start with the following items, plus anything provided by your background.

- (a) a [mace](/Mechaniky/CLI/items/mace.md) or (b) a [warhammer](/Mechaniky/CLI/items/warhammer.md) (if proficient)
- (a) [scale mail](/Mechaniky/CLI/items/scale-mail.md), (b) [leather armor](/Mechaniky/CLI/items/leather-armor.md), or (c) [chain mail](/Mechaniky/CLI/items/chain-mail.md) (if proficient)
...
- A [shield](/Mechaniky/CLI/items/shield.md) and a [holy symbol](/Mechaniky/CLI/items/holy-symbol.md)
...
You can make a cleric quickly by following these suggestions. First, Wisdom should be your highest ability score, followed by Strength or Constitution. Second, choose the [acolyte](/Mechaniky/CLI/backgrounds/acolyte.md) background.
...
You can use a [holy symbol](/Mechaniky/CLI/items/holy-symbol.md) as a spellcasting focus for your cleric spells.
...
A turned creature must spend its turns trying to move as far away from you as it can, and it can't willingly move to a space within 30 feet of you. It also can't take reactions. For its action, it can use only the [Dash](/Mechaniky/CLI/Rules/actions.md#Dash) action or try to escape from an effect that prevents it from moving. If there's nowhere to move, the creature can use the [Dodge](/Mechaniky/CLI/Rules/actions.md#Dodge) action.

### Channel Divinity: Harness Divine Power (Level 2)
_Source: Tasha's Cauldron of Everything p. 30_

*2nd-level cleric <span title="Tasha's Cauldron of Everything">optional feature</span>*
...
*4th-level cleric <span title="Tasha's Cauldron of Everything">optional feature</span>*
