...
- **Tools**: none
- **Skills**: choose 2 from [Animal Handling](/Mechaniky/CLI/Rules/skills.md#Animal%20Handling), [Athletics](/Mechaniky/CLI/Rules/skills.md#Athletics), [Intimidation](/Mechaniky/CLI/Rules/skills.md#Intimidation), [Nature](/Mechaniky/CLI/Rules/skills.md#Nature), [Perception](/Mechaniky/CLI/Rules/skills.md#Perception), and [Survival](/Mechaniky/CLI/Rules/skills.md#Survival)

You start with the following items, plus anything provided by your background.

- (a) a [greataxe](/Mechaniky/CLI/items/greataxe.md) or (b) any martial melee weapon
- (a) two [handaxes](/Mechaniky/CLI/items/handaxe.md) or (b) any simple weapon
- An [explorer's pack](/Mechaniky/CLI/items/explorers-pack.md), and four [javelins](/Mechaniky/CLI/items/javelin.md)
...
- **Armor**: [shields](/Mechaniky/CLI/items/shield.md)
- **Weapons**: simple weapons, martial weapons
...
You can make a barbarian quickly by following these suggestions. First, put your highest ability score in Strength, followed by Constitution. Second, choose the [outlander](/Mechaniky/CLI/backgrounds/outlander.md) background.
...
Your rage lasts for 1 minute. It ends early if you are knocked [unconscious](/Mechaniky/CLI/Rules/conditions.md#Unconscious) or if your turn ends and you haven't attacked a hostile creature since your last turn or taken damage since then. You can also end your rage on your turn as a bonus action.
...
At 2nd level, you gain an uncanny sense of when things nearby aren't as they should be, giving you an edge when you dodge away from danger. You have advantage on Dexterity saving throws against effects that you can see, such as traps and spells. To gain this benefit, you can't be [blinded](/Mechaniky/CLI/Rules/conditions.md#Blinded), [deafened](/Mechaniky/CLI/Rules/conditions.md#Deafened), or [incapacitated](/Mechaniky/CLI/Rules/conditions.md#Incapacitated).
...
*3rd-level barbarian <span title="Tasha's Cauldron of Everything">optional feature</span>*
...
Additionally, if you are [surprised](/Mechaniky/CLI/Rules/conditions.md#Surprised) at the beginning of combat and aren't [incapacitated](/Mechaniky/CLI/Rules/conditions.md#Incapacitated), you can act normally on your first turn, but only if you enter your rage before doing anything else on that turn.

### Instinctive Pounce (Level 7)
_Source: Tasha's Cauldron of Everything p. 24_

*7th-level barbarian <span title="Tasha's Cauldron of Everything">optional feature</span>*
...
Beginning at 15th level, your rage is so fierce that it ends early only if you fall [unconscious](/Mechaniky/CLI/Rules/conditions.md#Unconscious) or if you choose to end it.
