...
- [Commander's Strike](/Mechaniky/CLI/optional-features/commanders-strike.md)  
- [Disarming Attack](/Mechaniky/CLI/optional-features/disarming-attack.md)  
- [Distracting Strike](/Mechaniky/CLI/optional-features/distracting-strike.md)  
- [Evasive Footwork](/Mechaniky/CLI/optional-features/evasive-footwork.md)  
- [Feinting Attack](/Mechaniky/CLI/optional-features/feinting-attack.md)  
- [Goading Attack](/Mechaniky/CLI/optional-features/goading-attack.md)  
- [Lunging Attack](/Mechaniky/CLI/optional-features/lunging-attack.md)  
- [Maneuvering Attack](/Mechaniky/CLI/optional-features/maneuvering-attack.md)  
- [Menacing Attack](/Mechaniky/CLI/optional-features/menacing-attack.md)  
- [Parry](/Mechaniky/CLI/optional-features/parry.md)  
- [Precision Attack](/Mechaniky/CLI/optional-features/precision-attack.md)  
- [Pushing Attack](/Mechaniky/CLI/optional-features/pushing-attack.md)  
- [Rally](/Mechaniky/CLI/optional-features/rally.md)  
- [Riposte](/Mechaniky/CLI/optional-features/riposte.md)  
- [Sweeping Attack](/Mechaniky/CLI/optional-features/sweeping-attack.md)  
- [Trip Attack](/Mechaniky/CLI/optional-features/trip-attack.md)  

### Maneuver Options (Level 3)
_Source: Tasha's Cauldron of Everything p. 41_

*3rd-level fighter <span title="Tasha's Cauldron of Everything">optional feature</span>*

If you have access to maneuvers, the following maneuvers are added to the list of options available to you. Maneuvers are available to Battle Masters but also to characters who have a special feature like the Superior Technique fighting style or the [Martial Adept](/Mechaniky/CLI/feats/martial-adept.md) feat.
...
> ![Maneuver, Battle Master](/Mechaniky/CLI/lists/list-optfeaturetype-mv-b.md#Maneuver,%20Battle%20Master)
