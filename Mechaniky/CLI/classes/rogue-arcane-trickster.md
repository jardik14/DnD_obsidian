...
You learn three cantrips: [mage hand](/Mechaniky/CLI/spells/mage-hand.md) and two other cantrips of your choice from the wizard spell list. You learn another wizard cantrip of your choice at 10th level.
...
For example, if you know the 1st-level spell [charm person](/Mechaniky/CLI/spells/charm-person.md) and have a 1st-level and a 2nd-level spell slot available, you can cast [charm person](/Mechaniky/CLI/spells/charm-person.md) using either slot.
...
Starting at 3rd level, when you cast [mage hand](/Mechaniky/CLI/spells/mage-hand.md), you can make the spectral hand [invisible](/Mechaniky/CLI/Rules/conditions.md#Invisible), and you can perform the following additional tasks with it:

- You can stow one object the hand is holding in a container worn or carried by another creature.  
- You can retrieve an object in a container worn or carried by another creature.  
- You can use [thieves' tools](/Mechaniky/CLI/items/thieves-tools.md) to pick locks and disarm traps at range.  

You can perform one of these tasks without being noticed by a creature if you succeed on a Dexterity ([Sleight of Hand](/Mechaniky/CLI/Rules/skills.md#Sleight%20of%20Hand)) check contested by the creature's Wisdom ([Perception](/Mechaniky/CLI/Rules/skills.md#Perception)) check.
...
At 13th level, you gain the ability to distract targets with your [mage hand](/Mechaniky/CLI/spells/mage-hand.md). As a bonus action on your turn, you can designate a creature within 5 feet of the spectral hand created by the spell. Doing so gives you advantage on attack rolls against that creature until the end of the turn.
