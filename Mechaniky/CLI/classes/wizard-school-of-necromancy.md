...
At 6th level, you add the [animate dead](/Mechaniky/CLI/spells/animate-dead.md) spell to your spellbook if it is not there already. When you cast [animate dead](/Mechaniky/CLI/spells/animate-dead.md), you can target one additional corpse or pile of bones, creating another zombie or skeleton, as appropriate.
