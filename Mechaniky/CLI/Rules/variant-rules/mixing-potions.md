...
| 00 | Only one potion works, but its effect is permanent. Choose the simplest effect to make permanent, or the one that seems the most fun. For example, a [potion of healing](/Mechaniky/CLI/items/potion-of-healing.md) might increase the drinker's hit point maximum by 4, or [oil of etherealness](/Mechaniky/CLI/items/oil-of-etherealness.md) might permanently trap the user in the Ethereal Plane. At your discretion, an appropriate spell, such as [dispel magic](/Mechaniky/CLI/spells/dispel-magic.md) or [remove curse](/Mechaniky/CLI/spells/remove-curse.md), might end this lasting effect. |
^potion-miscibility