...
A creature who tries and fails to cast a spell from a [spell scroll](/Mechaniky/CLI/items/spell-scroll.md) must make a DC 10 Intelligence saving throw. If the saving throw fails, roll on the Scroll Mishap table.
...
| 4 | The spell's effect is contrary to its normal one, but neither harmful nor beneficial. For instance, a [fireball](/Mechaniky/CLI/spells/fireball.md) might produce an area of harmless cold. |
| 5 | The caster suffers a minor but bizarre effect related to the spell. Such effects last only as long as the original spell's duration, or `1d10` minutes for spells that take effect instantaneously. For example, a [fireball](/Mechaniky/CLI/spells/fireball.md) might cause smoke to billow from the caster's ears for `1d10` minutes.  |
