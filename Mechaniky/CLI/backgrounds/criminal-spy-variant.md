...
- **Skill Proficiencies.** [Deception](/Mechaniky/CLI/Rules/skills.md#Deception), [Stealth](/Mechaniky/CLI/Rules/skills.md#Stealth)  
- **Tool Proficiencies.** One type of gaming set, [thieves' tools](/Mechaniky/CLI/items/thieves-tools.md)  
- **Equipment.** A [crowbar](/Mechaniky/CLI/items/crowbar.md), a set of dark [common clothes](/Mechaniky/CLI/items/common-clothes.md) including a hood, and a belt [pouch](/Mechaniky/CLI/items/pouch.md) containing 15 gp  
