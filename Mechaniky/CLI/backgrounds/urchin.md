...
- **Skill Proficiencies.** [Sleight of Hand](/Mechaniky/CLI/Rules/skills.md#Sleight%20of%20Hand), [Stealth](/Mechaniky/CLI/Rules/skills.md#Stealth)  
- **Tool Proficiencies.** [Disguise kit](/Mechaniky/CLI/items/disguise-kit.md), [Thieves' tools](/Mechaniky/CLI/items/thieves-tools.md)  
- **Equipment.** A small knife, a map of the city you grew up in, a pet mouse, a token to remember your parents by, a set of [common clothes](/Mechaniky/CLI/items/common-clothes.md), and a belt [pouch](/Mechaniky/CLI/items/pouch.md) containing 10 gp  
