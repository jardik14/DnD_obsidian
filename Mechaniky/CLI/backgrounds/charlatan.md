...
- **Skill Proficiencies.** [Deception](/Mechaniky/CLI/Rules/skills.md#Deception), [Sleight of Hand](/Mechaniky/CLI/Rules/skills.md#Sleight%20of%20Hand)  
- **Tool Proficiencies.** [Disguise kit](/Mechaniky/CLI/items/disguise-kit.md), [Forgery kit](/Mechaniky/CLI/items/forgery-kit.md)  
- **Equipment.** A set of [fine clothes](/Mechaniky/CLI/items/fine-clothes.md), a [disguise kit](/Mechaniky/CLI/items/disguise-kit.md), tools of the con of your choice (ten stoppered bottles filled with colored liquid, a set of weighted dice, a deck of marked cards, or a signet ring of an imaginary duke), and a belt [pouch](/Mechaniky/CLI/items/pouch.md) containing 15 gp  
