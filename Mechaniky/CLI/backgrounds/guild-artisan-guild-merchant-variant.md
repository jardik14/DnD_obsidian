...
- **Skill Proficiencies.** [Insight](/Mechaniky/CLI/Rules/skills.md#Insight), [Persuasion](/Mechaniky/CLI/Rules/skills.md#Persuasion)  
- **Tool Proficiencies.** One type of artisan's tools, or [navigator's tools](/Mechaniky/CLI/items/navigators-tools.md), or an additional language  
- **Languages.** One of your choice  
- **Equipment.** A set of artisan's tools (one of your choice) or a [mule](/Mechaniky/CLI/items/mule.md) and [cart](/Mechaniky/CLI/items/cart.md), a letter of introduction from your guild, a set of [traveler's clothes](/Mechaniky/CLI/items/travelers-clothes.md), and a belt [pouch](/Mechaniky/CLI/items/pouch.md) containing 15 gp  
